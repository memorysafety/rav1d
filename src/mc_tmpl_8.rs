...
unsafe extern "C" fn put_8tap_c(
    ...
    let intermediate_bits = 4;
    let intermediate_rnd = 32 as libc::c_int
        + ((1 as libc::c_int) << 6 - intermediate_bits
            >> 1);
    let fh: *const int8_t = if mx == 0 {
        0 as *const int8_t
    } else if w > 4 {
        (dav1d_mc_subpel_filters[(filter_type & 3)
            as usize][(mx - 1) as usize])
            .as_ptr()
    } else {
        (dav1d_mc_subpel_filters[(3 + (filter_type & 1))
            as usize][(mx - 1) as usize])
            .as_ptr()
    };
    let fv: *const int8_t = if my == 0 {
        ...
        (dav1d_mc_subpel_filters[(filter_type >> 2)
            as usize][(my - 1) as usize])
            .as_ptr()
    } else {
            ...
            loop {
                ...
                while x < w {
                    *mid_ptr
                        ...
                        * *src
                            .offset(
                                (x + -(3 as libc::c_int) * 1) as isize,
                            ) as libc::c_int
                        + *fh.offset(1) as libc::c_int
                            * *src
                                .offset(
                                    (x + -(2 as libc::c_int) * 1) as isize,
                                ) as libc::c_int
                        + *fh.offset(2) as libc::c_int
                            * *src
                                .offset(
                                    (x + -(1 as libc::c_int) * 1) as isize,
                                ) as libc::c_int
                        + *fh.offset(3) as libc::c_int
                            * *src
                                .offset((x + 0 * 1) as isize)
                                as libc::c_int
                        + *fh.offset(4) as libc::c_int
                            * *src
                                .offset((x + 1 * 1) as isize)
                                as libc::c_int
                        ...
                        + *fh.offset(6) as libc::c_int
                            * *src
                                .offset((x + 3 * 1) as isize)
                                as libc::c_int
                        + *fh.offset(7) as libc::c_int
                            * *src
                                .offset((x + 4 * 1) as isize)
                                as libc::c_int
                        + ((1 as libc::c_int) << 6 - intermediate_bits
                ...
                while x_0 < w {
                    *dst
                        ...
                        *fv.offset(0) as libc::c_int
                            * *mid_ptr
                                .offset(
                                    (x_0 + -(3 as libc::c_int) * 128) as isize,
                                ) as libc::c_int
                            + *fv.offset(1) as libc::c_int
                                * *mid_ptr
                                    .offset(
                                        (x_0 + -(2 as libc::c_int) * 128) as isize,
                                    ) as libc::c_int
                            + *fv.offset(2) as libc::c_int
                                * *mid_ptr
                                    .offset(
                                        (x_0 + -(1 as libc::c_int) * 128) as isize,
                                    ) as libc::c_int
                ...
                while x_1 < w {
                    *dst
                        ...
                        *fh.offset(0) as libc::c_int
                            * *src
                                .offset(
                                    (x_1 + -(3 as libc::c_int) * 1) as isize,
                                ) as libc::c_int
                            + *fh.offset(1) as libc::c_int
                                * *src
                                    .offset(
                                        (x_1 + -(2 as libc::c_int) * 1) as isize,
                                    ) as libc::c_int
                            + *fh.offset(2) as libc::c_int
                                * *src
                                    .offset(
                                        (x_1 + -(1 as libc::c_int) * 1) as isize,
                                    ) as libc::c_int
                            + *fh.offset(3) as libc::c_int
                                * *src
                                    .offset(
                            ...
                            + *fh.offset(7) as libc::c_int
                                * *src
                                    .offset(
                                        (x_1 + 4 * 1) as isize,
                                    ) as libc::c_int + intermediate_rnd >> 6,
                    ) as pixel;
                    x_1 += 1;
                }
                dst = dst.offset(dst_stride as isize);
                    ...
                    *fv.offset(0) as libc::c_int
                        * *src
                        ...
                        + *fv.offset(3) as libc::c_int
                            * *src
                                .offset(
                                    (x_2 as isize + 0 * src_stride) as isize,
                                ) as libc::c_int
                        + *fv.offset(4) as libc::c_int
                            * *src
                                .offset(
                                    (x_2 as isize + 1 * src_stride) as isize,
                                ) as libc::c_int
                        + *fv.offset(5) as libc::c_int
                            * *src
                                .offset(
                                    (x_2 as isize + 2 * src_stride) as isize,
                                ) as libc::c_int
                        + *fv.offset(6) as libc::c_int
                            * *src
                                .offset(
                                    (x_2 as isize + 3 * src_stride) as isize,
                                ) as libc::c_int
                        + *fv.offset(7) as libc::c_int
                            * *src
                                .offset(
                                    (x_2 as isize + 4 * src_stride) as isize,
                                ) as libc::c_int
                        + ((1 as libc::c_int) << 6 >> 1)
                        >> 6,
                ) as pixel;
...
unsafe extern "C" fn put_8tap_scaled_c(
    ...
    let intermediate_bits = 4;
    let intermediate_rnd = (1 as libc::c_int) << intermediate_bits
        >> 1;
    let mut tmp_h = ((h - 1) * dy + my >> 10)
        + 8;
    ...
    loop {
        ...
        while x < w {
            ...
            *mid_ptr
                ...
                *fh.offset(0) as libc::c_int
                    * *src
                        .offset((ioff + -(3 as libc::c_int) * 1) as isize)
                        as libc::c_int
                    + *fh.offset(1) as libc::c_int
                        * *src
                            .offset(
                                (ioff + -(2 as libc::c_int) * 1) as isize,
                            ) as libc::c_int
                    + *fh.offset(2) as libc::c_int
                        * *src
                            .offset(
                                (ioff + -(1 as libc::c_int) * 1) as isize,
                            ) as libc::c_int
                    + *fh.offset(3) as libc::c_int
                        * *src
                            .offset(
...
unsafe extern "C" fn put_8tap_regular_c(
    ...
    put_8tap_c(
        ...
        DAV1D_FILTER_8TAP_REGULAR as libc::c_int
            | (DAV1D_FILTER_8TAP_REGULAR as libc::c_int) << 2,
    );
}
...
unsafe extern "C" fn prep_8tap_regular_sharp_scaled_c(
    ...
    prep_8tap_scaled_c(
        ...
        dy,
        DAV1D_FILTER_8TAP_REGULAR as libc::c_int
            | (DAV1D_FILTER_8TAP_SHARP as libc::c_int) << 2,
    );
}
...
unsafe extern "C" fn prep_8tap_regular_smooth_scaled_c(
    ...
    prep_8tap_scaled_c(
        ...
        dy,
        DAV1D_FILTER_8TAP_REGULAR as libc::c_int
            | (DAV1D_FILTER_8TAP_SMOOTH as libc::c_int) << 2,
    );
}
    ...
    if mx != 0 {
        if my != 0 {
                ...
                while x_0 < w {
                    *dst
                        ...
                        16 * *mid_ptr.offset(x_0 as isize) as libc::c_int
                            + my
                                * (*mid_ptr.offset((x_0 + 128) as isize)
                                    as libc::c_int
                                    - *mid_ptr.offset(x_0 as isize) as libc::c_int)
                            + ((1 as libc::c_int) << 4 + intermediate_bits
                                >> 1) >> 4 + intermediate_bits,
            ...
            loop {
                let mut x_1 = 0;
                while x_1 < w {
                    let px = 16 as libc::c_int
                        * *src.offset(x_1 as isize) as libc::c_int
                        + mx
                            * (*src.offset((x_1 + 1) as isize)
                    ...
                    *dst
                        .offset(
                            x_1 as isize,
                        ) = iclip_u8(px + intermediate_rnd >> intermediate_bits)
                        as pixel;
                    x_1 += 1;
                }
                dst = dst.offset(dst_stride as isize);
    ...
    loop {
        ...
        while x < w {
            *mid_ptr
                .offset(
                    x as isize,
                ) = (16 * *src.offset(ioff as isize) as libc::c_int
                + (imx >> 6)
...
unsafe extern "C" fn avg_c(
    ...
    let rnd = ((1 as libc::c_int) << intermediate_bits)
        + 0 * 2;
    loop {
        let mut x = 0;
        while x < w {
...
unsafe extern "C" fn w_avg_c(
    ...
    let rnd = ((8 as libc::c_int) << intermediate_bits)
        + 0 * 16;
    loop {
        let mut x = 0;
        while x < w {
...
unsafe extern "C" fn mask_c(
    ...
    let rnd = ((32 as libc::c_int) << intermediate_bits)
        + 0 * 64;
    loop {
        let mut x = 0;
        while x < w {
            ...
            *dst
                ...
                * (64 - *mask.offset(x as isize) as libc::c_int)
                + *tmp.offset(x as isize) as libc::c_int
                    * *mask.offset(x as isize) as libc::c_int + 32
                >> 6) as pixel;
            x += 1;
        }
        dst = dst.offset(dst_stride as isize);
    ...
    loop {
        ...
        while x < w {
            *dst
                .offset(
                    x as isize,
                ) = (*dst.offset(x as isize) as libc::c_int * (64 - m)
                + *tmp.offset(x as isize) as libc::c_int * m + 32
                >> 6) as pixel;
            x += 1;
        }
        dst = dst.offset(dst_stride as isize);
                ...
                *dst
                ...
                if h & ss_ver != 0 {
                    *mask
                        ...
                        + *mask.offset((x >> 1) as isize) as libc::c_int
                        + 2 - sign >> 2) as uint8_t;
                } else if ss_ver != 0 {
...
unsafe extern "C" fn warp_affine_8x8_c(
    ...
    while y < 15 {
        ...
        while x < 8 {
            ...
            *mid_ptr
                ...
                * *src.offset((x - 3 * 1) as isize)
                    as libc::c_int
                + *filter.offset(1) as libc::c_int
                    * *src.offset((x - 2 * 1) as isize)
                        as libc::c_int
                + *filter.offset(2) as libc::c_int
                    * *src.offset((x - 1 * 1) as isize)
                        as libc::c_int
                + *filter.offset(3) as libc::c_int
                    * *src.offset((x + 0 * 1) as isize)
                        as libc::c_int
                ...
                + *filter.offset(7) as libc::c_int
                    * *src.offset((x + 4 * 1) as isize)
                        as libc::c_int
                + ((1 as libc::c_int) << 7 - intermediate_bits
    ...
    mid_ptr = &mut *mid
        .as_mut_ptr()
        .offset((3 * 8) as isize) as *mut int16_t;
    let mut y_0 = 0;
    while y_0 < 8 {
        let mut x_0 = 0;
        let mut tmy = my;
    ...
    while y_0 < 8 {
        ...
        while x_0 < 8 {
            ...
            *tmp
                ...
                * *mid_ptr.offset((x_0 - 3 * 8) as isize)
                    as libc::c_int
                + *filter_0.offset(1) as libc::c_int
                    * *mid_ptr
                        .offset((x_0 - 2 * 8) as isize)
...
unsafe extern "C" fn emu_edge_c(
    ...
    let mut blk: *mut pixel = dst
        .offset((top_ext as isize * dst_stride) as isize);
    let center_w = (bw - left_ext as isize
        - right_ext as isize) as libc::c_int;
    let center_h = (bh - top_ext as isize
...
unsafe extern "C" fn resize_c(
    ...
    loop {
        ...
        let mut x = 0;
        while x < dst_w {
            let F: *const int8_t = (dav1d_resize_filter[(mx >> 8)
                as usize])
                .as_ptr();
            *dst
                .offset(
...
unsafe extern "C" fn mc_dsp_init_x86(c: *mut Dav1dMCDSPContext) {
    ...
    (*c).mct[FILTER_2D_8TAP_REGULAR_SMOOTH as usize] = Some(dav1d_prep_8tap_regular_smooth_8bpc_sse2);
    (*c).mct[FILTER_2D_8TAP_REGULAR_SHARP as usize] = Some(dav1d_prep_8tap_regular_sharp_8bpc_sse2);
    (*c).mct[FILTER_2D_8TAP_SMOOTH_REGULAR as usize] = Some(dav1d_prep_8tap_smooth_regular_8bpc_sse2);
    ...
    (*c).mc[FILTER_2D_8TAP_REGULAR_SMOOTH as usize] = Some(dav1d_put_8tap_regular_smooth_8bpc_ssse3);
    (*c).mc[FILTER_2D_8TAP_REGULAR_SHARP as usize] = Some(dav1d_put_8tap_regular_sharp_8bpc_ssse3);
    (*c).mc[FILTER_2D_8TAP_SMOOTH_REGULAR as usize] = Some(dav1d_put_8tap_smooth_regular_8bpc_ssse3);
    ...
    (*c).mct[FILTER_2D_8TAP_REGULAR_SMOOTH as usize] = Some(dav1d_prep_8tap_regular_smooth_8bpc_ssse3);
    (*c).mct[FILTER_2D_8TAP_REGULAR_SHARP as usize] = Some(dav1d_prep_8tap_regular_sharp_8bpc_ssse3);
    (*c).mct[FILTER_2D_8TAP_SMOOTH_REGULAR as usize] = Some(dav1d_prep_8tap_smooth_regular_8bpc_ssse3);
    ...
    (*c).mct[FILTER_2D_8TAP_SHARP_REGULAR as usize] = Some(dav1d_prep_8tap_sharp_regular_8bpc_ssse3);
    ...
    (*c).mc_scaled[FILTER_2D_8TAP_REGULAR as usize] = Some(dav1d_put_8tap_scaled_regular_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_REGULAR_SMOOTH as usize] = Some(dav1d_put_8tap_scaled_regular_smooth_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_REGULAR_SHARP as usize] = Some(dav1d_put_8tap_scaled_regular_sharp_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_SMOOTH_REGULAR as usize] = Some(dav1d_put_8tap_scaled_smooth_regular_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_SMOOTH as usize] = Some(dav1d_put_8tap_scaled_smooth_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_SMOOTH_SHARP as usize] = Some(dav1d_put_8tap_scaled_smooth_sharp_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_SHARP_REGULAR as usize] = Some(dav1d_put_8tap_scaled_sharp_regular_8bpc_ssse3);
    (*c).mc_scaled[FILTER_2D_8TAP_SHARP_SMOOTH as usize] = Some(dav1d_put_8tap_scaled_sharp_smooth_8bpc_ssse3);
    ...
    (*c).mct_scaled[FILTER_2D_8TAP_REGULAR as usize] = Some(dav1d_prep_8tap_scaled_regular_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_REGULAR_SMOOTH as usize] = Some(dav1d_prep_8tap_scaled_regular_smooth_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_REGULAR_SHARP as usize] = Some(dav1d_prep_8tap_scaled_regular_sharp_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_SMOOTH_REGULAR as usize] = Some(dav1d_prep_8tap_scaled_smooth_regular_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_SMOOTH as usize] = Some(dav1d_prep_8tap_scaled_smooth_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_SMOOTH_SHARP as usize] = Some(dav1d_prep_8tap_scaled_smooth_sharp_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_SHARP_REGULAR as usize] = Some(dav1d_prep_8tap_scaled_sharp_regular_8bpc_ssse3);
    (*c).mct_scaled[FILTER_2D_8TAP_SHARP_SMOOTH as usize] = Some(dav1d_prep_8tap_scaled_sharp_smooth_8bpc_ssse3);
...
unsafe extern "C" fn mc_dsp_init_arm(c: *mut Dav1dMCDSPContext) {
    ...
    (*c).mct[FILTER_2D_8TAP_REGULAR_SMOOTH as usize] = Some(dav1d_prep_8tap_regular_smooth_8bpc_neon);
    (*c).mct[FILTER_2D_8TAP_REGULAR_SHARP as usize] = Some(dav1d_prep_8tap_regular_sharp_8bpc_neon);
    (*c).mct[FILTER_2D_8TAP_SMOOTH_REGULAR as usize] = Some(dav1d_prep_8tap_smooth_regular_8bpc_neon);
