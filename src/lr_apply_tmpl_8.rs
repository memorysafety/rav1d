...
unsafe extern "C" fn lr_stripe(
    ...
    if (*lr).type_0 as libc::c_int == DAV1D_RESTORATION_WIENER as libc::c_int {
        ...
        *fresh2 = (*lr).filter_h[2 as libc::c_int as usize] as int16_t;
        ...
        let ref mut fresh3 = (*filter.offset(1 as libc::c_int as isize))[6 as libc::c_int as usize];
        *fresh3 = (*lr).filter_v[0 as libc::c_int as usize] as int16_t;
        ...
        let ref mut fresh4 = (*filter.offset(1 as libc::c_int as isize))[5 as libc::c_int as usize];
        *fresh4 = (*lr).filter_v[1 as libc::c_int as usize] as int16_t;
        ...
        let ref mut fresh5 = (*filter.offset(1 as libc::c_int as isize))[4 as libc::c_int as usize];
    ...
    if restore_planes & LR_RESTORE_Y as libc::c_int != 0 {
        ...
        lr_sbrow(
            ...
            (*dst.offset(0 as libc::c_int as isize)).offset(
                -((offset_y as libc::c_long * *dst_stride.offset(0 as libc::c_int as isize))
                    as isize),
            ),
            y_stripe,
            w,
        ...
        if restore_planes & LR_RESTORE_U as libc::c_int != 0 {
            lr_sbrow(
                ...
                (*dst.offset(1 as libc::c_int as isize)).offset(
                    -((offset_uv as libc::c_long * *dst_stride.offset(1 as libc::c_int as isize))
                        as isize),
                ),
                y_stripe_0,
                w_0,
