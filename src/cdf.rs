...
pub fn av1_default_cdf() -> CdfModeContext {
    let mut init = CdfModeContext {
        ...
        .into(),
        cfl_sign: cdf0d([1418, 2123, 13340, 18405, 26972, 28343, 32294]).into(),
        angle_delta: cdf1d([
        ...
        .into(),
        filter_intra: cdf0d([8949, 12776, 17211, 29558]).into(),
        comp_inter_mode: cdf1d([
        ...
        .into(),
        delta_q: cdf0d([28160, 32120, 32677]).into(),
        delta_lf: cdf1d([
            [28160, 32120, 32677],
            [28160, 32120, 32677],
            [28160, 32120, 32677],
        ...
        .into(),
        restore_switchable: cdf0d([9413, 22581]).into(),
        restore_wiener: cdf0d([11570]).into(),
        restore_sgrproj: cdf0d([16855]).into(),
        interintra: cdf1d([[16384], [26887], [27597], [30237], [0], [0], [0]]).into(),
        interintra_wedge: cdf1d([
            [20036],
            [24957],
            [26704],
            [27530],
        ...
        .into(),
        txtp_inter3: cdf1d([[16384], [4167], [1998], [748]]).into(),
        use_filter_intra: cdf1d([
            [16384],
            [16384],
            [16384],
            [16384],
        ...
        .into(),
        newmv_mode: cdf1d([[24035], [16630], [15339], [8386], [12222], [4676]]).into(),
        globalmv_mode: cdf1d([[2175], [1054]]).into(),
        refmv_mode: cdf1d([[23974], [24188], [17848], [28622], [24312], [19923]]).into(),
        drl_bit: cdf1d([[13104], [24560], [18945]]).into(),
        intra: cdf1d([[806], [16662], [20186], [26538]]).into(),
        comp: cdf1d([[26828], [24035], [12031], [10640], [2901]]).into(),
        comp_dir: cdf1d([[1198], [2070], [9166], [7499], [22475]]).into(),
        jnt_comp: cdf1d([[18244], [12865], [7053], [13259], [9334], [4644]]).into(),
        mask_comp: cdf1d([[26607], [22891], [18840], [24594], [19934], [22674]]).into(),
        wedge_comp: cdf1d([
            [23431],
            [13171],
            [11470],
        ...
        .into(),
        comp_bwd_ref: cdf2d([[[2235], [17182], [30606]], [[1423], [15175], [30489]]]).into(),
        comp_uni_ref: cdf2d([
            [[5284], [23152], [31774]],
            [[3865], [14173], [25120]],
            [[3128], [15270], [26710]],
        ...
        .into(),
        skip: cdf1d([[31671], [16515], [4576]]).into(),
        skip_mode: cdf1d([[32621], [20708], [8127]]).into(),
        seg_pred: cdf1d([[16384], [16384], [16384]]).into(),
        obmc: cdf1d([
            [32638],
            [31560],
            [31014],
        ...
        .into(),
        pal_uv: cdf1d([[32461], [21488]]).into(),
        intrabc: cdf0d([30531]).into(),
    };
    init
}
...
static mut default_mv_joint_cdf: Align8<[uint16_t; 4]> = Align8(cdf0d([4096, 11264, 19328]));
static mut default_kf_y_mode_cdf: Align32<[[[uint16_t; 16]; 5]; 5]> = Align32(cdf2d([
    [
        [
    ...
    [
        {
            let mut init = CdfCoefContext {
                ...
                .into(),
                dc_sign: cdf2d([[[16000], [13056], [18816]], [[15232], [12928], [17280]]]).into(),
            };
            init
        },
        {
