...
pub fn av1_default_cdf() -> CdfModeContext {
    let mut init = CdfModeContext {
        ...
        color_map: [
            [
                [
                    [(32768 - 28710) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 16384) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 10553) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 27036) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 31603) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                ],
                [
                    [
            ...
            [
                [
                    [(32768 - 29089) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 16384) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 8713) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 29257) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                    [(32768 - 31610) as uint16_t, 0, 0, 0, 0, 0, 0, 0],
                ],
                [
                    [
        ...
        filter: [
            [
                ...
                [(32768 - 422) as uint16_t, (32768 - 2938) as uint16_t, 0, 0],
                [
                    (32768 - 28244) as uint16_t,
                ...
                [(32768 - 770) as uint16_t, (32768 - 1152) as uint16_t, 0, 0],
                [
            ...
            [
                ...
                [(32768 - 305) as uint16_t, (32768 - 2247) as uint16_t, 0, 0],
                [
                ...
                [(32768 - 601) as uint16_t, (32768 - 943) as uint16_t, 0, 0],
                [
    ...
    [
        {
            let mut init = CdfCoefContext {
                ...
                eob_base_tok: [
                    ...
                    [
                        [
                            [(32768 - 1787) as uint16_t, (32768 - 2532) as uint16_t, 0, 0],
                            [
                    ...
                    [
                        [
                            [(32768 - 1725) as uint16_t, (32768 - 3449) as uint16_t, 0, 0],
                            [
        ...
        },
        {
            let mut init = CdfCoefContext {
                ...
                eob_base_tok: [
                    ...
                    [
                        [
                            [(32768 - 1044) as uint16_t, (32768 - 2257) as uint16_t, 0, 0],
                            [
                    ...
                    [
                        [
                            [(32768 - 478) as uint16_t, (32768 - 1834) as uint16_t, 0, 0],
                            [
        ...
        },
        {
            let mut init = CdfCoefContext {
                ...
                eob_base_tok: [
                    ...
                    [
                        [
                            [(32768 - 935) as uint16_t, (32768 - 3382) as uint16_t, 0, 0],
                            [
