...
pub fn av1_default_cdf() -> CdfModeContext {
    let mut init = CdfModeContext {
        ...
        .into(),
        cfl_sign: [1418, 2123, 13340, 18405, 26972, 28343, 32294].into(),
        angle_delta: [
        ...
        .into(),
        filter_intra: [8949, 12776, 17211, 29558].into(),
        comp_inter_mode: [
        ...
        .into(),
        delta_q: [28160, 32120, 32677].into(),
        delta_lf: [
            [28160, 32120, 32677],
            [28160, 32120, 32677],
            [28160, 32120, 32677],
        ...
        .into(),
        restore_switchable: [9413, 22581].into(),
        restore_wiener: [11570].into(),
        restore_sgrproj: [16855].into(),
        interintra: [[16384], [26887], [27597], [30237], [0], [0], [0]].into(),
        interintra_wedge: [
            [20036],
            [24957],
            [26704],
        ...
        .into(),
        txtp_inter3: [[16384], [4167], [1998], [748]].into(),
        use_filter_intra: [
            [16384],
            [16384],
            [16384],
        ...
        .into(),
        newmv_mode: [[24035], [16630], [15339], [8386], [12222], [4676]].into(),
        globalmv_mode: [[2175], [1054]].into(),
        refmv_mode: [[23974], [24188], [17848], [28622], [24312], [19923]].into(),
        drl_bit: [[13104], [24560], [18945]].into(),
        intra: [[806], [16662], [20186], [26538]].into(),
        comp: [[26828], [24035], [12031], [10640], [2901]].into(),
        comp_dir: [[1198], [2070], [9166], [7499], [22475]].into(),
        jnt_comp: [[18244], [12865], [7053], [13259], [9334], [4644]].into(),
        mask_comp: [[26607], [22891], [18840], [24594], [19934], [22674]].into(),
        wedge_comp: [
            [23431],
            [13171],
            [11470],
        ...
        .into(),
        comp_bwd_ref: [[[2235], [17182], [30606]], [[1423], [15175], [30489]]].into(),
        comp_uni_ref: [
            [[5284], [23152], [31774]],
            [[3865], [14173], [25120]],
            [[3128], [15270], [26710]],
        ...
        .into(),
        skip: [[31671], [16515], [4576]].into(),
        skip_mode: [[32621], [20708], [8127]].into(),
        seg_pred: [[16384], [16384], [16384]].into(),
        obmc: [
            [32638],
            [31560],
            [31014],
...
pub fn default_mv_component_cdf() -> CdfMvComponent {
    let mut init = CdfMvComponent {
        ...
        .into(),
        class0_fp: [[16384, 24576, 26624], [12288, 21248, 24128]].into(),
        classN_fp: [8192, 17408, 21248].into(),
        class0_hp: [20480].into(),
        classN_hp: [16384].into(),
        class0: [27648].into(),
        classN: [
            [17408],
            [17920],
...
static mut default_mv_joint_cdf: Align8<[uint16_t; 4]> = Align8([4096, 11264, 19328]);
    ...
    [
        {
            let mut init = CdfCoefContext {
                ...
                .into(),
                dc_sign: [[[16000], [13056], [18816]], [[15232], [12928], [17280]]].into(),
            };
            init
        },
        {
