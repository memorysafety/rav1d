...
unsafe extern "C" fn inv_dct4_1d_internal_c(
    ...
    if tx64 != 0 {
        ...
        t2 = (in1 * 1567 as libc::c_int
            - in3 * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) - in3;
        t3 = (in1 * (3784 as libc::c_int - 4096 as libc::c_int)
            + in3 * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in1;
    }
    *c
        .offset(
...
unsafe extern "C" fn inv_dct8_1d_internal_c(
    ...
    if tx64 != 0 {
        ...
        t7a = (in1 * (4017 as libc::c_int - 4096 as libc::c_int)
            + in7 * 799 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in1;
    }
    ...
    let t5: libc::c_int = (t6a - t5a) * 181 as libc::c_int + 128 as libc::c_int
        >> 8 as libc::c_int;
...
unsafe extern "C" fn inv_dct16_1d_internal_c(
    ...
    if tx64 != 0 {
        ...
        t9a = in9 * 1583 as libc::c_int - in7 * 1299 as libc::c_int + 1024 as libc::c_int
            >> 11 as libc::c_int;
        t10a = (in5 * 1931 as libc::c_int
            - in11 * (3612 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) - in11;
        t11a = (in13 * (3920 as libc::c_int - 4096 as libc::c_int)
            - in3 * 1189 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in13;
        t12a = (in13 * 1189 as libc::c_int
            + in3 * (3920 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) + in3;
        t13a = (in5 * (3612 as libc::c_int - 4096 as libc::c_int)
            + in11 * 1931 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in5;
        t14a = in9 * 1299 as libc::c_int + in7 * 1583 as libc::c_int
            + 1024 as libc::c_int >> 11 as libc::c_int;
        t15a = (in1 * (4076 as libc::c_int - 4096 as libc::c_int)
            + in15 * 401 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in1;
    }
    ...
    t9a = (t14 * 1567 as libc::c_int - t9 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t9;
    t14a = (t14 * (3784 as libc::c_int - 4096 as libc::c_int) + t9 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t14;
    t10a = (-(t13 * (3784 as libc::c_int - 4096 as libc::c_int)
        + t10 * 1567 as libc::c_int) + 2048 as libc::c_int >> 12 as libc::c_int) - t13;
    t13a = (t13 * 1567 as libc::c_int - t10 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t10;
...
unsafe extern "C" fn inv_dct32_1d_internal_c(
    ...
    if tx64 != 0 {
        ...
        t17a = (in17 * (3035 as libc::c_int - 4096 as libc::c_int)
            - in15 * 2751 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in17;
        t18a = (in9 * 1751 as libc::c_int
            - in23 * (3703 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) - in23;
        t19a = (in25 * (3857 as libc::c_int - 4096 as libc::c_int)
            - in7 * 1380 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in25;
        t20a = (in5 * 995 as libc::c_int
            - in27 * (3973 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) - in27;
        t21a = (in21 * (3513 as libc::c_int - 4096 as libc::c_int)
            - in11 * 2106 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in21;
        t22a = in13 * 1220 as libc::c_int - in19 * 1645 as libc::c_int
            + 1024 as libc::c_int >> 11 as libc::c_int;
        t23a = (in29 * (4052 as libc::c_int - 4096 as libc::c_int)
            - in3 * 601 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in29;
        t24a = (in29 * 601 as libc::c_int
            + in3 * (4052 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) + in3;
        t25a = in13 * 1645 as libc::c_int + in19 * 1220 as libc::c_int
            + 1024 as libc::c_int >> 11 as libc::c_int;
        t26a = (in21 * 2106 as libc::c_int
            + in11 * (3513 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) + in11;
        t27a = (in5 * (3973 as libc::c_int - 4096 as libc::c_int)
            + in27 * 995 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in5;
        t28a = (in25 * 1380 as libc::c_int
            + in7 * (3857 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) + in7;
        t29a = (in9 * (3703 as libc::c_int - 4096 as libc::c_int)
            + in23 * 1751 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in9;
        t30a = (in17 * 2751 as libc::c_int
            + in15 * (3035 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
            >> 12 as libc::c_int) + in15;
        t31a = (in1 * (4091 as libc::c_int - 4096 as libc::c_int)
            + in31 * 201 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int)
            + in1;
    }
    ...
    t17a = (t30 * 799 as libc::c_int - t17 * (4017 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t17;
    t30a = (t30 * (4017 as libc::c_int - 4096 as libc::c_int) + t17 * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t30;
    t18a = (-(t29 * (4017 as libc::c_int - 4096 as libc::c_int)
        + t18 * 799 as libc::c_int) + 2048 as libc::c_int >> 12 as libc::c_int) - t29;
    t29a = (t29 * 799 as libc::c_int - t18 * (4017 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t18;
    ...
    t18a = (t29 * 1567 as libc::c_int - t18 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t18;
    t29a = (t29 * (3784 as libc::c_int - 4096 as libc::c_int) + t18 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t29;
    t19 = (t28a * 1567 as libc::c_int
        - t19a * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t19a;
    t28 = (t28a * (3784 as libc::c_int - 4096 as libc::c_int)
        + t19a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + t28a;
    t20 = (-(t27a * (3784 as libc::c_int - 4096 as libc::c_int)
        + t20a * 1567 as libc::c_int) + 2048 as libc::c_int >> 12 as libc::c_int) - t27a;
    t27 = (t27a * 1567 as libc::c_int
        - t20a * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t20a;
    t21a = (-(t26 * (3784 as libc::c_int - 4096 as libc::c_int)
        + t21 * 1567 as libc::c_int) + 2048 as libc::c_int >> 12 as libc::c_int) - t26;
    t26a = (t26 * 1567 as libc::c_int - t21 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t21;
...
pub unsafe extern "C" fn dav1d_inv_dct64_1d_c(
    ...
    let mut t33a: libc::c_int = in31 * -(2824 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t34a: libc::c_int = in17 * 1660 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t35a: libc::c_int = in15 * -(1474 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t36a: libc::c_int = in9 * 897 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t37a: libc::c_int = in23 * -(2191 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t38a: libc::c_int = in25 * 2359 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t39a: libc::c_int = in7 * -(700 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t40a: libc::c_int = in5 * 501 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t41a: libc::c_int = in27 * -(2520 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t42a: libc::c_int = in21 * 2019 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t43a: libc::c_int = in11 * -(1092 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t44a: libc::c_int = in13 * 1285 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t45a: libc::c_int = in19 * -(1842 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t46a: libc::c_int = in29 * 2675 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t47a: libc::c_int = in3 * -(301 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t48a: libc::c_int = in3 * 4085 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t49a: libc::c_int = in29 * 3102 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t50a: libc::c_int = in19 * 3659 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t51a: libc::c_int = in13 * 3889 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t52a: libc::c_int = in11 * 3948 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t53a: libc::c_int = in21 * 3564 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t54a: libc::c_int = in27 * 3229 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t55a: libc::c_int = in5 * 4065 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t56a: libc::c_int = in7 * 4036 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t57a: libc::c_int = in25 * 3349 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t58a: libc::c_int = in23 * 3461 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t59a: libc::c_int = in9 * 3996 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t60a: libc::c_int = in15 * 3822 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t61a: libc::c_int = in17 * 3745 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t62a: libc::c_int = in31 * 2967 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    let mut t63a: libc::c_int = in1 * 4095 as libc::c_int + 2048 as libc::c_int
        >> 12 as libc::c_int;
    ...
    t33a = (t33 * (4096 as libc::c_int - 4076 as libc::c_int) + t62 * 401 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t33;
    t34a = (t34 * -(401 as libc::c_int)
        + t61 * (4096 as libc::c_int - 4076 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t61;
    t37a = t37 * -(1299 as libc::c_int) + t58 * 1583 as libc::c_int + 1024 as libc::c_int
        >> 11 as libc::c_int;
    t38a = t38 * -(1583 as libc::c_int) + t57 * -(1299 as libc::c_int)
        + 1024 as libc::c_int >> 11 as libc::c_int;
    t41a = (t41 * (4096 as libc::c_int - 3612 as libc::c_int) + t54 * 1931 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t41;
    t42a = (t42 * -(1931 as libc::c_int)
        + t53 * (4096 as libc::c_int - 3612 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t53;
    t45a = (t45 * -(1189 as libc::c_int)
        + t50 * (3920 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + t50;
    t46a = (t46 * (4096 as libc::c_int - 3920 as libc::c_int)
        + t49 * -(1189 as libc::c_int) + 2048 as libc::c_int >> 12 as libc::c_int) - t46;
    t49a = (t46 * -(1189 as libc::c_int)
        + t49 * (3920 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + t49;
    t50a = (t45 * (3920 as libc::c_int - 4096 as libc::c_int) + t50 * 1189 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t45;
    t53a = (t42 * (4096 as libc::c_int - 3612 as libc::c_int) + t53 * 1931 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t42;
    t54a = (t41 * 1931 as libc::c_int + t54 * (3612 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t54;
    ...
    t58a = t37 * 1583 as libc::c_int + t58 * 1299 as libc::c_int + 1024 as libc::c_int
        >> 11 as libc::c_int;
    t61a = (t34 * (4096 as libc::c_int - 4076 as libc::c_int) + t61 * 401 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t34;
    t62a = (t33 * 401 as libc::c_int + t62 * (4076 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t62;
    ...
    t34a = (t34 * (4096 as libc::c_int - 4017 as libc::c_int) + t61 * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t34;
    t35 = (t35a * (4096 as libc::c_int - 4017 as libc::c_int) + t60a * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t35a;
    t36 = (t36a * -(799 as libc::c_int)
        + t59a * (4096 as libc::c_int - 4017 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t59a;
    t37a = (t37 * -(799 as libc::c_int)
        + t58 * (4096 as libc::c_int - 4017 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t58;
    t42a = t42 * -(1138 as libc::c_int) + t53 * 1703 as libc::c_int + 1024 as libc::c_int
        >> 11 as libc::c_int;
    t43 = t43a * -(1138 as libc::c_int) + t52a * 1703 as libc::c_int
        + 1024 as libc::c_int >> 11 as libc::c_int;
    ...
    t50a = t45 * -(1138 as libc::c_int) + t50 * 1703 as libc::c_int + 1024 as libc::c_int
        >> 11 as libc::c_int;
    t51 = t44a * -(1138 as libc::c_int) + t51a * 1703 as libc::c_int
        + 1024 as libc::c_int >> 11 as libc::c_int;
    ...
    t53a = t42 * 1703 as libc::c_int + t53 * 1138 as libc::c_int + 1024 as libc::c_int
        >> 11 as libc::c_int;
    t58a = (t37 * (4096 as libc::c_int - 4017 as libc::c_int) + t58 * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t37;
    t59 = (t36a * (4096 as libc::c_int - 4017 as libc::c_int) + t59a * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t36a;
    t60 = (t35a * 799 as libc::c_int + t60a * (4017 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t60a;
    t61a = (t34 * 799 as libc::c_int + t61 * (4017 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t61;
    ...
    t36 = (t36a * (4096 as libc::c_int - 3784 as libc::c_int)
        + t59a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) - t36a;
    t37a = (t37 * (4096 as libc::c_int - 3784 as libc::c_int) + t58 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t37;
    t38 = (t38a * (4096 as libc::c_int - 3784 as libc::c_int)
        + t57a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) - t38a;
    t39a = (t39 * (4096 as libc::c_int - 3784 as libc::c_int) + t56 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t39;
    t40a = (t40 * -(1567 as libc::c_int)
        + t55 * (4096 as libc::c_int - 3784 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t55;
    t41 = (t41a * -(1567 as libc::c_int)
        + t54a * (4096 as libc::c_int - 3784 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t54a;
    t42a = (t42 * -(1567 as libc::c_int)
        + t53 * (4096 as libc::c_int - 3784 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t53;
    t43 = (t43a * -(1567 as libc::c_int)
        + t52a * (4096 as libc::c_int - 3784 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t52a;
    t52 = (t43a * (4096 as libc::c_int - 3784 as libc::c_int)
        + t52a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) - t43a;
    t53a = (t42 * (4096 as libc::c_int - 3784 as libc::c_int) + t53 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t42;
    t54 = (t41a * (4096 as libc::c_int - 3784 as libc::c_int)
        + t54a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) - t41a;
    t55a = (t40 * (4096 as libc::c_int - 3784 as libc::c_int) + t55 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) - t40;
    t56a = (t39 * 1567 as libc::c_int + t56 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t56;
    t57 = (t38a * 1567 as libc::c_int
        + t57a * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + t57a;
    t58a = (t37 * 1567 as libc::c_int + t58 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t58;
    t59 = (t36a * 1567 as libc::c_int
        + t59a * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + t59a;
...
unsafe extern "C" fn inv_adst8_1d_internal_c(
    ...
    let t1a: libc::c_int = (401 as libc::c_int * in7
        - (4076 as libc::c_int - 4096 as libc::c_int) * in0 + 2048 as libc::c_int
        >> 12 as libc::c_int) - in0;
    let t2a: libc::c_int = ((3612 as libc::c_int - 4096 as libc::c_int) * in5
        + 1931 as libc::c_int * in2 + 2048 as libc::c_int >> 12 as libc::c_int) + in5;
    let t3a: libc::c_int = (1931 as libc::c_int * in5
        - (3612 as libc::c_int - 4096 as libc::c_int) * in2 + 2048 as libc::c_int
        >> 12 as libc::c_int) - in2;
    let mut t4a: libc::c_int = 1299 as libc::c_int * in3 + 1583 as libc::c_int * in4
        + 1024 as libc::c_int >> 11 as libc::c_int;
    let mut t5a: libc::c_int = 1583 as libc::c_int * in3 - 1299 as libc::c_int * in4
        + 1024 as libc::c_int >> 11 as libc::c_int;
    let mut t6a: libc::c_int = (1189 as libc::c_int * in1
        + (3920 as libc::c_int - 4096 as libc::c_int) * in6 + 2048 as libc::c_int
        >> 12 as libc::c_int) + in6;
    let mut t7a: libc::c_int = ((3920 as libc::c_int - 4096 as libc::c_int) * in1
        - 1189 as libc::c_int * in6 + 2048 as libc::c_int >> 12 as libc::c_int) + in1;
    ...
    t4a = ((3784 as libc::c_int - 4096 as libc::c_int) * t4 + 1567 as libc::c_int * t5
        + 2048 as libc::c_int >> 12 as libc::c_int) + t4;
    t5a = (1567 as libc::c_int * t4 - (3784 as libc::c_int - 4096 as libc::c_int) * t5
        + 2048 as libc::c_int >> 12 as libc::c_int) - t5;
    t6a = ((3784 as libc::c_int - 4096 as libc::c_int) * t7 - 1567 as libc::c_int * t6
        + 2048 as libc::c_int >> 12 as libc::c_int) + t7;
    t7a = (1567 as libc::c_int * t7 + (3784 as libc::c_int - 4096 as libc::c_int) * t6
...
unsafe extern "C" fn inv_adst16_1d_internal_c(
    ...
    let mut t1: libc::c_int = (in15 * 201 as libc::c_int
        - in0 * (4091 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - in0;
    let mut t2: libc::c_int = (in13 * (3973 as libc::c_int - 4096 as libc::c_int)
        + in2 * 995 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in13;
    let mut t3: libc::c_int = (in13 * 995 as libc::c_int
        - in2 * (3973 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - in2;
    let mut t4: libc::c_int = (in11 * (3703 as libc::c_int - 4096 as libc::c_int)
        + in4 * 1751 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in11;
    let mut t5: libc::c_int = (in11 * 1751 as libc::c_int
        - in4 * (3703 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - in4;
    let mut t6: libc::c_int = in9 * 1645 as libc::c_int + in6 * 1220 as libc::c_int
        + 1024 as libc::c_int >> 11 as libc::c_int;
    let mut t7: libc::c_int = in9 * 1220 as libc::c_int - in6 * 1645 as libc::c_int
        + 1024 as libc::c_int >> 11 as libc::c_int;
    let mut t8: libc::c_int = (in7 * 2751 as libc::c_int
        + in8 * (3035 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + in8;
    let mut t9: libc::c_int = (in7 * (3035 as libc::c_int - 4096 as libc::c_int)
        - in8 * 2751 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in7;
    let mut t10: libc::c_int = (in5 * 2106 as libc::c_int
        + in10 * (3513 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + in10;
    let mut t11: libc::c_int = (in5 * (3513 as libc::c_int - 4096 as libc::c_int)
        - in10 * 2106 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in5;
    let mut t12: libc::c_int = (in3 * 1380 as libc::c_int
        + in12 * (3857 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + in12;
    let mut t13: libc::c_int = (in3 * (3857 as libc::c_int - 4096 as libc::c_int)
        - in12 * 1380 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in3;
    let mut t14: libc::c_int = (in1 * 601 as libc::c_int
        + in14 * (4052 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + in14;
    let mut t15: libc::c_int = (in1 * (4052 as libc::c_int - 4096 as libc::c_int)
        - in14 * 601 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + in1;
    ...
    t8 = (t8a * (4017 as libc::c_int - 4096 as libc::c_int) + t9a * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t8a;
    t9 = (t8a * 799 as libc::c_int - t9a * (4017 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) - t9a;
    t10 = (t10a * 2276 as libc::c_int
        + t11a * (3406 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + t11a;
    t11 = (t10a * (3406 as libc::c_int - 4096 as libc::c_int)
        - t11a * 2276 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + t10a;
    t12 = (t13a * (4017 as libc::c_int - 4096 as libc::c_int) - t12a * 799 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t13a;
    t13 = (t13a * 799 as libc::c_int + t12a * (4017 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t12a;
    t14 = (t15a * 2276 as libc::c_int
        - t14a * (3406 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t14a;
    t15 = (t15a * (3406 as libc::c_int - 4096 as libc::c_int)
        + t14a * 2276 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + t15a;
    ...
    t4a = (t4 * (3784 as libc::c_int - 4096 as libc::c_int) + t5 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t4;
    ...
    t6a = (t7 * (3784 as libc::c_int - 4096 as libc::c_int) - t6 * 1567 as libc::c_int
        + 2048 as libc::c_int >> 12 as libc::c_int) + t7;
    t7a = (t7 * 1567 as libc::c_int + t6 * (3784 as libc::c_int - 4096 as libc::c_int)
        + 2048 as libc::c_int >> 12 as libc::c_int) + t6;
    t12 = (t12a * (3784 as libc::c_int - 4096 as libc::c_int)
        + t13a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + t12a;
    t13 = (t12a * 1567 as libc::c_int
        - t13a * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) - t13a;
    t14 = (t15a * (3784 as libc::c_int - 4096 as libc::c_int)
        - t14a * 1567 as libc::c_int + 2048 as libc::c_int >> 12 as libc::c_int) + t15a;
    t15 = (t15a * 1567 as libc::c_int
        + t14a * (3784 as libc::c_int - 4096 as libc::c_int) + 2048 as libc::c_int
        >> 12 as libc::c_int) + t14a;
    *out
        .offset(
            (0 as libc::c_int as libc::c_long * out_s) as isize,
