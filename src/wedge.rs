    ...
    dav1d_ii_masks = [
        ...
        [
            [
                ...
                ii_nondc_mask_32x32.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_32x32.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_32x32.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_16x32.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_16x32.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_16x32.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_16x16.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_16x16.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_16x16.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
        ],
        [
            [
        ...
        [
            ...
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_8x32.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_8x32.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_8x32.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_8x16.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_8x16.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_8x16.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
        ],
        [
            [
            ...
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_8x8.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_8x8.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_8x8.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
        ],
        [
            [
        ...
        [
            ...
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_4x16.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_4x16.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_4x16.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_4x8.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_4x8.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_4x8.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
        ],
        [
            [
            ...
            [
                ii_dc_mask.0.as_mut_ptr() as *const u8,
                ii_nondc_mask_4x4.0[II_VERT_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_4x4.0[II_HOR_PRED as usize - 1].as_mut_ptr() as *const u8,
                ii_nondc_mask_4x4.0[II_SMOOTH_PRED as usize - 1].as_mut_ptr() as *const u8,
            ],
        ],
        [[0 as *const u8; 4]; 3],
        [[0 as *const u8; 4]; 3],
