...
impl TryFrom<Dav1dSettings> for Rav1dSettings {
    ...
    fn try_from(value: Dav1dSettings) -> Result<Self, Self::Error> {
        ...
        validate_input!((n_threads <= 256, Rav1dError::EINVAL))?;
        validate_input!((max_frame_delay <= 256, Rav1dError::EINVAL))?;
        validate_input!((operating_point <= 31, Rav1dError::EINVAL))?;
        Ok(Self {
            n_threads: n_threads.try_into().map_err(|_| Rav1dError::EINVAL)?,
            max_frame_delay: max_frame_delay.try_into().map_err(|_| Rav1dError::EINVAL)?,
            apply_grain: apply_grain != 0,
            operating_point: operating_point.try_into().map_err(|_| Rav1dError::EINVAL)?,
