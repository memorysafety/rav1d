...
static mut cfl_allowed_mask: libc::c_uint = ((1i32) << BS_32x32 as libc::c_int
    | (1i32) << BS_32x16 as libc::c_int
    | (1i32) << BS_32x8 as libc::c_int
    | (1i32) << BS_16x32 as libc::c_int
    | (1i32) << BS_16x16 as libc::c_int
    | (1i32) << BS_16x8 as libc::c_int
    | (1i32) << BS_16x4 as libc::c_int
    | (1i32) << BS_8x32 as libc::c_int
    | (1i32) << BS_8x16 as libc::c_int
    | (1i32) << BS_8x8 as libc::c_int
    | (1i32) << BS_8x4 as libc::c_int
    | (1i32) << BS_4x16 as libc::c_int
    | (1i32) << BS_4x8 as libc::c_int
    | (1i32) << BS_4x4 as libc::c_int) as libc::c_uint;
static mut wedge_allowed_mask: libc::c_uint = ((1i32) << BS_32x32 as libc::c_int
    | (1i32) << BS_32x16 as libc::c_int
    | (1i32) << BS_32x8 as libc::c_int
    | (1i32) << BS_16x32 as libc::c_int
    | (1i32) << BS_16x16 as libc::c_int
    ...
    | (1i32) << BS_8x8 as libc::c_int)
    as libc::c_uint;
static mut interintra_allowed_mask: libc::c_uint = ((1i32) << BS_32x32 as libc::c_int
    | (1i32) << BS_32x16 as libc::c_int
    | (1i32) << BS_16x32 as libc::c_int
    | (1i32) << BS_16x16 as libc::c_int
    | (1i32) << BS_16x8 as libc::c_int
...
unsafe extern "C" fn get_intra_ctx(
    ...
    if have_left != 0 {
        if have_top != 0 {
            ...
            return ctx + (ctx == 2i32) as libc::c_int;
        } else {
            return (*l).intra[yb4 as usize] as libc::c_int * 2i32;
        }
    } else {
        return if have_top != 0 {
            (*a).intra[xb4 as usize] as libc::c_int * 2i32
        } else {
            0i32
        };
    };
...
unsafe extern "C" fn get_partition_ctx(
    ...
    return ((*a).partition[xb8 as usize] as libc::c_int >> (4u32).wrapping_sub(bl) & 1i32)
        + (((*l).partition[yb8 as usize] as libc::c_int >> (4u32).wrapping_sub(bl) & 1i32)
            << 1i32);
}
#[inline]
unsafe extern "C" fn gather_left_partition_prob(
    ...
    let mut out: libc::c_uint = (*in_0.offset((PARTITION_H as libc::c_int - 1i32) as isize)
        as libc::c_int
        - *in_0.offset(PARTITION_H as libc::c_int as isize) as libc::c_int)
        as libc::c_uint;
    out = out.wrapping_add(
        (*in_0.offset((PARTITION_SPLIT as libc::c_int - 1i32) as isize) as libc::c_int
            - *in_0.offset(PARTITION_T_LEFT_SPLIT as libc::c_int as isize) as libc::c_int)
            as libc::c_uint,
    );
    if bl != BL_128X128 {
        out = out.wrapping_add(
            (*in_0.offset((PARTITION_H4 as libc::c_int - 1i32) as isize) as libc::c_int
...
unsafe extern "C" fn gather_top_partition_prob(
    ...
    let mut out: libc::c_uint = (*in_0.offset((PARTITION_V as libc::c_int - 1i32) as isize)
        as libc::c_int
        - *in_0.offset(PARTITION_T_TOP_SPLIT as libc::c_int as isize) as libc::c_int)
        as libc::c_uint;
    out = out.wrapping_add(
        *in_0.offset((PARTITION_T_LEFT_SPLIT as libc::c_int - 1i32) as isize) as libc::c_uint,
    );
    if bl != BL_128X128 {
        out = out.wrapping_add(
            (*in_0.offset((PARTITION_V4 as libc::c_int - 1i32) as isize) as libc::c_int
...
unsafe extern "C" fn get_filter_ctx(
    ...
    let a_filter: libc::c_int = if (*a).ref_0[0usize][xb4 as usize] as libc::c_int == ref_0
        || (*a).ref_0[1usize][xb4 as usize] as libc::c_int == ref_0
    {
        (*a).filter[dir as usize][xb4 as usize] as libc::c_int
    } else {
        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int
    };
    let l_filter: libc::c_int = if (*l).ref_0[0usize][yb4 as usize] as libc::c_int == ref_0
        || (*l).ref_0[1usize][yb4 as usize] as libc::c_int == ref_0
    {
...
unsafe extern "C" fn get_comp_ctx(
    ...
    if have_top != 0 {
        if have_left != 0 {
            if (*a).comp_type[xb4 as usize] != 0 {
                if (*l).comp_type[yb4 as usize] != 0 {
                    ...
                    return 2i32
                        + ((*l).ref_0[0usize][yb4 as usize] as libc::c_uint >= 4u32)
                            as libc::c_int;
                }
            } else if (*l).comp_type[yb4 as usize] != 0 {
                return 2i32
                    + ((*a).ref_0[0usize][xb4 as usize] as libc::c_uint >= 4u32) as libc::c_int;
            } else {
                return ((*l).ref_0[0usize][yb4 as usize] as libc::c_int >= 4i32) as libc::c_int
                    ^ ((*a).ref_0[0usize][xb4 as usize] as libc::c_int >= 4i32) as libc::c_int;
            }
        } else {
        ...
        return if (*l).comp_type[yb4 as usize] as libc::c_int != 0 {
            ...
            ((*l).ref_0[0usize][yb4 as usize] as libc::c_int >= 4i32) as libc::c_int
        };
    } else {
        return 1i32;
    };
...
unsafe extern "C" fn get_comp_dir_ctx(
    ...
    if have_top != 0 && have_left != 0 {
        ...
        if a_intra != 0 || l_intra != 0 {
            ...
            return 1i32
                + 2i32
                    * ((((*edge).ref_0[0usize][off as usize] as libc::c_int) < 4i32) as libc::c_int
                        == (((*edge).ref_0[1usize][off as usize] as libc::c_int) < 4i32)
        ...
        let l_comp: libc::c_int = ((*l).comp_type[yb4 as usize] as libc::c_int
            != COMP_INTER_NONE as libc::c_int) as libc::c_int;
        let a_ref0: libc::c_int = (*a).ref_0[0usize][xb4 as usize] as libc::c_int;
        let l_ref0: libc::c_int = (*l).ref_0[0usize][yb4 as usize] as libc::c_int;
        if a_comp == 0 && l_comp == 0 {
            return 1i32
                + 2i32
                    * ((a_ref0 >= 4i32) as libc::c_int == (l_ref0 >= 4i32) as libc::c_int)
                        as libc::c_int;
        } else if a_comp == 0 || l_comp == 0 {
            let edge_0: *const BlockContext = if a_comp != 0 { a } else { l };
            let off_0: libc::c_int = if a_comp != 0 { xb4 } else { yb4 };
            if !((((*edge_0).ref_0[0usize][off_0 as usize] as libc::c_int) < 4i32) as libc::c_int
                == (((*edge_0).ref_0[1usize][off_0 as usize] as libc::c_int) < 4i32) as libc::c_int)
            {
                return 1i32;
            }
            return 3i32
            ...
            let a_uni: libc::c_int = ((((*a).ref_0[0usize][xb4 as usize] as libc::c_int) < 4i32)
                as libc::c_int
                == (((*a).ref_0[1usize][xb4 as usize] as libc::c_int) < 4i32) as libc::c_int)
                as libc::c_int;
            let l_uni: libc::c_int = ((((*l).ref_0[0usize][yb4 as usize] as libc::c_int) < 4i32)
                as libc::c_int
                == (((*l).ref_0[1usize][yb4 as usize] as libc::c_int) < 4i32) as libc::c_int)
                as libc::c_int;
            if a_uni == 0 && l_uni == 0 {
                return 0i32;
            }
        ...
        return 4i32
            * ((((*edge_1).ref_0[0usize][off_1 as usize] as libc::c_int) < 4i32) as libc::c_int
                == (((*edge_1).ref_0[1usize][off_1 as usize] as libc::c_int) < 4i32) as libc::c_int)
                as libc::c_int;
    } else {
        return 2i32;
    };
...
unsafe extern "C" fn get_jnt_comp_ctx(
    ...
    let d0: libc::c_uint = abs(get_poc_diff(
        order_hint_n_bits,
        ref0poc as libc::c_int,
        poc as libc::c_int,
    )) as libc::c_uint;
    let d1: libc::c_uint = abs(get_poc_diff(
        order_hint_n_bits,
        poc as libc::c_int,
        ref1poc as libc::c_int,
    )) as libc::c_uint;
    let offset: libc::c_int = (d0 == d1) as libc::c_int;
    let a_ctx: libc::c_int =
        ((*a).comp_type[xb4 as usize] as libc::c_int >= COMP_INTER_AVG as libc::c_int
            || (*a).ref_0[0usize][xb4 as usize] as libc::c_int == 6i32) as libc::c_int;
    let l_ctx: libc::c_int =
        ((*l).comp_type[yb4 as usize] as libc::c_int >= COMP_INTER_AVG as libc::c_int
            || (*l).ref_0[0usize][yb4 as usize] as libc::c_int == 6i32) as libc::c_int;
    return 3i32 * offset + a_ctx + l_ctx;
}
#[inline]
unsafe extern "C" fn get_mask_comp_ctx(
    ...
    let a_ctx: libc::c_int =
        if (*a).comp_type[xb4 as usize] as libc::c_int >= COMP_INTER_SEG as libc::c_int {
            1i32
        } else if (*a).ref_0[0usize][xb4 as usize] as libc::c_int == 6i32 {
            3i32
        } else {
            0i32
        };
    let l_ctx: libc::c_int =
        if (*l).comp_type[yb4 as usize] as libc::c_int >= COMP_INTER_SEG as libc::c_int {
            1i32
        } else if (*l).ref_0[0usize][yb4 as usize] as libc::c_int == 6i32 {
            3i32
        } else {
            0i32
        };
    return imin(a_ctx + l_ctx, 5i32);
}
#[inline]
unsafe extern "C" fn av1_get_ref_ctx(
    ...
    let mut cnt: [libc::c_int; 2] = [0i32, 0];
    if have_top != 0 && (*a).intra[xb4 as usize] == 0 {
        cnt[((*a).ref_0[0usize][xb4 as usize] as libc::c_int >= 4i32) as libc::c_int as usize] += 1;
        if (*a).comp_type[xb4 as usize] != 0 {
            cnt[((*a).ref_0[1usize][xb4 as usize] as libc::c_int >= 4i32) as libc::c_int
                as usize] += 1;
        }
    }
    if have_left != 0 && (*l).intra[yb4 as usize] == 0 {
        cnt[((*l).ref_0[0usize][yb4 as usize] as libc::c_int >= 4i32) as libc::c_int as usize] += 1;
        if (*l).comp_type[yb4 as usize] != 0 {
            cnt[((*l).ref_0[1usize][yb4 as usize] as libc::c_int >= 4i32) as libc::c_int
                as usize] += 1;
        }
    }
    return if cnt[0usize] == cnt[1usize] {
        1i32
    } else if cnt[0usize] < cnt[1usize] {
        0i32
    } else {
        2i32
    };
...
unsafe extern "C" fn av1_get_fwd_ref_ctx(
    ...
    let mut cnt: [libc::c_int; 4] = [0i32, 0, 0, 0];
    if have_top != 0 && (*a).intra[xb4 as usize] == 0 {
        if ((*a).ref_0[0usize][xb4 as usize] as libc::c_int) < 4i32 {
            cnt[(*a).ref_0[0usize][xb4 as usize] as usize] += 1;
        }
        if (*a).comp_type[xb4 as usize] as libc::c_int != 0
            && ((*a).ref_0[1usize][xb4 as usize] as libc::c_int) < 4i32
        {
            cnt[(*a).ref_0[1usize][xb4 as usize] as usize] += 1;
        }
    }
    if have_left != 0 && (*l).intra[yb4 as usize] == 0 {
        if ((*l).ref_0[0usize][yb4 as usize] as libc::c_int) < 4i32 {
            cnt[(*l).ref_0[0usize][yb4 as usize] as usize] += 1;
        }
        if (*l).comp_type[yb4 as usize] as libc::c_int != 0
            && ((*l).ref_0[1usize][yb4 as usize] as libc::c_int) < 4i32
        {
            cnt[(*l).ref_0[1usize][yb4 as usize] as usize] += 1;
        }
    }
    cnt[0usize] += cnt[1usize];
    cnt[2usize] += cnt[3usize];
    return if cnt[0usize] == cnt[2usize] {
        1i32
    } else if cnt[0usize] < cnt[2usize] {
        0i32
    } else {
        2i32
    };
...
unsafe extern "C" fn av1_get_fwd_ref_1_ctx(
    ...
    let mut cnt: [libc::c_int; 2] = [0i32, 0];
    if have_top != 0 && (*a).intra[xb4 as usize] == 0 {
        if ((*a).ref_0[0usize][xb4 as usize] as libc::c_int) < 2i32 {
            cnt[(*a).ref_0[0usize][xb4 as usize] as usize] += 1;
        }
        if (*a).comp_type[xb4 as usize] as libc::c_int != 0
            && ((*a).ref_0[1usize][xb4 as usize] as libc::c_int) < 2i32
        {
            cnt[(*a).ref_0[1usize][xb4 as usize] as usize] += 1;
        }
    }
    if have_left != 0 && (*l).intra[yb4 as usize] == 0 {
        if ((*l).ref_0[0usize][yb4 as usize] as libc::c_int) < 2i32 {
            cnt[(*l).ref_0[0usize][yb4 as usize] as usize] += 1;
        }
        if (*l).comp_type[yb4 as usize] as libc::c_int != 0
            && ((*l).ref_0[1usize][yb4 as usize] as libc::c_int) < 2i32
        {
            cnt[(*l).ref_0[1usize][yb4 as usize] as usize] += 1;
        }
    }
...
unsafe extern "C" fn av1_get_fwd_ref_2_ctx(
    ...
    let mut cnt: [libc::c_int; 2] = [0i32, 0];
    if have_top != 0 && (*a).intra[xb4 as usize] == 0 {
        if ((*a).ref_0[0usize][xb4 as usize] as libc::c_uint ^ 2u32) < 2u32 {
            cnt[((*a).ref_0[0usize][xb4 as usize] as libc::c_int - 2i32) as usize] += 1;
        }
        if (*a).comp_type[xb4 as usize] as libc::c_int != 0
            && ((*a).ref_0[1usize][xb4 as usize] as libc::c_uint ^ 2u32) < 2u32
        {
            cnt[((*a).ref_0[1usize][xb4 as usize] as libc::c_int - 2i32) as usize] += 1;
        }
    }
    if have_left != 0 && (*l).intra[yb4 as usize] == 0 {
        if ((*l).ref_0[0usize][yb4 as usize] as libc::c_uint ^ 2u32) < 2u32 {
            cnt[((*l).ref_0[0usize][yb4 as usize] as libc::c_int - 2i32) as usize] += 1;
        }
        if (*l).comp_type[yb4 as usize] as libc::c_int != 0
            && ((*l).ref_0[1usize][yb4 as usize] as libc::c_uint ^ 2u32) < 2u32
        {
            cnt[((*l).ref_0[1usize][yb4 as usize] as libc::c_int - 2i32) as usize] += 1;
        }
    }
    return if cnt[0usize] == cnt[1usize] {
        1i32
...
unsafe extern "C" fn av1_get_bwd_ref_ctx(
    ...
    let mut cnt: [libc::c_int; 3] = [0i32, 0, 0];
    if have_top != 0 && (*a).intra[xb4 as usize] == 0 {
        if (*a).ref_0[0usize][xb4 as usize] as libc::c_int >= 4i32 {
            cnt[((*a).ref_0[0usize][xb4 as usize] as libc::c_int - 4i32) as usize] += 1;
        }
        if (*a).comp_type[xb4 as usize] as libc::c_int != 0
            && (*a).ref_0[1usize][xb4 as usize] as libc::c_int >= 4i32
        {
            cnt[((*a).ref_0[1usize][xb4 as usize] as libc::c_int - 4i32) as usize] += 1;
        }
    }
    if have_left != 0 && (*l).intra[yb4 as usize] == 0 {
        if (*l).ref_0[0usize][yb4 as usize] as libc::c_int >= 4i32 {
            cnt[((*l).ref_0[0usize][yb4 as usize] as libc::c_int - 4i32) as usize] += 1;
        }
        if (*l).comp_type[yb4 as usize] as libc::c_int != 0
            && (*l).ref_0[1usize][yb4 as usize] as libc::c_int >= 4i32
        {
            cnt[((*l).ref_0[1usize][yb4 as usize] as libc::c_int - 4i32) as usize] += 1;
        }
    }
    cnt[1usize] += cnt[0usize];
    return if cnt[2usize] == cnt[1usize] {
        1i32
    } else if cnt[1usize] < cnt[2usize] {
        0i32
    } else {
        2i32
    };
...
unsafe extern "C" fn av1_get_uni_p1_ctx(
    ...
    let mut cnt: [libc::c_int; 3] = [0i32, 0, 0];
    if have_top != 0 && (*a).intra[xb4 as usize] == 0 {
        if ((*a).ref_0[0usize][xb4 as usize] as libc::c_uint).wrapping_sub(1u32) < 3u32 {
            cnt[((*a).ref_0[0usize][xb4 as usize] as libc::c_int - 1i32) as usize] += 1;
        }
        if (*a).comp_type[xb4 as usize] as libc::c_int != 0
            && ((*a).ref_0[1usize][xb4 as usize] as libc::c_uint).wrapping_sub(1u32) < 3u32
        {
            cnt[((*a).ref_0[1usize][xb4 as usize] as libc::c_int - 1i32) as usize] += 1;
        }
    }
    if have_left != 0 && (*l).intra[yb4 as usize] == 0 {
        if ((*l).ref_0[0usize][yb4 as usize] as libc::c_uint).wrapping_sub(1u32) < 3u32 {
            cnt[((*l).ref_0[0usize][yb4 as usize] as libc::c_int - 1i32) as usize] += 1;
        }
        if (*l).comp_type[yb4 as usize] as libc::c_int != 0
            && ((*l).ref_0[1usize][yb4 as usize] as libc::c_uint).wrapping_sub(1u32) < 3u32
        {
            cnt[((*l).ref_0[1usize][yb4 as usize] as libc::c_int - 1i32) as usize] += 1;
        }
    }
    cnt[1usize] += cnt[2usize];
    return if cnt[0usize] == cnt[1usize] {
        1i32
    } else if cnt[0usize] < cnt[1usize] {
        0i32
...
unsafe extern "C" fn get_drl_context(
    ...
    if (*ref_mv_stack.offset(ref_idx as isize)).weight >= 640i32 {
        return ((*ref_mv_stack.offset((ref_idx + 1i32) as isize)).weight < 640i32) as libc::c_int;
    }
    return if (*ref_mv_stack.offset((ref_idx + 1i32) as isize)).weight < 640i32 {
        2i32
    } else {
        0i32
    };
...
unsafe extern "C" fn get_cur_frame_segid(
    ...
    cur_seg_map = cur_seg_map.offset((bx as libc::c_long + by as libc::c_long * stride) as isize);
    if have_left != 0 && have_top != 0 {
        let l: libc::c_int = *cur_seg_map.offset(-1isize) as libc::c_int;
        let a: libc::c_int = *cur_seg_map.offset(-stride as isize) as libc::c_int;
        let al: libc::c_int = *cur_seg_map.offset(-(stride + 1i64) as isize) as libc::c_int;
        if l == a && al == l {
            *seg_ctx = 2i32;
        ...
        *seg_ctx = 0i32;
        return (if have_left != 0 {
            *cur_seg_map.offset(-1isize) as libc::c_int
        } else if have_top != 0 {
...
unsafe extern "C" fn get_gmv_2d(
    ...
    match (*gmv).type_0 {
        ...
        0 => {
            return mv {
                c2rust_unnamed: {
                    let mut init = C2RustUnnamed_25 { y: 0i16, x: 0i16 };
                    init
                },
            };
        }
...
unsafe extern "C" fn dav1d_msac_decode_uniform(
    ...
    let l: libc::c_int = ulog2(n) + 1i32;
    if !(l > 1i32) {
        unreachable!();
    }
    let m: libc::c_uint = (((1i32) << l) as libc::c_uint).wrapping_sub(n);
    let v: libc::c_uint = dav1d_msac_decode_bools(s, (l - 1i32) as libc::c_uint);
    return (if v < m {
        v
    } else {
        (v << 1i32)
...
unsafe extern "C" fn init_quant_tables(
        ...
        })
    {
        ...
        (*dq.offset(i as isize))[0usize][0usize] =
            dav1d_dq_tbl[(*seq_hdr).hbd as usize][ydc as usize][0usize];
        (*dq.offset(i as isize))[0usize][1usize] =
            dav1d_dq_tbl[(*seq_hdr).hbd as usize][yac as usize][1usize];
        (*dq.offset(i as isize))[1usize][0usize] =
            dav1d_dq_tbl[(*seq_hdr).hbd as usize][udc as usize][0usize];
        (*dq.offset(i as isize))[1usize][1usize] =
            dav1d_dq_tbl[(*seq_hdr).hbd as usize][uac as usize][1usize];
        (*dq.offset(i as isize))[2usize][0usize] =
            dav1d_dq_tbl[(*seq_hdr).hbd as usize][vdc as usize][0usize];
        (*dq.offset(i as isize))[2usize][1usize] =
            dav1d_dq_tbl[(*seq_hdr).hbd as usize][vac as usize][1usize];
        i += 1;
    }
}
unsafe extern "C" fn read_mv_component_diff(
    ...
    let sign: libc::c_int =
        dav1d_msac_decode_bool_adapt(&mut (*ts).msac, ((*mv_comp).sign.0).as_mut_ptr())
            as libc::c_int;
    ...
    let diff: libc::c_int = (up << 3i32 | fp << 1i32 | hp) + 1i32;
...
unsafe extern "C" fn read_mv_residual(
    ...
    match dav1d_msac_decode_symbol_adapt4(
        ...
        (N_MV_JOINTS as libc::c_int - 1i32) as size_t,
    ) {
        3 => {
            (*ref_mv).c2rust_unnamed.y = ((*ref_mv).c2rust_unnamed.y as libc::c_int
                + read_mv_component_diff(
                    t,
                    &mut *((*mv_cdf).comp).as_mut_ptr().offset(0isize),
                    have_fp,
                )) as int16_t;
            (*ref_mv).c2rust_unnamed.x = ((*ref_mv).c2rust_unnamed.x as libc::c_int
                + read_mv_component_diff(
                    t,
                    &mut *((*mv_cdf).comp).as_mut_ptr().offset(1isize),
                    have_fp,
                )) as int16_t;
        }
        1 => {
...
unsafe extern "C" fn read_tx_tree(
    ...
    let f: *const Dav1dFrameContext = (*t).f;
    let bx4: libc::c_int = (*t).bx & 31i32;
    let by4: libc::c_int = (*t).by & 31i32;
    ...
    if depth < 2i32 && from > TX_4X4 {
        let cat: libc::c_int =
            2i32 * (TX_64X64 as libc::c_int - (*t_dim).max as libc::c_int) - depth;
        let a: libc::c_int = (((*(*t).a).tx[bx4 as usize] as libc::c_int) < txw) as libc::c_int;
        let l: libc::c_int = (((*t).l.tx[by4 as usize] as libc::c_int) < txh) as libc::c_int;
        ...
        if is_split != 0 {
            ...
            *fresh1 = (*fresh1 as libc::c_int | (1i32) << y_off * 4i32 + x_off) as uint16_t;
        }
    } else {
        is_split = 0i32;
    }
        ...
        match (*t_dim).h as libc::c_int {
            ...
            4 => {
                (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                    ...
                    (0x1010101u32).wrapping_mul(txh as libc::c_uint)
                };
            }
            8 => {
                (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                    ...
                    (0x101010101010101u64).wrapping_mul(txh as libc::c_ulonglong)
                };
            }
            16 => {
                ...
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val;
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val;
            }
            _ => {}
        ...
        match (*t_dim).w as libc::c_int {
            ...
            4 => {
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                    ...
                    (0x1010101u32).wrapping_mul(txw as libc::c_uint)
                };
            }
            8 => {
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                    ...
                    (0x101010101010101u64).wrapping_mul(txw as libc::c_ulonglong)
                };
            }
            16 => {
                ...
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 0i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_0;
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 8i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_0;
            }
            _ => {}
...
unsafe extern "C" fn neg_deinterleave(
    ...
    if ref_0 >= max - 1i32 {
        return max - diff - 1i32;
    }
    if 2i32 * ref_0 < max {
        if diff <= 2i32 * ref_0 {
            if diff & 1i32 != 0 {
                return ref_0 + (diff + 1i32 >> 1i32);
            } else {
                return ref_0 - (diff >> 1i32);
            }
        }
        return diff;
    } else {
        if diff <= 2i32 * (max - ref_0 - 1i32) {
            if diff & 1i32 != 0 {
                return ref_0 + (diff + 1i32 >> 1i32);
            } else {
                return ref_0 - (diff >> 1i32);
...
unsafe extern "C" fn find_matching_ref(
    ...
    let mut r: *const *mut refmvs_block = &*((*t).rt.r)
        .as_ptr()
        .offset((((*t).by & 31i32) + 5i32) as isize)
        as *const *mut refmvs_block;
    let mut count: libc::c_int = 0i32;
    let mut have_topleft: libc::c_int = (have_top != 0 && have_left != 0) as libc::c_int;
    let mut have_topright: libc::c_int = (imax(bw4, bh4) < 32i32
        && have_top != 0
        && (*t).bx + bw4 < (*(*t).ts).tiling.col_end
        && intra_edge_flags & EDGE_I444_TOP_HAS_RIGHT != 0)
        as libc::c_int;
    if have_top != 0 {
        let mut r2: *const refmvs_block =
            &mut *(*r.offset(-1isize)).offset((*t).bx as isize) as *mut refmvs_block;
        if (*r2).ref_0.ref_0[0usize] as libc::c_int == ref_0 + 1i32
            && (*r2).ref_0.ref_0[1usize] as libc::c_int == -(1i32)
        {
            let ref mut fresh2 = *masks.offset(0isize);
            *fresh2 |= 1u64;
            count = 1i32;
        }
        let mut aw4: libc::c_int = dav1d_block_dimensions[(*r2).bs as usize][0usize] as libc::c_int;
        if aw4 >= bw4 {
            let off: libc::c_int = (*t).bx & aw4 - 1i32;
            if off != 0 {
                have_topleft = 0i32;
            }
            if aw4 - off > bw4 {
            ...
            let mut mask: libc::c_uint = ((1i32) << aw4) as libc::c_uint;
            ...
            while x < w4 {
                ...
                if (*r2).ref_0.ref_0[0usize] as libc::c_int == ref_0 + 1i32
                    && (*r2).ref_0.ref_0[1usize] as libc::c_int == -(1i32)
                {
                    let ref mut fresh3 = *masks.offset(0isize);
                ...
                aw4 = dav1d_block_dimensions[(*r2).bs as usize][0usize] as libc::c_int;
                mask <<= aw4;
                x += aw4;
            }
        }
    ...
    if have_left != 0 {
        ...
        if (*(*r2_0.offset(0isize)).offset(((*t).bx - 1i32) as isize))
            .ref_0
            .ref_0[0usize] as libc::c_int
            == ref_0 + 1i32
            && (*(*r2_0.offset(0isize)).offset(((*t).bx - 1i32) as isize))
                .ref_0
                .ref_0[1usize] as libc::c_int
                == -(1i32)
        {
            let ref mut fresh4 = *masks.offset(1isize);
            *fresh4 |= 1u64;
            count += 1;
            if count >= 8i32 {
                return;
        ...
        let mut lh4: libc::c_int = dav1d_block_dimensions
            [(*(*r2_0.offset(0isize)).offset(((*t).bx - 1i32) as isize)).bs as usize][1usize]
            as libc::c_int;
        if lh4 >= bh4 {
            if (*t).by & lh4 - 1i32 != 0 {
                have_topleft = 0i32;
            ...
            let mut mask_0: libc::c_uint = ((1i32) << lh4) as libc::c_uint;
            ...
            while y < h4 {
                ...
                if (*(*r2_0.offset(0isize)).offset(((*t).bx - 1i32) as isize))
                    ...
                    && (*(*r2_0.offset(0isize)).offset(((*t).bx - 1i32) as isize))
                        ...
                        == -(1i32)
                {
                    let ref mut fresh5 = *masks.offset(1isize);
                ...
                lh4 = dav1d_block_dimensions
                    [(*(*r2_0.offset(0isize)).offset(((*t).bx - 1i32) as isize)).bs as usize]
                    [1usize] as libc::c_int;
                mask_0 <<= lh4;
                y += lh4;
            }
        }
    ...
    if have_topleft != 0
        && ((*(*r.offset(-1isize)).offset(((*t).bx - 1i32) as isize))
            .ref_0
            .ref_0[0usize] as libc::c_int
            == ref_0 + 1i32
            && (*(*r.offset(-1isize)).offset(((*t).bx - 1i32) as isize))
                ...
                == -(1i32))
    {
        let ref mut fresh6 = *masks.offset(1isize);
        *fresh6 = *fresh6 | (1u64) << 32i32;
        count += 1;
        if count >= 8i32 {
            return;
        }
    ...
    if have_topright != 0
        && ((*(*r.offset(-1isize)).offset(((*t).bx + bw4) as isize))
            .ref_0
            .ref_0[0usize] as libc::c_int
            == ref_0 + 1i32
            && (*(*r.offset(-1isize)).offset(((*t).bx + bw4) as isize))
                ...
                == -(1i32))
    {
        let ref mut fresh7 = *masks.offset(0isize);
        *fresh7 = *fresh7 | (1u64) << 32i32;
    }
}
unsafe extern "C" fn derive_warpmv(
    ...
    let mut np: libc::c_int = 0i32;
    let mut r: *const *mut refmvs_block = &*((*t).rt.r)
        .as_ptr()
        .offset((((*t).by & 31i32) + 5i32) as isize)
        as *const *mut refmvs_block;
    if *masks.offset(0isize) as libc::c_uint == 1u32 && *masks.offset(1isize) >> 32i32 == 0 {
        let off: libc::c_int = (*t).bx
            & dav1d_block_dimensions[(*(*r.offset(-1isize)).offset((*t).bx as isize)).bs as usize]
                [0usize] as libc::c_int
                - 1i32;
        pts[np as usize][0usize][0usize] = 16i32
            * (2i32 * -off
                + 1i32
                    * dav1d_block_dimensions
                        [(*(*r.offset(-1isize)).offset((*t).bx as isize)).bs as usize][0usize]
                        as libc::c_int)
            - 8i32;
        pts[np as usize][0usize][1usize] = 16i32
            * (2i32 * 0i32
                + -(1i32)
                    * dav1d_block_dimensions
                        [(*(*r.offset(-1isize)).offset((*t).bx as isize)).bs as usize][1usize]
                        as libc::c_int)
            - 8i32;
        pts[np as usize][1usize][0usize] = pts[np as usize][0usize][0usize]
            + (*(*r.offset(-1isize)).offset((*t).bx as isize)).mv.mv[0usize]
                .c2rust_unnamed
                .x as libc::c_int;
        pts[np as usize][1usize][1usize] = pts[np as usize][0usize][1usize]
            + (*(*r.offset(-1isize)).offset((*t).bx as isize)).mv.mv[0usize]
                .c2rust_unnamed
                .y as libc::c_int;
        np += 1;
    } else {
        let mut off_0: libc::c_uint = 0u32;
        let mut xmask: libc::c_uint = *masks.offset(0isize) as uint32_t;
        while np < 8i32 && xmask != 0 {
            let tz: libc::c_int = ctz(xmask);
            off_0 = off_0.wrapping_add(tz as libc::c_uint);
            xmask >>= tz;
            pts[np as usize][0usize][0usize] = (16u32)
                .wrapping_mul(
                    (2u32).wrapping_mul(off_0).wrapping_add(
                        (1i32
                            * dav1d_block_dimensions[(*(*r.offset(-1isize))
                                .offset(((*t).bx as libc::c_uint).wrapping_add(off_0) as isize))
                            .bs as usize][0usize] as libc::c_int)
                            as libc::c_uint,
                    ),
                )
                .wrapping_sub(8u32) as libc::c_int;
            pts[np as usize][0usize][1usize] = 16i32
                * (2i32 * 0i32
                    + -(1i32)
                        * dav1d_block_dimensions[(*(*r.offset(-1isize))
                            .offset(((*t).bx as libc::c_uint).wrapping_add(off_0) as isize))
                        .bs as usize][1usize] as libc::c_int)
                - 8i32;
            pts[np as usize][1usize][0usize] = pts[np as usize][0usize][0usize]
                + (*(*r.offset(-1isize))
                    .offset(((*t).bx as libc::c_uint).wrapping_add(off_0) as isize))
            ...
            pts[np as usize][1usize][1usize] = pts[np as usize][0usize][1usize]
                ...
                .mv[0usize]
                    ...
                    .y as libc::c_int;
            np += 1;
            xmask &= !(1i32) as libc::c_uint;
        }
    }
    if np < 8i32 && *masks.offset(1isize) == 1u64 {
        let off_1: libc::c_int = (*t).by
            & dav1d_block_dimensions
                [(*(*r.offset(0isize)).offset(((*t).bx - 1i32) as isize)).bs as usize][1usize]
                as libc::c_int
                - 1i32;
        pts[np as usize][0usize][0usize] = 16i32
            * (2i32 * 0i32
        ...
        pts[np as usize][0usize][1usize] = 16i32
            * (2i32 * -off_1
            ...
            - 8i32;
        pts[np as usize][1usize][0usize] = pts[np as usize][0usize][0usize]
            + (*(*r.offset(-off_1 as isize)).offset(((*t).bx - 1i32) as isize))
                .mv
                .mv[0usize]
                .c2rust_unnamed
                .x as libc::c_int;
        ...
        let mut off_2: libc::c_uint = 0u32;
        let mut ymask: libc::c_uint = *masks.offset(1isize) as uint32_t;
        while np < 8i32 && ymask != 0 {
                ...
                * (2i32 * 0i32
                    + -(1i32)
                        * dav1d_block_dimensions[(*(*r.offset(off_2 as isize))
                        ...
                        .bs as usize][0usize] as libc::c_int)
                - 8i32;
            pts[np as usize][0usize][1usize] = (16u32)
                .wrapping_mul((2u32).wrapping_mul(off_2).wrapping_add(
                    (1i32
                        * dav1d_block_dimensions
                            [(*(*r.offset(off_2 as isize)).offset(((*t).bx - 1i32) as isize)).bs
                                as usize][1usize] as libc::c_int)
                        as libc::c_uint,
                ))
                .wrapping_sub(8u32) as libc::c_int;
            pts[np as usize][1usize][0usize] = pts[np as usize][0usize][0usize]
                + (*(*r.offset(off_2 as isize)).offset(((*t).bx - 1i32) as isize))
                    .mv
                    .mv[0usize]
                    .c2rust_unnamed
                    .x as libc::c_int;
            pts[np as usize][1usize][1usize] = pts[np as usize][0usize][1usize]
                + (*(*r.offset(off_2 as isize)).offset(((*t).bx - 1i32) as isize))
                    ...
                    .y as libc::c_int;
            np += 1;
            ymask &= !(1i32) as libc::c_uint;
        }
    }
    if np < 8i32 && *masks.offset(1isize) >> 32i32 != 0 {
        pts[np as usize][0usize][0usize] = 16i32
            * (2i32 * 0i32
                + -(1i32)
                    * dav1d_block_dimensions
                        [(*(*r.offset(-1isize)).offset(((*t).bx - 1i32) as isize)).bs as usize]
                        [0usize] as libc::c_int)
            - 8i32;
        pts[np as usize][0usize][1usize] = 16i32
            * (2i32 * 0i32
    ...
    if np < 8i32 && *masks.offset(0isize) >> 32i32 != 0 {
        pts[np as usize][0usize][0usize] = 16i32
            * (2i32 * bw4
                + 1i32
                    * dav1d_block_dimensions
                        [(*(*r.offset(-1isize)).offset(((*t).bx + bw4) as isize)).bs as usize]
                        [0usize] as libc::c_int)
            - 8i32;
        pts[np as usize][0usize][1usize] = 16i32
            * (2i32 * 0i32
    ...
    let thresh: libc::c_int = 4i32 * iclip(imax(bw4, bh4), 4i32, 28i32);
    let mut i: libc::c_int = 0i32;
    while i < np {
        mvd[i as usize] = abs(pts[i as usize][1usize][0usize]
            - pts[i as usize][0usize][0usize]
            - mv.c2rust_unnamed.x as libc::c_int)
            + abs(pts[i as usize][1usize][1usize]
                - pts[i as usize][0usize][1usize]
    ...
    if ret == 0 {
        ...
        let mut j: libc::c_int = np - 1i32;
        let mut k: libc::c_int = 0i32;
        while k < np - ret {
            while mvd[i_0 as usize] != -(1i32) {
                i_0 += 1;
            }
            while mvd[j as usize] == -(1i32) {
                j -= 1;
            }
            if !(i_0 != j) {
                unreachable!();
...
#[inline]
unsafe extern "C" fn findoddzero(mut buf: *const uint8_t, mut len: libc::c_int) -> libc::c_int {
    let mut n: libc::c_int = 0i32;
    while n < len {
        if *buf.offset((n * 2i32) as isize) == 0 {
            return 1i32;
        }
        n += 1;
    }
...
unsafe extern "C" fn read_pal_plane(
    ...
    .wrapping_add(2u32) as uint8_t;
    let pal_sz: libc::c_int = (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[pl as usize] as libc::c_int;
    let mut cache: [uint16_t; 16] = [0; 16];
    let mut used_cache: [uint16_t; 8] = [0; 8];
    let mut l_cache: libc::c_int = if pl != 0 {
        (*t).pal_sz_uv[1usize][by4 as usize] as libc::c_int
    } else {
        (*t).l.pal_sz[by4 as usize] as libc::c_int
    };
    let mut n_cache: libc::c_int = 0i32;
    let mut a_cache: libc::c_int = if by4 & 15i32 != 0 {
        if pl != 0 {
            (*t).pal_sz_uv[0usize][bx4 as usize] as libc::c_int
        } else {
    ...
    let mut l: *const uint16_t = ((*t).al_pal[1usize][by4 as usize][pl as usize]).as_mut_ptr();
    let mut a: *const uint16_t = ((*t).al_pal[0usize][bx4 as usize][pl as usize]).as_mut_ptr();
    while l_cache != 0 && a_cache != 0 {
        if (*l as libc::c_int) < *a as libc::c_int {
            if n_cache == 0 || cache[(n_cache - 1i32) as usize] as libc::c_int != *l as libc::c_int
            {
                let fresh8 = n_cache;
                n_cache = n_cache + 1;
            ...
            if n_cache == 0 || cache[(n_cache - 1i32) as usize] as libc::c_int != *a as libc::c_int
            {
                let fresh9 = n_cache;
                n_cache = n_cache + 1;
    ...
    let pal: *mut uint16_t = if (*t).frame_thread.pass != 0 {
        ((*((*f).frame_thread.pal).offset(
            ((((*t).by >> 1i32) + ((*t).bx & 1i32)) as libc::c_long * ((*f).b4_stride >> 1i32)
                + (((*t).bx >> 1i32) + ((*t).by & 1i32)) as libc::c_long) as isize,
        ))[pl as usize])
            .as_mut_ptr()
    } else {
    ...
    if i < pal_sz {
        ...
        *fresh14 =
        ...
        if i < pal_sz {
            let mut bits: libc::c_int = (((*f).cur.p.bpc - 3i32) as libc::c_uint)
                .wrapping_add(dav1d_msac_decode_bools(&mut (*ts).msac, 2u32))
                as libc::c_int;
            let max: libc::c_int = ((1i32) << (*f).cur.p.bpc) - 1i32;
            loop {
                ...
                *fresh16 = imin(prev + delta + (pl == 0) as libc::c_int, max) as uint16_t;
                ...
                if prev + (pl == 0) as libc::c_int >= max {
                    ...
                    bits = imin(
                        bits,
                        1i32 + ulog2((max - prev - (pl == 0) as libc::c_int) as libc::c_uint),
                    );
                    if !(i < pal_sz) {
                        break;
                    }
...
unsafe extern "C" fn read_pal_uv(
    ...
    read_pal_plane(t, b, 1i32, sz_ctx, bx4, by4);
    let ts: *mut Dav1dTileState = (*t).ts;
    let f: *const Dav1dFrameContext = (*t).f;
    let pal: *mut uint16_t = if (*t).frame_thread.pass != 0 {
        ((*((*f).frame_thread.pal).offset(
        ...
        ((*t).scratch.c2rust_unnamed_0.pal[2usize]).as_mut_ptr()
    };
    if dav1d_msac_decode_bool_equi(&mut (*ts).msac) != 0 {
        let bits: libc::c_int = (((*f).cur.p.bpc - 4i32) as libc::c_uint)
            .wrapping_add(dav1d_msac_decode_bools(&mut (*ts).msac, 2u32))
            as libc::c_int;
        let ref mut fresh19 = *pal.offset(0isize);
        *fresh19 =
            dav1d_msac_decode_bools(&mut (*ts).msac, (*f).cur.p.bpc as libc::c_uint) as uint16_t;
        let mut prev: libc::c_int = *fresh19 as libc::c_int;
        let max: libc::c_int = ((1i32) << (*f).cur.p.bpc) - 1i32;
        let mut i: libc::c_int = 1i32;
        while i < (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int {
        ...
        let mut i_0: libc::c_int = 0i32;
        while i_0 < (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int {
        ...
        && (*t).bx < 12i32
    {
        ...
        let mut n: libc::c_int = 0i32;
        while n < (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int {
            printf(
                b"%c%02x\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn order_palette(
    ...
    pal_idx =
        pal_idx.offset((first as libc::c_long + (i - first) as libc::c_long * stride) as isize);
    let mut j: libc::c_int = first;
    let mut n: libc::c_int = 0i32;
    while j >= last {
        let have_left: libc::c_int = (j > 0i32) as libc::c_int;
        if !(have_left != 0 || have_top != 0) {
            unreachable!();
        }
        let mut mask: libc::c_uint = 0u32;
        let mut o_idx: libc::c_int = 0i32;
        if have_left == 0 {
            *ctx.offset(n as isize) = 0u8;
            let v: libc::c_int = *pal_idx.offset(-stride as isize) as libc::c_int;
            if !((v as libc::c_uint) < 8u32) {
                unreachable!();
            }
            let fresh21 = o_idx;
            o_idx = o_idx + 1;
            (*order.offset(n as isize))[fresh21 as usize] = v as uint8_t;
            mask |= ((1i32) << v) as libc::c_uint;
        } else if have_top == 0 {
            *ctx.offset(n as isize) = 0u8;
            let v_0: libc::c_int = *pal_idx.offset(-1isize) as libc::c_int;
            if !((v_0 as libc::c_uint) < 8u32) {
                unreachable!();
            }
            let fresh22 = o_idx;
            o_idx = o_idx + 1;
            (*order.offset(n as isize))[fresh22 as usize] = v_0 as uint8_t;
            mask |= ((1i32) << v_0) as libc::c_uint;
        } else {
            let l: libc::c_int = *pal_idx.offset(-1isize) as libc::c_int;
            let t: libc::c_int = *pal_idx.offset(-stride as isize) as libc::c_int;
            let tl: libc::c_int = *pal_idx.offset(-(stride + 1i64) as isize) as libc::c_int;
        ...
        j -= 1;
        n += 1;
        pal_idx = pal_idx.offset((stride - 1i64) as isize);
    }
}
unsafe extern "C" fn read_pal_indices(
    ...
    let ts: *mut Dav1dTileState = (*t).ts;
    let stride: ptrdiff_t = (bw4 * 4i32) as ptrdiff_t;
    if pal_idx.is_null() {
        unreachable!();
    }
    *pal_idx.offset(0isize) = dav1d_msac_decode_uniform(
        &mut (*ts).msac,
    ...
    let color_map_cdf: *mut [uint16_t; 8] = ((*ts).cdf.m.color_map[pl as usize]
        [((*b).c2rust_unnamed.c2rust_unnamed.pal_sz[pl as usize] as libc::c_int - 2i32) as usize])
        .as_mut_ptr();
    ...
    let ctx: *mut uint8_t = ((*t)
        ...
        .as_mut_ptr();
    let mut i: libc::c_int = 1i32;
    while i < 4i32 * (w4 + h4) - 1i32 {
        let first: libc::c_int = imin(i, w4 * 4i32 - 1i32);
        let last: libc::c_int = imax(0i32, i - h4 * 4i32 + 1i32);
        ...
        while j >= last {
            let color_idx: libc::c_int = dav1d_msac_decode_symbol_adapt8(
                ...
                ((*b).c2rust_unnamed.c2rust_unnamed.pal_sz[pl as usize] as libc::c_int - 1i32)
                    as size_t,
            ) as libc::c_int;
            *pal_idx.offset(((i - j) as libc::c_long * stride + j as libc::c_long) as isize) =
    ...
    if bw4 > w4 {
        ...
        while y < 4i32 * h4 {
            memset(
                &mut *pal_idx
                    .offset((y as libc::c_long * stride + (4i32 * w4) as libc::c_long) as isize)
                    as *mut uint8_t as *mut libc::c_void,
                *pal_idx.offset(
                    (y as libc::c_long * stride + (4i32 * w4) as libc::c_long - 1i64) as isize,
                ) as libc::c_int,
                (4i32 * (bw4 - w4)) as libc::c_ulong,
            );
            y += 1;
        }
    }
    if h4 < bh4 {
        let src: *const uint8_t = &mut *pal_idx
            .offset((stride * (4i32 * h4 - 1i32) as libc::c_long) as isize)
            as *mut uint8_t;
        let mut y_0: libc::c_int = h4 * 4i32;
        while y_0 < bh4 * 4i32 {
            memcpy(
                &mut *pal_idx.offset((y_0 as libc::c_long * stride) as isize) as *mut uint8_t
                    as *mut libc::c_void,
                src as *const libc::c_void,
                (bw4 * 4i32) as libc::c_ulong,
            );
            y_0 += 1;
        }
    }
...
unsafe extern "C" fn read_vartx_tree(
    ...
    let mut tx_split: [uint16_t; 2] = [0u16, 0];
    (*b).c2rust_unnamed.c2rust_unnamed_0.max_ytx = dav1d_max_txfm_size_for_bs[bs as usize][0usize];
    if (*b).skip == 0
            ...
            || (*b).c2rust_unnamed.c2rust_unnamed_0.max_ytx as libc::c_int == TX_4X4 as libc::c_int)
    {
        ...
        if (*(*f).frame_hdr).txfm_mode == DAV1D_TX_SWITCHABLE {
            match bh4 {
                1 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 = TX_4X4 as uint8_t;
                }
                2 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias16))
                        .u16_0 = TX_4X4 as uint16_t;
                }
                4 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias32))
                ...
                16 => {
                    ...
                    (*(&mut *((*t).l.tx)
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = const_val;
                    (*(&mut *((*t).l.tx)
                        .as_mut_ptr()
                        .offset((by4 + 8i32) as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = const_val;
                }
                32 => {
                    ...
                    (*(&mut *((*t).l.tx)
                        .as_mut_ptr()
                        .offset((by4 + 16i32) as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = const_val_0;
                    (*(&mut *((*t).l.tx)
                        .as_mut_ptr()
                        .offset((by4 + 24i32) as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = const_val_0;
                }
                _ => {}
            ...
            match bw4 {
                ...
                16 => {
                    ...
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_1;
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 8i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_1;
                }
                32 => {
                    ...
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 8i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_2;
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 16i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_2;
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 24i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_2;
                }
                _ => {}
    ...
    } else if (*(*f).frame_hdr).txfm_mode != DAV1D_TX_SWITCHABLE || (*b).skip as libc::c_int != 0 {
        if (*(*f).frame_hdr).txfm_mode == DAV1D_TX_SWITCHABLE {
            match bh4 {
                1 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 =
                        (0x1i32 * *b_dim.offset((2i32 + 1i32) as isize) as libc::c_int) as uint8_t;
                }
                2 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * *b_dim.offset((2i32 + 1i32) as isize) as libc::c_int)
                        as uint16_t;
                }
                4 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32)
                        .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_uint);
                }
                8 => {
                    (*(&mut *((*t).l.tx).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64)
                        .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                }
                16 => {
                    let const_val_3: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                    (*(&mut *((*t).l.tx)
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                32 => {
                    let const_val_4: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                    (*(&mut *((*t).l.tx)
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
            ...
            match bw4 {
                1 => {
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 =
                        (0x1i32 * *b_dim.offset((2i32 + 0i32) as isize) as libc::c_int) as uint8_t;
                }
                2 => {
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * *b_dim.offset((2i32 + 0i32) as isize) as libc::c_int)
                        as uint16_t;
                }
                4 => {
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32)
                        .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_uint);
                }
                8 => {
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64)
                        .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                }
                16 => {
                    let const_val_5: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_5;
                ...
                32 => {
                    let const_val_6: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut int8_t as *mut alias64))
                        .u64_0 = const_val_6;
            ...
            && (*t).bx < 12i32
        {
            printf(
                ...
                tx_split[0usize] as libc::c_int,
                tx_split[1usize] as libc::c_int,
                (*(*t).ts).msac.rng,
            );
        }
        (*b).uvtx = dav1d_max_txfm_size_for_bs[bs as usize][(*f).cur.p.layout as usize];
    }
    if tx_split[0usize] as libc::c_int & !(0x33i32) != 0 {
        unreachable!();
    }
    (*b).c2rust_unnamed.c2rust_unnamed_0.tx_split0 = tx_split[0usize] as uint8_t;
    (*b).c2rust_unnamed.c2rust_unnamed_0.tx_split1 = tx_split[1usize];
}
#[inline]
unsafe extern "C" fn get_prev_frame_segid(
    ...
    if !((*(*f).frame_hdr).primary_ref_frame != 7i32) {
        unreachable!();
    }
    let mut seg_id: libc::c_uint = 8u32;
    ref_seg_map = ref_seg_map.offset((by as libc::c_long * stride + bx as libc::c_long) as isize);
    loop {
...
unsafe extern "C" fn splat_oneref_mv(
    ...
    let tmpl: refmvs_block = {
        let mut init = refmvs_block {
            ...
            ref_0: refmvs_refpair {
                ref_0: [
                    ((*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_int + 1i32)
                        as int8_t,
            ...
            bs: bs as uint8_t,
            mf: ((mode == GLOBALMV && imin(bw4, bh4) >= 2i32) as libc::c_int
                | (mode == NEWMV) as libc::c_int * 2i32) as uint8_t,
        };
        init
    };
...
unsafe extern "C" fn splat_intrabc_mv(
    ...
    let tmpl: refmvs_block = {
        let mut init = refmvs_block {
            ...
            ref_0: refmvs_refpair { ref_0: [0i8, -1i8] },
            bs: bs as uint8_t,
            mf: 0u8,
        };
        init
        ...
        let mut init = refmvs_block {
            ...
            ref_0: refmvs_refpair {
                ref_0: [
                    ((*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_int + 1i32)
                        as int8_t,
                    ((*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as libc::c_int + 1i32)
                        as int8_t,
                ],
            },
            bs: bs as uint8_t,
            mf: ((mode == GLOBALMV_GLOBALMV) as libc::c_int
                | ((1i32) << mode & 0xbci32 != 0) as libc::c_int * 2i32) as uint8_t,
        };
        init
    };
    ((*c).refmvs_dsp.splat_mv).expect("non-null function pointer")(
...
unsafe extern "C" fn mc_lowest_px(
    ...
    let v_mul: libc::c_int = 4i32 >> ss_ver;
    if (*smp).scale == 0 {
        let my: libc::c_int = mvy >> 3i32 + ss_ver;
        let dy: libc::c_int = mvy & 15i32 >> (ss_ver == 0) as libc::c_int;
        *dst = imax(
            *dst,
            (by4 + bh4) * v_mul + my + 4i32 * (dy != 0) as libc::c_int,
        );
    } else {
        let mut y: libc::c_int =
            (by4 * v_mul << 4i32) + mvy * ((1i32) << (ss_ver == 0) as libc::c_int);
        let tmp: int64_t = y as int64_t * (*smp).scale as libc::c_long
            + (((*smp).scale - 0x4000i32) * 8i32) as libc::c_long;
        y = apply_sign64((llabs(tmp) + 128i64 >> 8i32) as libc::c_int, tmp) + 32i32;
        let bottom: libc::c_int = (y + (bh4 * v_mul - 1i32) * (*smp).step >> 10i32) + 1i32 + 4i32;
        *dst = imax(*dst, bottom);
    };
}
#[inline(always)]
unsafe extern "C" fn affine_lowest_px(
    ...
    let h_mul: libc::c_int = 4i32 >> ss_hor;
    let v_mul: libc::c_int = 4i32 >> ss_ver;
    if !(*b_dim.offset(0isize) as libc::c_int * h_mul & 7i32 == 0
        && *b_dim.offset(1isize) as libc::c_int * v_mul & 7i32 == 0)
    {
        unreachable!();
    }
    let mat: *const int32_t = ((*wmp).matrix).as_ptr();
    let y: libc::c_int = *b_dim.offset(1isize) as libc::c_int * v_mul - 8i32;
    let src_y: libc::c_int = (*t).by * 4i32 + ((y + 4i32) << ss_ver);
    let mat5_y: int64_t = *mat.offset(5isize) as int64_t * src_y as libc::c_long
        + *mat.offset(1isize) as libc::c_long;
    let mut x: libc::c_int = 0i32;
    while x < *b_dim.offset(0isize) as libc::c_int * h_mul {
        let src_x: libc::c_int = (*t).bx * 4i32 + ((x + 4i32) << ss_hor);
        let mvy: int64_t =
            *mat.offset(4isize) as int64_t * src_x as libc::c_long + mat5_y >> ss_ver;
        let dy: libc::c_int = (mvy >> 16i32) as libc::c_int - 4i32;
        *dst = imax(*dst, dy + 4i32 + 8i32);
        x += imax(8i32, *b_dim.offset(0isize) as libc::c_int * h_mul - 8i32);
    }
}
#[inline(never)]
unsafe extern "C" fn affine_lowest_px_luma(
    ...
    affine_lowest_px(t, dst, b_dim, wmp, 0i32, 0i32);
}
#[inline(never)]
...
unsafe extern "C" fn obmc_lowest_px(
    ...
    let ss_ver: libc::c_int =
        (is_chroma != 0 && (*f).cur.p.layout == DAV1D_PIXEL_LAYOUT_I420) as libc::c_int;
    let ss_hor: libc::c_int =
        (is_chroma != 0 && (*f).cur.p.layout != DAV1D_PIXEL_LAYOUT_I444) as libc::c_int;
    let h_mul: libc::c_int = 4i32 >> ss_hor;
    let v_mul: libc::c_int = 4i32 >> ss_ver;
    if (*t).by > (*(*t).ts).tiling.row_start
        && (is_chroma == 0
            || *b_dim.offset(0isize) as libc::c_int * h_mul
                + *b_dim.offset(1isize) as libc::c_int * v_mul
                >= 16i32)
    {
        let mut i: libc::c_int = 0i32;
        let mut x: libc::c_int = 0i32;
        while x < w4 && i < imin(*b_dim.offset(2isize) as libc::c_int, 4i32) {
            let a_r: *const refmvs_block = &mut *(*r.offset(-1isize))
                .offset(((*t).bx + x + 1i32) as isize)
                as *mut refmvs_block;
            let a_b_dim: *const uint8_t = (dav1d_block_dimensions[(*a_r).bs as usize]).as_ptr();
            if (*a_r).ref_0.ref_0[0usize] as libc::c_int > 0i32 {
                let oh4: libc::c_int = imin(*b_dim.offset(1isize) as libc::c_int, 16i32) >> 1i32;
                mc_lowest_px(
                    &mut *(*dst.offset(
                        (*((*a_r).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int - 1i32)
                            as isize,
                    ))
                    .as_mut_ptr()
                    ...
                    (*t).by,
                    oh4 * 3i32 + 3i32 >> 2i32,
                    (*a_r).mv.mv[0usize].c2rust_unnamed.y as libc::c_int,
                    ss_ver,
                    &*(*((*f).svc).as_ptr().offset(
                        (*((*a_r).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int - 1i32)
                            as isize,
            ...
            x += imax(*a_b_dim.offset(0isize) as libc::c_int, 2i32);
        }
    }
    if (*t).bx > (*(*t).ts).tiling.col_start {
        let mut i_0: libc::c_int = 0i32;
        let mut y: libc::c_int = 0i32;
        while y < h4 && i_0 < imin(*b_dim.offset(3isize) as libc::c_int, 4i32) {
            let l_r: *const refmvs_block = &mut *(*r.offset((y + 1i32) as isize))
                .offset(((*t).bx - 1i32) as isize)
                as *mut refmvs_block;
            let l_b_dim: *const uint8_t = (dav1d_block_dimensions[(*l_r).bs as usize]).as_ptr();
            if (*l_r).ref_0.ref_0[0usize] as libc::c_int > 0i32 {
                let oh4_0: libc::c_int = iclip(
                    *l_b_dim.offset(1isize) as libc::c_int,
                    2i32,
                    *b_dim.offset(1isize) as libc::c_int,
                );
                mc_lowest_px(
                    &mut *(*dst.offset(
                        (*((*l_r).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int - 1i32)
                            as isize,
                    ))
                    .as_mut_ptr()
                    .offset(is_chroma as isize),
                    (*t).by + y,
                    oh4_0,
                    (*l_r).mv.mv[0usize].c2rust_unnamed.y as libc::c_int,
                    ss_ver,
                    &*(*((*f).svc).as_ptr().offset(
                        (*((*l_r).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int - 1i32)
                            as isize,
            ...
            y += imax(*l_b_dim.offset(1isize) as libc::c_int, 2i32);
        }
    }
}
unsafe extern "C" fn decode_b(
    ...
    let b: *mut Av1Block = if (*t).frame_thread.pass != 0 {
        &mut *((*f).frame_thread.b)
            .offset(((*t).by as libc::c_long * (*f).b4_stride + (*t).bx as libc::c_long) as isize)
            as *mut Av1Block
    } else {
        &mut b_mem
    };
    ...
    let has_chroma: libc::c_int = ((*f).cur.p.layout != DAV1D_PIXEL_LAYOUT_I400
        && (bw4 > ss_hor || (*t).bx & 1i32 != 0)
        && (bh4 > ss_ver || (*t).by & 1i32 != 0)) as libc::c_int;
    if (*t).frame_thread.pass == 2i32 {
        if (*b).intra != 0 {
            ((*f).bd_fn.recon_b_intra).expect("non-null function pointer")(
                t,
                bs,
                intra_edge_flags,
                b,
            ...
            match bh4 {
                1 => {
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1u32).wrapping_mul(y_mode_nofilt) as uint8_t;
                ...
                2 => {
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = (0x101u32).wrapping_mul(y_mode_nofilt) as uint16_t;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = 0x101u16;
                }
                4 => {
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32).wrapping_mul(y_mode_nofilt);
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 = 0x1010101u32;
                }
                8 => {
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 =
                        (0x101010101010101u64).wrapping_mul(y_mode_nofilt as libc::c_ulonglong);
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = 0x101010101010101u64;
                }
                16 => {
                    let const_val: uint64_t =
                        (0x101010101010101u64).wrapping_mul(y_mode_nofilt as libc::c_ulonglong);
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val;
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val;
                    let const_val_0: uint64_t = 0x101010101010101u64;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_0;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_0;
                }
                32 => {
                    ...
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_1;
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 16i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_1;
                    (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 24i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_1;
                    let const_val_2: uint64_t = 0x101010101010101u64;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_2;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_2;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 16i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_2;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 24i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_2;
                }
                _ => {}
            ...
            match bw4 {
                ...
                16 => {
                    let const_val_3: uint64_t =
                        (0x101010101010101u64).wrapping_mul(y_mode_nofilt as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_3;
                    (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_3;
                    let const_val_4: uint64_t = 0x101010101010101u64;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_4;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_4;
                }
                32 => {
                    let const_val_5: uint64_t =
                        (0x101010101010101u64).wrapping_mul(y_mode_nofilt as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_5;
                    (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 8i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_5;
                    (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 16i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_5;
                    (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 24i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_5;
                    let const_val_6: uint64_t = 0x101010101010101u64;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    ...
                    (*(&mut *((*(*t).a).intra)
                        .as_mut_ptr()
                        .offset((bx4 + 16i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_6;
                    (*(&mut *((*(*t).a).intra)
                        .as_mut_ptr()
                        .offset((bx4 + 24i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_6;
                }
                _ => {}
            }
            if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                let r: *mut refmvs_block = &mut *(*((*t).rt.r)
                    .as_mut_ptr()
                    .offset((((*t).by & 31i32) + 5i32 + bh4 - 1i32) as isize))
                .offset((*t).bx as isize)
                    as *mut refmvs_block;
                let mut x: libc::c_int = 0i32;
                while x < bw4 {
                    (*r.offset(x as isize)).ref_0.ref_0[0usize] = 0i8;
                ...
                let mut y: libc::c_int = 0i32;
                while y < bh4 - 1i32 {
                    (*(*rr.offset(y as isize)).offset(((*t).bx + bw4 - 1i32) as isize))
                        .ref_0
                        .ref_0[0usize] = 0i8;
                    (*(*rr.offset(y as isize)).offset(((*t).bx + bw4 - 1i32) as isize)).bs =
                        bs as uint8_t;
                    y += 1;
                }
            }
            if has_chroma != 0 {
                match cbh4 {
                    ...
                    16 => {
                        let const_val_7: uint64_t = (0x101010101010101u64).wrapping_mul(
                            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                        );
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_7;
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 8i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_7;
                    }
                    32 => {
                        let const_val_8: uint64_t = (0x101010101010101u64).wrapping_mul(
                            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                        );
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                            as *mut uint8_t as *mut alias64))
                        ...
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 8i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_8;
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 16i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_8;
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 24i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_8;
                    }
                    _ => {}
                ...
                match cbw4 {
                    ...
                    4 => {
                        (*(&mut *((*(*t).a).uvmode).as_mut_ptr().offset(cbx4 as isize)
                            as *mut uint8_t as *mut alias32))
                            .u32_0 = (0x1010101u32).wrapping_mul(
                            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_uint,
                        );
                    }
                    8 => {
                        (*(&mut *((*(*t).a).uvmode).as_mut_ptr().offset(cbx4 as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = (0x101010101010101u64).wrapping_mul(
                            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                        );
                    }
                    16 => {
                        let const_val_9: uint64_t = (0x101010101010101u64).wrapping_mul(
                            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                        );
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                            .offset((cbx4 + 0i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_9;
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                            .offset((cbx4 + 8i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_9;
                    }
                    32 => {
                        let const_val_10: uint64_t = (0x101010101010101u64).wrapping_mul(
                            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                        );
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                        ...
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                            .offset((cbx4 + 16i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_10;
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                            .offset((cbx4 + 24i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_10;
                    }
                    _ => {}
                    ...
                    == -(32767i32) - 1i32
                {
                    ...
                    (*t).warpmv.matrix[2usize] =
                        (*b).c2rust_unnamed
                            ...
                            .matrix[0usize] as libc::c_int
                            + 0x10000i32;
                    (*t).warpmv.matrix[3usize] = (*b)
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .matrix[1usize] as int32_t;
                    (*t).warpmv.matrix[4usize] = (*b)
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .matrix[2usize] as int32_t;
                    (*t).warpmv.matrix[5usize] =
                        (*b).c2rust_unnamed
                            .c2rust_unnamed_0
                            .c2rust_unnamed
                            .c2rust_unnamed_0
                            .matrix[3usize] as libc::c_int
                            + 0x10000i32;
                        ...
                        && (*t).bx < 12i32
                    {
                        printf(
                            ...
                            abs((*t).warpmv.matrix[0usize]),
                            if (*t).warpmv.matrix[1usize]
                                < 0i32
                            {
                                '-' as i32
                            } else {
                            ...
                            abs((*t).warpmv.matrix[1usize]),
                            if (*t).warpmv.matrix[2usize]
                                < 0i32
                            {
                                '-' as i32
                            } else {
                            ...
                            abs((*t).warpmv.matrix[2usize]),
                            if (*t).warpmv.matrix[3usize]
                                < 0i32
                            {
                                '-' as i32
                            } else {
                            ...
                            abs((*t).warpmv.matrix[3usize]),
                            if (*t).warpmv.matrix[4usize]
                                < 0i32
                            {
                                '-' as i32
                            } else {
                            ...
                            abs((*t).warpmv.matrix[4usize]),
                            if (*t).warpmv.matrix[5usize]
                                < 0i32
                            {
                                '-' as i32
                            } else {
                            ...
                            abs((*t).warpmv.matrix[5usize]),
                            if ((*t).warpmv.u.p.alpha as libc::c_int) < 0i32
                            {
                                '-' as i32
                            } else {
                                ' ' as i32
                            ...
                            if ((*t).warpmv.u.p.beta as libc::c_int) < 0i32 {
                                '-' as i32
                            } else {
                                ' ' as i32
                            },
                            abs((*t).warpmv.u.p.beta as libc::c_int),
                            if ((*t).warpmv.u.p.gamma as libc::c_int) < 0i32
                            {
                                '-' as i32
                            } else {
                                ' ' as i32
                            ...
                            if ((*t).warpmv.u.p.delta as libc::c_int) < 0i32
                            {
                                '-' as i32
                            } else {
                                ' ' as i32
            ...
            if ((*f).bd_fn.recon_b_inter).expect("non-null function pointer")(t, bs, b) != 0 {
                return -(1i32);
            }
            let filter: *const uint8_t =
                (dav1d_filter_dir[(*b).c2rust_unnamed.c2rust_unnamed_0.filter2d as usize]).as_ptr();
            match bh4 {
                1 => {
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * *filter.offset(0isize) as libc::c_int) as uint8_t;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * *filter.offset(1isize) as libc::c_int) as uint8_t;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = 0u8;
                }
                2 => {
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * *filter.offset(0isize) as libc::c_int) as uint16_t;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * *filter.offset(1isize) as libc::c_int) as uint16_t;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = 0u16;
                }
                4 => {
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias32))
                        .u32_0 =
                        (0x1010101u32).wrapping_mul(*filter.offset(0isize) as libc::c_uint);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 =
                        (0x1010101u32).wrapping_mul(*filter.offset(1isize) as libc::c_uint);
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 = 0u32;
                }
                8 => {
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(0isize) as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(1isize) as libc::c_ulonglong);
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = 0u64;
                }
                16 => {
                    let const_val_11: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(0isize) as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_11;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 8i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_11;
                    let const_val_12: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(1isize) as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_12;
                    let const_val_13: uint64_t = 0u64;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_13;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 8i32) as isize)
                ...
                32 => {
                    let const_val_14: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(0isize) as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 16i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_14;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 24i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_14;
                    let const_val_15: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(1isize) as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_15;
                    let const_val_16: uint64_t = 0u64;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_16;
                    (*(&mut *((*t).l.intra).as_mut_ptr().offset((by4 + 8i32) as isize)
            ...
            match bw4 {
                1 => {
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(bx4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * *filter.offset(0isize) as libc::c_int) as uint8_t;
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(bx4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * *filter.offset(1isize) as libc::c_int) as uint8_t;
                ...
                16 => {
                    let const_val_17: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(0isize) as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_17;
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((bx4 + 8i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_17;
                    let const_val_18: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(1isize) as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_18;
                    let const_val_19: uint64_t = 0u64;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_19;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
                ...
                32 => {
                    let const_val_20: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(0isize) as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_20;
                    let const_val_21: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(*filter.offset(1isize) as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_21;
                    let const_val_22: uint64_t = 0u64;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_22;
                    (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
            ...
            if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                ...
                while x_0 < bw4 {
                    (*r_0.offset(x_0 as isize)).ref_0.ref_0[0usize] =
                        ((*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_int + 1i32)
                            as int8_t;
                    (*r_0.offset(x_0 as isize)).mv.mv[0usize] = (*b)
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .c2rust_unnamed
                        .c2rust_unnamed
                ...
                while y_0 < bh4 - 1i32 {
                    (*(*rr_0.offset(y_0 as isize)).offset(((*t).bx + bw4 - 1i32) as isize))
                        .ref_0
                        .ref_0[0usize] = ((*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize]
                        as libc::c_int
                        + 1i32) as int8_t;
                    (*(*rr_0.offset(y_0 as isize)).offset(((*t).bx + bw4 - 1i32) as isize))
                        .mv
                        ...
                        .c2rust_unnamed
                        .mv[0usize];
                    (*(*rr_0.offset(y_0 as isize)).offset(((*t).bx + bw4 - 1i32) as isize)).bs =
                        bs as uint8_t;
                    y_0 += 1;
                }
            }
            if has_chroma != 0 {
                match cbh4 {
                    1 => {
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize)
                            as *mut uint8_t as *mut alias8))
                            .u8_0 = (0x1i32 * DC_PRED as libc::c_int)
                            as uint8_t;
                    }
                    2 => {
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize)
                            as *mut uint8_t as *mut alias16))
                            .u16_0 = (0x101i32 * DC_PRED as libc::c_int)
                            as uint16_t;
                    }
                    4 => {
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize)
                    ...
                    16 => {
                        let const_val_23: uint64_t = (0x101010101010101u64)
                            .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_23;
                    ...
                    32 => {
                        let const_val_24: uint64_t = (0x101010101010101u64)
                            .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                        (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                            as *mut uint8_t as *mut alias64))
                            .u64_0 = const_val_24;
                ...
                match cbw4 {
                    1 => {
                        (*(&mut *((*(*t).a).uvmode).as_mut_ptr().offset(cbx4 as isize)
                            as *mut uint8_t as *mut alias8))
                            .u8_0 = (0x1i32 * DC_PRED as libc::c_int) as uint8_t;
                    }
                    2 => {
                        (*(&mut *((*(*t).a).uvmode).as_mut_ptr().offset(cbx4 as isize)
                            as *mut uint8_t as *mut alias16))
                            .u16_0 = (0x101i32 * DC_PRED as libc::c_int) as uint16_t;
                    }
                    4 => {
                        (*(&mut *((*(*t).a).uvmode).as_mut_ptr().offset(cbx4 as isize)
                            as *mut uint8_t as *mut alias32))
                            .u32_0 = (0x1010101u32).wrapping_mul(DC_PRED);
                    }
                    8 => {
                        (*(&mut *((*(*t).a).uvmode).as_mut_ptr().offset(cbx4 as isize)
                            as *mut uint8_t as *mut alias64))
                    ...
                    16 => {
                        let const_val_25: uint64_t = (0x101010101010101u64)
                            .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                            .offset((cbx4 + 0i32) as isize)
                    ...
                    32 => {
                        let const_val_26: uint64_t = (0x101010101010101u64)
                            .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                        (*(&mut *((*(*t).a).uvmode)
                            .as_mut_ptr()
                            .offset((cbx4 + 0i32) as isize)
    ...
    let mut seg_pred: libc::c_int = 0i32;
        ...
        if (*(*f).frame_hdr).segmentation.update_map == 0 {
            ...
            if (*(*f).frame_hdr).segmentation.temporal != 0 && {
                seg_pred = dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.seg_pred[((*(*t).a).seg_pred[bx4 as usize] as libc::c_int
                        + (*t).l.seg_pred[by4 as usize] as libc::c_int)
                        as usize])
                        .as_mut_ptr(),
                ) as libc::c_int;
                seg_pred != 0
                ...
                let last_active_seg_id: libc::c_uint =
                    (*(*f).frame_hdr).segmentation.seg_data.last_active_segid as libc::c_uint;
                (*b).seg_id = neg_deinterleave(
                    diff as libc::c_int,
                    pred_seg_id as libc::c_int,
                    last_active_seg_id.wrapping_add(1u32) as libc::c_int,
                ) as uint8_t;
                if (*b).seg_id as libc::c_uint > last_active_seg_id {
                    (*b).seg_id = 0u8;
                }
                if (*b).seg_id as libc::c_int >= 8i32 {
                    (*b).seg_id = 0u8;
                }
            }
            if 0i32 != 0
    ...
    if (seg.is_null() || (*seg).globalmv == 0 && (*seg).ref_0 == -(1i32) && (*seg).skip == 0)
    ...
    if (*b).skip_mode as libc::c_int != 0 || !seg.is_null() && (*seg).skip != 0 {
        ...
        let sctx: libc::c_int =
            (*(*t).a).skip[bx4 as usize] as libc::c_int + (*t).l.skip[by4 as usize] as libc::c_int;
        ...
        && (*(*f).frame_hdr).segmentation.seg_data.preskip == 0
    {
        if (*b).skip == 0 && (*(*f).frame_hdr).segmentation.temporal != 0 && {
            ...
            if (*b).skip != 0 {
                ...
                let last_active_seg_id_0: libc::c_uint =
                    (*(*f).frame_hdr).segmentation.seg_data.last_active_segid as libc::c_uint;
                (*b).seg_id = neg_deinterleave(
                    diff_0 as libc::c_int,
                    pred_seg_id_0 as libc::c_int,
                    last_active_seg_id_0.wrapping_add(1u32) as libc::c_int,
                ) as uint8_t;
    ...
    if (*b).skip == 0 {
        let idx: libc::c_int = if (*(*f).seq_hdr).sb128 != 0 {
            (((*t).bx & 16i32) >> 4i32) + (((*t).by & 16i32) >> 3i32)
        } else {
            0i32
        };
        if *((*t).cur_sb_cdef_idx_ptr).offset(idx as isize) as libc::c_int == -(1i32) {
            ...
            *((*t).cur_sb_cdef_idx_ptr).offset(idx as isize) = v as int8_t;
            if bw4 > 16i32 {
                *((*t).cur_sb_cdef_idx_ptr).offset((idx + 1i32) as isize) = v as int8_t;
            }
            if bh4 > 16i32 {
                *((*t).cur_sb_cdef_idx_ptr).offset((idx + 2i32) as isize) = v as int8_t;
            }
            if bw4 == 32i32 && bh4 == 32i32 {
                *((*t).cur_sb_cdef_idx_ptr).offset((idx + 3i32) as isize) = v as int8_t;
            }
            if 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
                && (*t).by >= 0i32
    ...
    if (*t).bx & 31i32 >> ((*(*f).seq_hdr).sb128 == 0) as libc::c_int == 0
        && (*t).by & 31i32 >> ((*(*f).seq_hdr).sb128 == 0) as libc::c_int == 0
    {
        ...
        if have_delta_q != 0 {
            ...
            if delta_q == 3i32 {
                let n_bits: libc::c_int = (1u32)
                    .wrapping_add(dav1d_msac_decode_bools(&mut (*ts).msac, 3u32))
                    as libc::c_int;
                delta_q = (dav1d_msac_decode_bools(&mut (*ts).msac, n_bits as libc::c_uint))
                    .wrapping_add(1u32)
                    .wrapping_add(((1i32) << n_bits) as libc::c_uint)
                    as libc::c_int;
            }
            if delta_q != 0 {
                if dav1d_msac_decode_bool_equi(&mut (*ts).msac) != 0 {
                ...
                delta_q *= (1i32) << (*(*f).frame_hdr).delta.q.res_log2;
            }
            (*ts).last_qidx = iclip((*ts).last_qidx + delta_q, 1i32, 255i32);
            if have_delta_q != 0
                && 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
                && (*t).by >= 0i32
            ...
            if (*(*f).frame_hdr).delta.lf.present != 0 {
                ...
                while i < n_lfs {
                    ...
                    if delta_lf == 3i32 {
                        let n_bits_0: libc::c_int = (1u32)
                            .wrapping_add(dav1d_msac_decode_bools(&mut (*ts).msac, 3u32))
                            as libc::c_int;
                        delta_lf =
                            (dav1d_msac_decode_bools(&mut (*ts).msac, n_bits_0 as libc::c_uint))
                                .wrapping_add(1u32)
                                .wrapping_add(((1i32) << n_bits_0) as libc::c_uint)
                                as libc::c_int;
                    }
                    if delta_lf != 0 {
                        if dav1d_msac_decode_bool_equi(&mut (*ts).msac) != 0 {
                        ...
                        delta_lf *= (1i32) << (*(*f).frame_hdr).delta.lf.res_log2;
                    }
        ...
        if memcmp(
            ((*ts).last_delta_lf).as_mut_ptr() as *const libc::c_void,
            [0i8, 0i8, 0i8, 0i8].as_mut_ptr() as *const libc::c_void,
            4u64,
        ) == 0
        {
    ...
    if (*b).skip_mode != 0 {
        (*b).intra = 0u8;
    } else if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
        if !seg.is_null() && ((*seg).ref_0 >= 0i32 || (*seg).globalmv != 0) {
            (*b).intra = ((*seg).ref_0 == 0) as uint8_t;
        } else {
            let ictx: libc::c_int =
                get_intra_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
        ...
        (*b).intra =
            (dav1d_msac_decode_bool_adapt(&mut (*ts).msac, ((*ts).cdf.m.intrabc.0).as_mut_ptr())
                == 0) as uint8_t;
        if 0i32 != 0
            && (*(*f).frame_hdr).frame_offset == 2i32
            && (*t).by >= 0i32
    ...
    if (*b).intra != 0 {
        let ymode_cdf: *mut uint16_t = if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
        ...
        (*b).c2rust_unnamed.c2rust_unnamed.y_mode = dav1d_msac_decode_symbol_adapt16(
            &mut (*ts).msac,
            ymode_cdf,
            (N_INTRA_PRED_MODES as libc::c_int - 1i32) as size_t,
        ) as uint8_t;
        if 0i32 != 0
            && (*(*f).frame_hdr).frame_offset == 2i32
            && (*t).by >= 0i32
        ...
        if *b_dim.offset(2isize) as libc::c_int + *b_dim.offset(3isize) as libc::c_int >= 2i32
                ...
                <= VERT_LEFT_PRED as libc::c_int
        {
            ...
            let angle: libc::c_int =
                dav1d_msac_decode_symbol_adapt8(&mut (*ts).msac, acdf, 6u64) as libc::c_int;
            (*b).c2rust_unnamed.c2rust_unnamed.y_angle = (angle - 3i32) as int8_t;
        } else {
            (*b).c2rust_unnamed.c2rust_unnamed.y_angle = 0i8;
        }
        if has_chroma != 0 {
            let cfl_allowed: libc::c_int =
                if (*(*f).frame_hdr).segmentation.lossless[(*b).seg_id as usize] != 0 {
                    (cbw4 == 1i32 && cbh4 == 1i32) as libc::c_int
                } else {
                    (cfl_allowed_mask & ((1i32) << bs) as libc::c_uint != 0) as libc::c_int
                };
            ...
            (*b).c2rust_unnamed.c2rust_unnamed.uv_mode = dav1d_msac_decode_symbol_adapt16(
                &mut (*ts).msac,
                uvmode_cdf,
                (N_UV_INTRA_PRED_MODES as libc::c_int - 1i32 - (cfl_allowed == 0) as libc::c_int)
                    as size_t,
            ) as uint8_t;
            if 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
            ...
            (*b).c2rust_unnamed.c2rust_unnamed.uv_angle = 0i8;
            if (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_int == CFL_PRED as libc::c_int
            {
                ...
                let sign_u: libc::c_int = sign * 0x56i32 >> 8i32;
                let sign_v: libc::c_int = sign - sign_u * 3i32;
                if !(sign_u == sign / 3i32) {
                    unreachable!();
                }
                if sign_u != 0 {
                    let ctx: libc::c_int = (sign_u == 2i32) as libc::c_int * 3i32 + sign_v;
                    (*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[0usize] =
                        (dav1d_msac_decode_symbol_adapt16(
                            &mut (*ts).msac,
                            ((*ts).cdf.m.cfl_alpha[ctx as usize]).as_mut_ptr(),
                            15u64,
                        ))
                        .wrapping_add(1u32) as int8_t;
                    if sign_u == 1i32 {
                        (*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[0usize] =
                            -((*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[0usize] as libc::c_int)
                                as int8_t;
                    }
                } else {
                    (*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[0usize] = 0i8;
                }
                if sign_v != 0 {
                    let ctx_0: libc::c_int = (sign_v == 2i32) as libc::c_int * 3i32 + sign_u;
                    (*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[1usize] =
                        (dav1d_msac_decode_symbol_adapt16(
                            &mut (*ts).msac,
                    ...
                    if sign_v == 1i32 {
                        (*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[1usize] =
                            -((*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[1usize] as libc::c_int)
                                as int8_t;
                    }
                } else {
                    (*b).c2rust_unnamed.c2rust_unnamed.cfl_alpha[1usize] = 0i8;
                }
                if 0i32 != 0
                    && (*(*f).frame_hdr).frame_offset == 2i32
                    && (*t).by >= 0i32
            ...
            } else if *b_dim.offset(2isize) as libc::c_int + *b_dim.offset(3isize) as libc::c_int
                >= 2i32
                && (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_int
                    ...
                    <= VERT_LEFT_PRED as libc::c_int
            {
                let acdf_0: *mut uint16_t =
                    ((*ts).cdf.m.angle_delta[((*b).c2rust_unnamed.c2rust_unnamed.uv_mode
                        as libc::c_int
                        - VERT_PRED as libc::c_int)
                        as usize])
                        .as_mut_ptr();
                let angle_0: libc::c_int =
                    dav1d_msac_decode_symbol_adapt8(&mut (*ts).msac, acdf_0, 6u64) as libc::c_int;
                (*b).c2rust_unnamed.c2rust_unnamed.uv_angle = (angle_0 - 3i32) as int8_t;
            }
        }
        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] = 0u8;
        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] =
            (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize];
        if (*(*f).frame_hdr).allow_screen_content_tools != 0
            && imax(bw4, bh4) <= 16i32
            && bw4 + bh4 >= 4i32
        {
            let sz_ctx: libc::c_int =
                *b_dim.offset(2isize) as libc::c_int + *b_dim.offset(3isize) as libc::c_int - 2i32;
            if (*b).c2rust_unnamed.c2rust_unnamed.y_mode as libc::c_int == DC_PRED as libc::c_int {
                let pal_ctx: libc::c_int = ((*(*t).a).pal_sz[bx4 as usize] as libc::c_int > 0i32)
                    as libc::c_int
                    + ((*t).l.pal_sz[by4 as usize] as libc::c_int > 0i32) as libc::c_int;
                ...
                if use_y_pal != 0 {
                    read_pal_plane(t, b, 0i32, sz_ctx, bx4, by4);
                }
            }
            if has_chroma != 0
                && (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_int
                    == DC_PRED as libc::c_int
            {
                let pal_ctx_0: libc::c_int = ((*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize]
                    as libc::c_int
                    > 0i32) as libc::c_int;
        ...
        if (*b).c2rust_unnamed.c2rust_unnamed.y_mode as libc::c_int == DC_PRED as libc::c_int
            && (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] == 0
            && imax(
                *b_dim.offset(2isize) as libc::c_int,
                *b_dim.offset(3isize) as libc::c_int,
            ) <= 3i32
            && (*(*f).seq_hdr).filter_intra != 0
        {
            ...
            if is_filter != 0 {
                (*b).c2rust_unnamed.c2rust_unnamed.y_mode = FILTER_PRED as uint8_t;
        ...
        if (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] != 0 {
            let mut pal_idx: *mut uint8_t = 0 as *mut uint8_t;
            if (*t).frame_thread.pass != 0 {
                let p: libc::c_int = (*t).frame_thread.pass & 1i32;
                ...
                (*ts).frame_thread[p as usize].pal_idx =
                    ((*ts).frame_thread[p as usize].pal_idx).offset((bw4 * bh4 * 16i32) as isize);
            } else {
                pal_idx = ((*t).scratch.c2rust_unnamed_0.pal_idx).as_mut_ptr();
            }
            read_pal_indices(t, pal_idx, b, 0i32, w4, h4, bw4, bh4);
            if 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
                && (*t).by >= 0i32
                && (*t).by < 4i32
        ...
        if has_chroma != 0 && (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int != 0
        {
            let mut pal_idx_0: *mut uint8_t = 0 as *mut uint8_t;
            if (*t).frame_thread.pass != 0 {
                let p_0: libc::c_int = (*t).frame_thread.pass & 1i32;
                if ((*ts).frame_thread[p_0 as usize].pal_idx).is_null() {
                    unreachable!();
                }
                pal_idx_0 = (*ts).frame_thread[p_0 as usize].pal_idx;
                (*ts).frame_thread[p_0 as usize].pal_idx = ((*ts).frame_thread[p_0 as usize]
                    .pal_idx)
                    .offset((cbw4 * cbh4 * 16i32) as isize);
            } else {
                pal_idx_0 = &mut *((*t).scratch.c2rust_unnamed_0.pal_idx)
                    .as_mut_ptr()
                    .offset((bw4 * bh4 * 16i32) as isize)
                    as *mut uint8_t;
            }
            read_pal_indices(t, pal_idx_0, b, 1i32, cw4, ch4, cbw4, cbh4);
            if 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
                && (*t).by >= 0i32
                && (*t).by < 4i32
        ...
        if (*(*f).frame_hdr).segmentation.lossless[(*b).seg_id as usize] != 0 {
            ...
            (*b).c2rust_unnamed.c2rust_unnamed.tx = dav1d_max_txfm_size_for_bs[bs as usize][0usize];
            (*b).uvtx = dav1d_max_txfm_size_for_bs[bs as usize][(*f).cur.p.layout as usize];
            t_dim = &*dav1d_txfm_dimensions
                .as_ptr()
                ...
                && (*t_dim).max as libc::c_int > TX_4X4 as libc::c_int
            {
                ...
                let tx_cdf: *mut uint16_t = ((*ts).cdf.m.txsz
                    [((*t_dim).max as libc::c_int - 1i32) as usize][tctx as usize])
                    .as_mut_ptr();
                let mut depth: libc::c_int = dav1d_msac_decode_symbol_adapt4(
                    &mut (*ts).msac,
                    tx_cdf,
                    imin((*t_dim).max as libc::c_int, 2i32) as size_t,
                ) as libc::c_int;
                loop {
                    let fresh32 = depth;
                    depth = depth - 1;
            ...
            || (*(*f).frame_hdr).loopfilter.level_y[1usize] != 0
        {
            dav1d_create_lf_mask_intra(
                ...
                .offset(0isize))
                .as_ptr()
                .offset(0isize) as *const uint8_t as *const [[uint8_t; 2]; 8],
                (*t).bx,
                (*t).by,
                (*f).w4,
                (*f).h4,
        ...
        let y_mode_nofilt_0: IntraPredMode = (if (*b).c2rust_unnamed.c2rust_unnamed.y_mode
            as libc::c_int
            == FILTER_PRED as libc::c_int
        {
            DC_PRED as libc::c_int
        ...
        match bh4 {
            1 => {
                (*(&mut *((*t).l.tx_intra).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                    * *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(1isize)
                ...
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1u32).wrapping_mul(y_mode_nofilt_0) as uint8_t;
                (*(&mut *((*t).l.pal_sz).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                    * (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_int)
                    as uint8_t;
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32 * seg_pred) as uint8_t;
                ...
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32 * (*b).skip as libc::c_int) as uint8_t;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias8))
                    .u8_0 = (0x1i32
                    * (if has_chroma != 0 {
                        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int
                    } else {
                        0i32
                    })) as uint8_t;
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    (*(&mut *((*t).l.comp_type).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * COMP_INTER_NONE as libc::c_int) as uint8_t;
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * -(1i32) as uint8_t as libc::c_int) as uint8_t;
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * -(1i32) as uint8_t as libc::c_int) as uint8_t;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * DAV1D_N_SWITCHABLE_FILTERS as libc::c_int) as uint8_t;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias8))
            ...
            2 => {
                ...
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101u32).wrapping_mul(y_mode_nofilt_0) as uint16_t;
                (*(&mut *((*t).l.pal_sz).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32
                    * (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_int)
                ...
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32 * seg_pred) as uint16_t;
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = 0u16;
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32 * (*b).skip as libc::c_int) as uint16_t;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                ...
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    (*(&mut *((*t).l.comp_type).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * COMP_INTER_NONE as libc::c_int) as uint16_t;
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * -(1i32) as uint8_t as libc::c_int) as uint16_t;
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias16))
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
                        .u16_0 = (0x101i32 * DAV1D_N_SWITCHABLE_FILTERS as libc::c_int) as uint16_t;
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias16))
            ...
            4 => {
                ...
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(y_mode_nofilt_0);
                (*(&mut *((*t).l.pal_sz).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_uint,
                );
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(seg_pred as libc::c_uint);
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = 0u32;
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul((*b).skip as libc::c_uint);
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                ...
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    (*(&mut *((*t).l.comp_type).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32).wrapping_mul(COMP_INTER_NONE);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32).wrapping_mul(-(1i32) as uint8_t as libc::c_uint);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias32))
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32).wrapping_mul(DAV1D_N_SWITCHABLE_FILTERS);
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
                        as *mut alias32))
            ...
            8 => {
                ...
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 =
                    (0x101010101010101u64).wrapping_mul(y_mode_nofilt_0 as libc::c_ulonglong);
                (*(&mut *((*t).l.pal_sz).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(seg_pred as libc::c_ulonglong);
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = 0u64;
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul((*b).skip as libc::c_ulonglong);
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                ...
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    (*(&mut *((*t).l.comp_type).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64)
                        .wrapping_mul(COMP_INTER_NONE as libc::c_int as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut int8_t
                        as *mut alias64))
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(by4 as isize) as *mut uint8_t
            ...
            16 => {
                let const_val_27: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(1isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.tx_intra)
                ...
                (*(&mut *((*t).l.tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_27;
                let const_val_28: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(1isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_28;
                let const_val_29: uint64_t =
                    (0x101010101010101u64).wrapping_mul(y_mode_nofilt_0 as libc::c_ulonglong);
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_29;
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_29;
                let const_val_30: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.pal_sz)
                    .as_mut_ptr()
                ...
                (*(&mut *((*t).l.pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_30;
                let const_val_31: uint64_t =
                    (0x101010101010101u64).wrapping_mul(seg_pred as libc::c_ulonglong);
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset((by4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_31;
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset((by4 + 8i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_31;
                let const_val_32: uint64_t = 0u64;
                (*(&mut *((*t).l.skip_mode)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_32;
                let const_val_33: uint64_t = 0x101010101010101u64;
                (*(&mut *((*t).l.intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_33;
                let const_val_34: uint64_t =
                    (0x101010101010101u64).wrapping_mul((*b).skip as libc::c_ulonglong);
                (*(&mut *((*t).l.skip).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_34;
                (*(&mut *((*t).l.skip).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_34;
                let const_val_35: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (if has_chroma != 0 {
                        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int
                    } else {
                        0i32
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    ...
                    .u64_0 = const_val_35;
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    let const_val_36: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(COMP_INTER_NONE as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*t).l.comp_type)
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *((*t).l.comp_type)
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_36;
                    let const_val_37: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_37;
                    let const_val_38: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_38;
                    let const_val_39: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_39;
                    let const_val_40: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
            ...
            32 => {
                let const_val_41: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(1isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.tx_intra)
                ...
                (*(&mut *((*t).l.tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_41;
                let const_val_42: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(1isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_42;
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 16i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_42;
                (*(&mut *((*t).l.tx).as_mut_ptr().offset((by4 + 24i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_42;
                let const_val_43: uint64_t =
                    (0x101010101010101u64).wrapping_mul(y_mode_nofilt_0 as libc::c_ulonglong);
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_43;
                ...
                (*(&mut *((*t).l.mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_43;
                let const_val_44: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.pal_sz)
                    .as_mut_ptr()
                ...
                (*(&mut *((*t).l.seg_pred)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_45;
                let const_val_46: uint64_t = 0u64;
                (*(&mut *((*t).l.skip_mode)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_46;
                let const_val_47: uint64_t = 0x101010101010101u64;
                (*(&mut *((*t).l.intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_48;
                let const_val_49: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (if has_chroma != 0 {
                        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int
                    } else {
                        0i32
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    ...
                    .u64_0 = const_val_49;
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    let const_val_50: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(COMP_INTER_NONE as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*t).l.comp_type)
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *((*t).l.comp_type)
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_50;
                    let const_val_51: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_51;
                    let const_val_52: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((by4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_52;
                    let const_val_53: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                    ...
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_53;
                    let const_val_54: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
        ...
        match bw4 {
            1 => {
                (*(&mut *((*(*t).a).tx_intra).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                    * *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(0isize)
                        as libc::c_int) as uint8_t;
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                ...
                (*(&mut *((*(*t).a).skip).as_mut_ptr().offset(bx4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32 * (*b).skip as libc::c_int) as uint8_t;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                ...
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    (*(&mut *((*(*t).a).comp_type).as_mut_ptr().offset(bx4 as isize)
                        as *mut uint8_t as *mut alias8))
                        .u8_0 = (0x1i32 * COMP_INTER_NONE as libc::c_int)
                        as uint8_t;
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(bx4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * -(1i32) as uint8_t as libc::c_int) as uint8_t;
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset(bx4 as isize) as *mut int8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * -(1i32) as uint8_t as libc::c_int) as uint8_t;
            ...
            2 => {
                ...
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    (*(&mut *((*(*t).a).comp_type).as_mut_ptr().offset(bx4 as isize)
                        as *mut uint8_t as *mut alias16))
                        .u16_0 = (0x101i32 * COMP_INTER_NONE as libc::c_int)
                        as uint16_t;
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset(bx4 as isize) as *mut int8_t
            ...
            16 => {
                let const_val_55: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(0isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_55;
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 8i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_55;
                let const_val_56: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(0isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*(*t).a).mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_57;
                let const_val_58: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).pal_sz)
                    .as_mut_ptr()
                ...
                (*(&mut *((*(*t).a).seg_pred)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_59;
                let const_val_60: uint64_t = 0u64;
                (*(&mut *((*(*t).a).skip_mode)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_60;
                let const_val_61: uint64_t = 0x101010101010101u64;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_61;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
                ...
                (*(&mut *((*(*t).a).skip)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_62;
                let const_val_63: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (if has_chroma != 0 {
                        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int
                    } else {
                        0i32
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    ...
                    .u64_0 = const_val_63;
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    let const_val_64: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(COMP_INTER_NONE as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).comp_type)
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *((*(*t).a).comp_type)
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_64;
                    let const_val_65: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_65;
                    let const_val_66: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_66;
                    let const_val_67: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                    ...
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_67;
                    let const_val_68: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
            ...
            32 => {
                let const_val_69: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(0isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).tx_intra)
                ...
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 16i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_69;
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 24i32) as isize) as *mut int8_t
                    as *mut alias64))
                    .u64_0 = const_val_69;
                let const_val_70: uint64_t = (0x101010101010101u64).wrapping_mul(
                    *(&(*t_dim).lw as *const uint8_t as *mut uint8_t).offset(0isize)
                        as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).tx).as_mut_ptr().offset((bx4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 24i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_71;
                let const_val_72: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).pal_sz)
                    .as_mut_ptr()
                ...
                (*(&mut *((*(*t).a).seg_pred)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_73;
                let const_val_74: uint64_t = 0u64;
                (*(&mut *((*(*t).a).skip_mode)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_74;
                let const_val_75: uint64_t = 0x101010101010101u64;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_75;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
                ...
                (*(&mut *((*(*t).a).skip)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_76;
                (*(&mut *((*(*t).a).skip).as_mut_ptr().offset((bx4 + 16i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_76;
                (*(&mut *((*(*t).a).skip).as_mut_ptr().offset((bx4 + 24i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_76;
                let const_val_77: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (if has_chroma != 0 {
                        (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] as libc::c_int
                    } else {
                        0i32
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    ...
                    .u64_0 = const_val_77;
                if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                    let const_val_78: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(COMP_INTER_NONE as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).comp_type)
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    ...
                    (*(&mut *((*(*t).a).comp_type)
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_78;
                    let const_val_79: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_79;
                    let const_val_80: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(-(1i32) as uint8_t as libc::c_ulonglong);
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
                        .offset((bx4 + 0i32) as isize) as *mut int8_t
                    ...
                    (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_80;
                    let const_val_81: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        .as_mut_ptr()
                    ...
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(0isize))
                        ...
                        as *mut alias64))
                        .u64_0 = const_val_81;
                    let const_val_82: uint64_t = (0x101010101010101u64).wrapping_mul(
                        DAV1D_N_SWITCHABLE_FILTERS as libc::c_int as libc::c_ulonglong,
                    );
                    (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                        .as_mut_ptr()
        ...
        if (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] != 0 {
            let pal: *mut uint16_t = if (*t).frame_thread.pass != 0 {
                ((*((*f).frame_thread.pal).offset(
                    ((((*t).by >> 1i32) + ((*t).bx & 1i32)) as libc::c_long
                        * ((*f).b4_stride >> 1i32)
                        + (((*t).bx >> 1i32) + ((*t).by & 1i32)) as libc::c_long)
                        as isize,
                ))[0usize])
                    .as_mut_ptr()
            } else {
                ((*t).scratch.c2rust_unnamed_0.pal[0usize]).as_mut_ptr()
            };
            let mut x_1: libc::c_int = 0i32;
            while x_1 < bw4 {
                memcpy(
                    ((*t).al_pal[0usize][(bx4 + x_1) as usize][0usize]).as_mut_ptr()
                        as *mut libc::c_void,
            ...
            while y_1 < bh4 {
                memcpy(
                    ((*t).al_pal[1usize][(by4 + y_1) as usize][0usize]).as_mut_ptr()
                        as *mut libc::c_void,
                    pal as *const libc::c_void,
                    16u64,
                );
        ...
        if has_chroma != 0 {
            match cbh4 {
                1 => {
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize) as *mut uint8_t
                        as *mut alias8))
                        .u8_0 = (0x1i32 * (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_int)
                        as uint8_t;
                }
                2 => {
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize) as *mut uint8_t
                ...
                4 => {
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize) as *mut uint8_t
                        as *mut alias32))
                        .u32_0 = (0x1010101u32)
                        .wrapping_mul((*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_uint);
                }
                8 => {
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset(cby4 as isize) as *mut uint8_t
                        as *mut alias64))
                ...
                16 => {
                    let const_val_83: uint64_t = (0x101010101010101u64).wrapping_mul(
                        (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                    );
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                ...
                32 => {
                    let const_val_84: uint64_t = (0x101010101010101u64).wrapping_mul(
                        (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                    );
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
            ...
            match cbw4 {
                ...
                16 => {
                    let const_val_85: uint64_t = (0x101010101010101u64).wrapping_mul(
                        (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                    );
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 0i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_85;
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 8i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_85;
                }
                32 => {
                    let const_val_86: uint64_t = (0x101010101010101u64).wrapping_mul(
                        (*b).c2rust_unnamed.c2rust_unnamed.uv_mode as libc::c_ulonglong,
                    );
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                    ...
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 16i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_86;
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 24i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_86;
                }
                _ => {}
            }
            if (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[1usize] != 0 {
                ...
                while pl <= 2i32 {
                    ...
                    while x_2 < bw4 {
                        memcpy(
                            ((*t).al_pal[0usize][(bx4 + x_2) as usize][pl as usize]).as_mut_ptr()
                                as *mut libc::c_void,
                    ...
                    while y_2 < bh4 {
                        memcpy(
                            ((*t).al_pal[1usize][(by4 + y_2) as usize][pl as usize]).as_mut_ptr()
                                as *mut libc::c_void,
                            (*pal_0.offset(pl as isize)).as_ptr() as *const libc::c_void,
                            16u64,
                        );
        ...
        if (*(*f).frame_hdr).frame_type & 1u32 != 0 || (*(*f).frame_hdr).allow_intrabc != 0 {
        ...
        dav1d_refmvs_find(
            ...
            &mut n_mvs,
            &mut ctx_1,
            refmvs_refpair { ref_0: [0i8, -1i8] },
            bs,
            intra_edge_flags,
            (*t).by,
            (*t).bx,
        );
        if mvstack[0usize].mv.mv[0usize].n != 0 {
            (*b).c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                .c2rust_unnamed
                .mv[0usize] = mvstack[0usize].mv.mv[0usize];
        } else if mvstack[1usize].mv.mv[0usize].n != 0 {
            (*b).c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                .c2rust_unnamed
                .mv[0usize] = mvstack[1usize].mv.mv[0usize];
        } else if (*t).by - ((16i32) << (*(*f).seq_hdr).sb128) < (*ts).tiling.row_start {
            (*b).c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                .c2rust_unnamed
            ...
            (*b).c2rust_unnamed
                ...
                .mv[0usize]
                .c2rust_unnamed
                .x = (-((512i32) << (*(*f).seq_hdr).sb128) - 2048i32) as int16_t;
        } else {
            (*b).c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                ...
                .mv[0usize]
                .c2rust_unnamed
                .y = -((512i32) << (*(*f).seq_hdr).sb128) as int16_t;
            (*b).c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                .c2rust_unnamed
        ...
        let mut border_left: libc::c_int = (*ts).tiling.col_start * 4i32;
        let mut border_top: libc::c_int = (*ts).tiling.row_start * 4i32;
        if has_chroma != 0 {
            if bw4 < 2i32 && ss_hor != 0 {
                border_left += 4i32;
            }
            if bh4 < 2i32 && ss_ver != 0 {
                border_top += 4i32;
            }
        }
        let mut src_left: libc::c_int = (*t).bx * 4i32
            + ((*b)
                .c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                ...
                .x as libc::c_int
                >> 3i32);
        let mut src_top: libc::c_int = (*t).by * 4i32
            + ((*b)
                .c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                ...
                .y as libc::c_int
                >> 3i32);
        let mut src_right: libc::c_int = src_left + bw4 * 4i32;
        let mut src_bottom: libc::c_int = src_top + bh4 * 4i32;
        let border_right: libc::c_int =
            ((*ts).tiling.col_end + (bw4 - 1i32) & !(bw4 - 1i32)) * 4i32;
        ...
        let sbx: libc::c_int =
            (*t).bx >> 4i32 + (*(*f).seq_hdr).sb128 << 6i32 + (*(*f).seq_hdr).sb128;
        let sby: libc::c_int =
            (*t).by >> 4i32 + (*(*f).seq_hdr).sb128 << 6i32 + (*(*f).seq_hdr).sb128;
        let sb_size: libc::c_int = (1i32) << 6i32 + (*(*f).seq_hdr).sb128;
        ...
        (*b).c2rust_unnamed
            ...
            .mv[0usize]
            .c2rust_unnamed
            .x = ((src_left - (*t).bx * 4i32) * 8i32) as int16_t;
        (*b).c2rust_unnamed
            .c2rust_unnamed_0
            .c2rust_unnamed
            .c2rust_unnamed
            .mv[0usize]
            .c2rust_unnamed
            .y = ((src_top - (*t).by * 4i32) * 8i32) as int16_t;
        if 0i32 != 0
            && (*(*f).frame_hdr).frame_offset == 2i32
            && (*t).by >= 0i32
            && (*t).by < 4i32
            ...
            && (*t).bx < 12i32
        {
            printf(
                ...
                mvstack[0usize].mv.mv[0usize].c2rust_unnamed.y as libc::c_int,
                mvstack[0usize].mv.mv[0usize].c2rust_unnamed.x as libc::c_int,
                (*ts).msac.rng,
            );
        }
        ...
        if (*t).frame_thread.pass == 1i32 {
            ((*f).bd_fn.read_coef_blocks).expect("non-null function pointer")(t, bs, b);
            (*b).c2rust_unnamed.c2rust_unnamed_0.filter2d = FILTER_2D_BILINEAR as uint8_t;
        ...
        match bh4 {
            ...
            2 => {
                (*(&mut *((*t).l.tx_intra).as_mut_ptr().offset(by4 as isize) as *mut int8_t
                    as *mut alias16))
                    .u16_0 =
                    (0x101i32 * *b_dim.offset((2i32 + 1i32) as isize) as libc::c_int) as uint16_t;
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32 * DC_PRED as libc::c_int) as uint16_t;
                (*(&mut *((*t).l.pal_sz).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
            ...
            16 => {
                let const_val_87: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*t).l.tx_intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*t).l.tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_87;
                let const_val_88: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_88;
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_88;
                let const_val_89: uint64_t = 0u64;
                (*(&mut *((*t).l.pal_sz)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_89;
                let const_val_90: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset((by4 + 8i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_91;
                let const_val_92: uint64_t = 0u64;
                (*(&mut *((*t).l.skip_mode)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_92;
                let const_val_93: uint64_t = 0u64;
                (*(&mut *((*t).l.intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
            ...
            32 => {
                let const_val_95: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*t).l.tx_intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*t).l.tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_95;
                let const_val_96: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_96;
                ...
                (*(&mut *((*t).l.mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_96;
                let const_val_97: uint64_t = 0u64;
                (*(&mut *((*t).l.pal_sz)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_97;
                let const_val_98: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.seg_pred)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_99;
                let const_val_100: uint64_t = 0u64;
                (*(&mut *((*t).l.skip_mode)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_100;
                let const_val_101: uint64_t = 0u64;
                (*(&mut *((*t).l.intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
        ...
        match bw4 {
            ...
            2 => {
                (*(&mut *((*(*t).a).tx_intra).as_mut_ptr().offset(bx4 as isize) as *mut int8_t
                    as *mut alias16))
                    .u16_0 =
                    (0x101i32 * *b_dim.offset((2i32 + 0i32) as isize) as libc::c_int) as uint16_t;
                (*(&mut *((*(*t).a).mode).as_mut_ptr().offset(bx4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32 * DC_PRED as libc::c_int) as uint16_t;
                (*(&mut *((*(*t).a).pal_sz).as_mut_ptr().offset(bx4 as isize) as *mut uint8_t
            ...
            16 => {
                let const_val_103: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*(*t).a).tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_103;
                let const_val_104: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                (*(&mut *((*(*t).a).mode)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                ...
                (*(&mut *((*(*t).a).mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_104;
                let const_val_105: uint64_t = 0u64;
                (*(&mut *((*(*t).a).pal_sz)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_105;
                let const_val_106: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).seg_pred)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_107;
                let const_val_108: uint64_t = 0u64;
                (*(&mut *((*(*t).a).skip_mode)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_108;
                let const_val_109: uint64_t = 0u64;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_109;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
            ...
            32 => {
                let const_val_111: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*(*t).a).tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_111;
                let const_val_112: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                (*(&mut *((*(*t).a).mode)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                ...
                (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 24i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_112;
                let const_val_113: uint64_t = 0u64;
                (*(&mut *((*(*t).a).pal_sz)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_113;
                let const_val_114: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).seg_pred)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_115;
                let const_val_116: uint64_t = 0u64;
                (*(&mut *((*(*t).a).skip_mode)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_116;
                let const_val_117: uint64_t = 0u64;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_117;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
        ...
        if has_chroma != 0 {
            match cbh4 {
                ...
                16 => {
                    let const_val_119: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_119;
                ...
                32 => {
                    let const_val_120: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_120;
            ...
            match cbw4 {
                ...
                16 => {
                    let const_val_121: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 0i32) as isize) as *mut uint8_t
                ...
                32 => {
                    let const_val_122: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 0i32) as isize) as *mut uint8_t
        ...
        if (*b).skip_mode != 0 {
            ...
            || (*seg).ref_0 == -(1i32) && (*seg).globalmv == 0 && (*seg).skip == 0)
            && (*(*f).frame_hdr).switchable_comp_refs != 0
            && imin(bw4, bh4) > 1i32
        {
            let ctx_2: libc::c_int =
                get_comp_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
        ...
        if (*b).skip_mode != 0 {
            (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                (*(*f).frame_hdr).skip_mode_refs[0usize] as int8_t;
            (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] =
                (*(*f).frame_hdr).skip_mode_refs[1usize] as int8_t;
            ...
            (*b).c2rust_unnamed
                ...
                .c2rust_unnamed
                .c2rust_unnamed
                .mv[0usize] = mvstack_0[0usize].mv.mv[0usize];
            (*b).c2rust_unnamed
                .c2rust_unnamed_0
                .c2rust_unnamed
                .c2rust_unnamed
                .mv[1usize] = mvstack_0[0usize].mv.mv[1usize];
            fix_mv_precision(
                (*f).frame_hdr,
                &mut *((*b)
                    .c2rust_unnamed
                ...
                && (*t).bx < 12i32
            {
                printf(
                    ...
                    (*b).c2rust_unnamed
                        ...
                        .c2rust_unnamed
                        .x as libc::c_int,
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_int,
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as libc::c_int,
                );
            }
        } else if is_comp != 0 {
            let dir_ctx: libc::c_int =
                get_comp_dir_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
            ...
            {
                let ctx1: libc::c_int =
                    av1_get_fwd_ref_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                if dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.comp_fwd_ref[0usize][ctx1 as usize]).as_mut_ptr(),
                ) != 0
                {
                    let ctx2: libc::c_int =
                        av1_get_fwd_ref_2_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                        (2u32).wrapping_add(dav1d_msac_decode_bool_adapt(
                            &mut (*ts).msac,
                            ((*ts).cdf.m.comp_fwd_ref[2usize][ctx2 as usize]).as_mut_ptr(),
                        )) as int8_t;
                } else {
                    let ctx2_0: libc::c_int =
                        av1_get_fwd_ref_1_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                        dav1d_msac_decode_bool_adapt(
                            &mut (*ts).msac,
                            ((*ts).cdf.m.comp_fwd_ref[1usize][ctx2_0 as usize]).as_mut_ptr(),
                        ) as int8_t;
                }
                let ctx3: libc::c_int =
                    av1_get_bwd_ref_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                if dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.comp_bwd_ref[0usize][ctx3 as usize]).as_mut_ptr(),
                ) != 0
                {
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] = 6i8;
                } else {
                    let ctx4: libc::c_int =
                        av1_get_bwd_ref_1_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] =
                        (4u32).wrapping_add(dav1d_msac_decode_bool_adapt(
                            &mut (*ts).msac,
                            ((*ts).cdf.m.comp_bwd_ref[1usize][ctx4 as usize]).as_mut_ptr(),
                        )) as int8_t;
                }
            } else {
                let uctx_p: libc::c_int =
                    av1_get_ref_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                if dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.comp_uni_ref[0usize][uctx_p as usize]).as_mut_ptr(),
                ) != 0
                {
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] = 4i8;
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] = 6i8;
                } else {
                    let uctx_p1: libc::c_int =
                        av1_get_uni_p1_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] = 0i8;
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] =
                        (1u32).wrapping_add(dav1d_msac_decode_bool_adapt(
                            &mut (*ts).msac,
                            ((*ts).cdf.m.comp_uni_ref[1usize][uctx_p1 as usize]).as_mut_ptr(),
                        )) as int8_t;
                    if (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as libc::c_int == 2i32 {
                        ...
                        (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] =
                            ((*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as libc::c_uint)
                                .wrapping_add(dav1d_msac_decode_bool_adapt(
                                    &mut (*ts).msac,
                                    ((*ts).cdf.m.comp_uni_ref[2usize][uctx_p2 as usize])
                                        .as_mut_ptr(),
                                )) as int8_t;
                    }
                }
            ...
            (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode = dav1d_msac_decode_symbol_adapt8(
                ...
                (N_COMP_INTER_PRED_MODES as libc::c_int - 1i32) as size_t,
            ) as uint8_t;
            if 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
                && (*t).by >= 0i32
            ...
            let im: *const uint8_t = (dav1d_comp_inter_pred_modes
                [(*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as usize])
                .as_ptr();
            (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = NEAREST_DRL as uint8_t;
            ...
            {
                if n_mvs_1 > 1i32 {
                    let drl_ctx_v1: libc::c_int = get_drl_context(mvstack_1.as_mut_ptr(), 0i32);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = ((*b)
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .drl_idx
                        as libc::c_uint)
                    ...
                    if (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_int
                        ...
                        && n_mvs_1 > 2i32
                    {
                        let drl_ctx_v2: libc::c_int = get_drl_context(mvstack_1.as_mut_ptr(), 1i32);
            ...
            } else if *im.offset(0isize) as libc::c_int == NEARMV as libc::c_int
                || *im.offset(1isize) as libc::c_int == NEARMV as libc::c_int
            {
                (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = NEARER_DRL as uint8_t;
                if n_mvs_1 > 2i32 {
                    let drl_ctx_v2_0: libc::c_int = get_drl_context(mvstack_1.as_mut_ptr(), 1i32);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = ((*b)
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .drl_idx
                    ...
                    if (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_int
                        ...
                        && n_mvs_1 > 3i32
                    {
                        let drl_ctx_v3: libc::c_int = get_drl_context(mvstack_1.as_mut_ptr(), 2i32);
                        (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx =
                            ((*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_uint)
                                .wrapping_add(dav1d_msac_decode_bool_adapt(
                                    &mut (*ts).msac,
            ...
            has_subpel_filter = (imin(bw4, bh4) == 1i32
                || (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_int
                    != GLOBALMV_GLOBALMV as libc::c_int)
                as libc::c_int;
            match *im.offset(0isize) as libc::c_int {
                1 | 0 => {
                    (*b).c2rust_unnamed
                        .c2rust_unnamed_0
                        .c2rust_unnamed
                ...
                2 => {
                    has_subpel_filter |= ((*(*f).frame_hdr).gmv
                        [(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as usize]
                        .type_0
            ...
            match *im.offset(1isize) as libc::c_int {
                1 | 0 => {
                    (*b).c2rust_unnamed
                        .c2rust_unnamed_0
                        .c2rust_unnamed
                ...
                2 => {
                    has_subpel_filter |= ((*(*f).frame_hdr).gmv
                        [(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as usize]
                        .type_0
                        == DAV1D_WM_TYPE_TRANSLATION)
                        as libc::c_int;
                    (*b).c2rust_unnamed
            ...
            let mut is_segwedge: libc::c_int = 0i32;
            if (*(*f).seq_hdr).masked_compound != 0 {
                let mask_ctx: libc::c_int = get_mask_comp_ctx((*t).a, &mut (*t).l, by4, bx4);
            ...
            if is_segwedge == 0 {
                if (*(*f).seq_hdr).jnt_comp != 0 {
                    let jnt_ctx: libc::c_int = get_jnt_comp_ctx(
                        ...
                        (*(*f).refp[(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as usize]
                            .p
                            .frame_hdr)
                            .frame_offset as libc::c_uint,
                        (*(*f).refp[(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as usize]
                            .p
                            .frame_hdr)
                            .frame_offset as libc::c_uint,
                        (*t).a,
                    ...
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type =
                        (COMP_INTER_WEIGHTED_AVG).wrapping_add(dav1d_msac_decode_bool_adapt(
                            &mut (*ts).msac,
                        ...
                        && (*t).bx < 12i32
                    {
                        printf(
                            ...
                            (*(*t).a).ref_0[0usize][bx4 as usize] as libc::c_int,
                            (*t).l.comp_type[by4 as usize] as libc::c_int,
                            (*t).l.ref_0[0usize][by4 as usize] as libc::c_int,
                            (*ts).msac.rng,
                        );
                    }
                } else {
                ...
                if wedge_allowed_mask & ((1i32) << bs) as libc::c_uint != 0 {
                    let ctx_5: libc::c_int = dav1d_wedge_ctx_lut[bs as usize] as libc::c_int;
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type =
                        (COMP_INTER_WEDGE).wrapping_sub(dav1d_msac_decode_bool_adapt(
                            &mut (*ts).msac,
                    ...
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type = COMP_INTER_SEG as uint8_t;
                }
                (*b).c2rust_unnamed
                    .c2rust_unnamed_0
                    .c2rust_unnamed
            ...
            (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type = COMP_INTER_NONE as uint8_t;
            if !seg.is_null() && (*seg).ref_0 > 0i32 {
                (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                    ((*seg).ref_0 - 1i32) as int8_t;
            } else if !seg.is_null() && ((*seg).globalmv != 0 || (*seg).skip != 0) {
                (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] = 0i8;
            } else {
                let ctx1_0: libc::c_int =
                    av1_get_ref_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                if dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.ref_0[0usize][ctx1_0 as usize]).as_mut_ptr(),
                ) != 0
                {
                    let ctx2_1: libc::c_int =
                        av1_get_bwd_ref_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                    if dav1d_msac_decode_bool_adapt(
                        &mut (*ts).msac,
                        ((*ts).cdf.m.ref_0[1usize][ctx2_1 as usize]).as_mut_ptr(),
                    ) != 0
                    {
                        (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] = 6i8;
                    } else {
                        ...
                        (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                            (4u32).wrapping_add(dav1d_msac_decode_bool_adapt(
                                &mut (*ts).msac,
                                ((*ts).cdf.m.ref_0[5usize][ctx3_0 as usize]).as_mut_ptr(),
                            )) as int8_t;
                    }
                } else {
                    let ctx2_2: libc::c_int =
                        av1_get_fwd_ref_ctx((*t).a, &mut (*t).l, by4, bx4, have_top, have_left);
                    if dav1d_msac_decode_bool_adapt(
                        &mut (*ts).msac,
                        ((*ts).cdf.m.ref_0[2usize][ctx2_2 as usize]).as_mut_ptr(),
                    ) != 0
                    {
                        ...
                        (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                            (2u32).wrapping_add(dav1d_msac_decode_bool_adapt(
                                &mut (*ts).msac,
                                ((*ts).cdf.m.ref_0[4usize][ctx3_1 as usize]).as_mut_ptr(),
                            )) as int8_t;
                    } else {
                        ...
                        (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] =
                            dav1d_msac_decode_bool_adapt(
                                &mut (*ts).msac,
                                ((*ts).cdf.m.ref_0[3usize][ctx3_2 as usize]).as_mut_ptr(),
                            ) as int8_t;
                    }
                }
                if 0i32 != 0
            ...
            (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] = -1i8;
            ...
            if !seg.is_null() && ((*seg).skip != 0 || (*seg).globalmv != 0)
                || dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.newmv_mode[(ctx_6 & 7i32) as usize]).as_mut_ptr(),
                ) != 0
            {
                if !seg.is_null() && ((*seg).skip != 0 || (*seg).globalmv != 0)
                    || dav1d_msac_decode_bool_adapt(
                        &mut (*ts).msac,
                        ((*ts).cdf.m.globalmv_mode[(ctx_6 >> 3i32 & 1i32) as usize]).as_mut_ptr(),
                    ) == 0
                {
                    (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode = GLOBALMV as uint8_t;
                    (*b).c2rust_unnamed
                        .c2rust_unnamed_0
                        .c2rust_unnamed
                        .c2rust_unnamed
                    ...
                    has_subpel_filter = 1i32;
                    if dav1d_msac_decode_bool_adapt(
                        &mut (*ts).msac,
                        ((*ts).cdf.m.refmv_mode[(ctx_6 >> 4i32 & 15i32) as usize]).as_mut_ptr(),
                    ) != 0
                    {
                        (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode = NEARMV as uint8_t;
                        (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = NEARER_DRL as uint8_t;
                        if n_mvs_2 > 2i32 {
                            let drl_ctx_v2_1: libc::c_int =
                                get_drl_context(mvstack_2.as_mut_ptr(), 1i32);
                            (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx =
                                ((*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_uint)
                                    .wrapping_add(dav1d_msac_decode_bool_adapt(
                                        &mut (*ts).msac,
                            ...
                            if (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_int
                                ...
                                && n_mvs_2 > 3i32
                            {
                                let drl_ctx_v3_0: libc::c_int =
                                    get_drl_context(mvstack_2.as_mut_ptr(), 2i32);
                                (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx =
                                    ((*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_uint)
                                        .wrapping_add(dav1d_msac_decode_bool_adapt(
                                            &mut (*ts).msac,
                                            ((*ts).cdf.m.drl_bit[drl_ctx_v3_0 as usize])
                                                .as_mut_ptr(),
                                        )) as uint8_t;
                            }
                        }
                    } else {
                        (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode = NEARESTMV as uint8_t;
                        (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = NEAREST_DRL as uint8_t;
                    }
                    if !((*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx as libc::c_int
                        >= NEAREST_DRL as libc::c_int
                ...
                has_subpel_filter = 1i32;
                (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode = NEWMV as uint8_t;
                (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = NEAREST_DRL as uint8_t;
                if n_mvs_2 > 1i32 {
                    let drl_ctx_v1_0: libc::c_int = get_drl_context(mvstack_2.as_mut_ptr(), 0i32);
                    (*b).c2rust_unnamed.c2rust_unnamed_0.drl_idx = ((*b)
                        .c2rust_unnamed
                        .c2rust_unnamed_0
                        .drl_idx
                ...
                if n_mvs_2 > 1i32 {
                    ...
                    (*b).c2rust_unnamed
                        ...
                        .c2rust_unnamed
                        .c2rust_unnamed
                        .mv[0usize] = mvstack_2[0usize].mv.mv[0usize];
                    fix_mv_precision(
                        (*f).frame_hdr,
                        &mut *((*b)
                            .c2rust_unnamed
            ...
            let ii_sz_grp: libc::c_int = dav1d_ymode_size_context[bs as usize] as libc::c_int;
            if (*(*f).seq_hdr).inter_intra != 0
                && interintra_allowed_mask & ((1i32) << bs) as libc::c_uint != 0
                && dav1d_msac_decode_bool_adapt(
                    &mut (*ts).msac,
                ...
                ) != 0
            {
                (*b).c2rust_unnamed
                    ...
                    (N_INTER_INTRA_PRED_MODES as libc::c_int - 1i32) as size_t,
                ) as uint8_t;
                let wedge_ctx: libc::c_int = dav1d_wedge_ctx_lut[bs as usize] as libc::c_int;
                (*b).c2rust_unnamed.c2rust_unnamed_0.interintra_type =
                    (INTER_INTRA_BLEND).wrapping_add(dav1d_msac_decode_bool_adapt(
                        &mut (*ts).msac,
                ...
                (*b).c2rust_unnamed.c2rust_unnamed_0.interintra_type = INTER_INTRA_NONE as uint8_t;
            }
            if 0i32 != 0
                && (*(*f).frame_hdr).frame_offset == 2i32
                && (*t).by >= 0i32
            ...
            if (*(*f).frame_hdr).switchable_motion_mode != 0
                ...
                && (have_left != 0
                    && findoddzero(
                        &mut *((*t).l.intra).as_mut_ptr().offset((by4 + 1i32) as isize),
                        h4 >> 1i32,
                    ) != 0
                    || have_top != 0
                        && findoddzero(
                            &mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 1i32) as isize),
                            w4 >> 1i32,
                        ) != 0)
            {
                let mut mask: [uint64_t; 2] = [0u64, 0u64];
                find_matching_ref(
                    t,
                    intra_edge_flags,
                    bw4,
                ...
                let allow_warp: libc::c_int =
                    ((*f).svc[(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as usize][0usize]
                        .scale
                        == 0
                        && (*(*f).frame_hdr).force_integer_mv == 0
                        && (*(*f).frame_hdr).warp_motion != 0
                        && mask[0usize] | mask[1usize] != 0) as libc::c_int;
                    ...
                    if (*t).frame_thread.pass != 0 {
                        if (*t).warpmv.type_0 == DAV1D_WM_TYPE_AFFINE {
                            (*b).c2rust_unnamed
                                ...
                                .c2rust_unnamed_0
                                .matrix[0usize] =
                                ((*t).warpmv.matrix[2usize] - 0x10000i32) as int16_t;
                            (*b).c2rust_unnamed
                                .c2rust_unnamed_0
                                .c2rust_unnamed
                                .c2rust_unnamed_0
                                .matrix[1usize] = (*t).warpmv.matrix[3usize] as int16_t;
                            (*b).c2rust_unnamed
                                .c2rust_unnamed_0
                                .c2rust_unnamed
                                .c2rust_unnamed_0
                                .matrix[2usize] = (*t).warpmv.matrix[4usize] as int16_t;
                            (*b).c2rust_unnamed
                                .c2rust_unnamed_0
                                .c2rust_unnamed
                                .c2rust_unnamed_0
                                .matrix[3usize] =
                                ((*t).warpmv.matrix[5usize] - 0x10000i32) as int16_t;
                        } else {
                            (*b).c2rust_unnamed
                                .c2rust_unnamed_0
                                .c2rust_unnamed
                                .c2rust_unnamed_0
                                .matrix[0usize] = (-(32767i32) - 1i32) as int16_t;
                        }
                    }
                }
                if 0i32 != 0
                ...
                (*b).c2rust_unnamed.c2rust_unnamed_0.motion_mode = MM_TRANSLATION as uint8_t;
            }
        }
        ...
        if (*(*f).frame_hdr).subpel_filter_mode == DAV1D_FILTER_SWITCHABLE {
            if has_subpel_filter != 0 {
                ...
                filter_0[0usize] = dav1d_msac_decode_symbol_adapt4(
                    &mut (*ts).msac,
                    ((*ts).cdf.m.filter[0usize][ctx1_1 as usize]).as_mut_ptr(),
                    (DAV1D_N_SWITCHABLE_FILTERS as libc::c_int - 1i32) as size_t,
                );
                if (*(*f).seq_hdr).dual_filter != 0 {
                    ...
                    filter_0[1usize] = dav1d_msac_decode_symbol_adapt4(
                        &mut (*ts).msac,
                        ((*ts).cdf.m.filter[1usize][ctx2_3 as usize]).as_mut_ptr(),
                        (DAV1D_N_SWITCHABLE_FILTERS as libc::c_int - 1i32) as size_t,
                    );
                    if 0i32 != 0
                        && (*(*f).frame_hdr).frame_offset == 2i32
                    ...
                    filter_0[1usize] = filter_0[0usize];
                    if 0i32 != 0
                        && (*(*f).frame_hdr).frame_offset == 2i32
                        && (*t).by >= 0i32
                        && (*t).by < 4i32
                ...
                filter_0[1usize] = DAV1D_FILTER_8TAP_REGULAR;
                filter_0[0usize] = filter_0[1usize];
            }
        } else {
            filter_0[1usize] = (*(*f).frame_hdr).subpel_filter_mode;
            filter_0[0usize] = filter_0[1usize];
        }
        (*b).c2rust_unnamed.c2rust_unnamed_0.filter2d =
            dav1d_filter_2d[filter_0[1usize] as usize][filter_0[0usize] as usize];
        read_vartx_tree(t, b, bs, bx4, by4);
        if (*t).frame_thread.pass == 1i32 {
            ((*f).bd_fn.read_coef_blocks).expect("non-null function pointer")(t, bs, b);
        } else if ((*f).bd_fn.recon_b_inter).expect("non-null function pointer")(t, bs, b) != 0 {
        ...
        if (*(*f).frame_hdr).loopfilter.level_y[0usize] != 0
            || (*(*f).frame_hdr).loopfilter.level_y[1usize] != 0
        {
            let is_globalmv: libc::c_int = ((*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode
                as libc::c_int
                == (if is_comp != 0 {
                    GLOBALMV_GLOBALMV as libc::c_int
                } else {
        ...
        match bh4 {
            1 => {
                ...
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32 * (*b).skip_mode as libc::c_int) as uint8_t;
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = 0u8;
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.comp_type).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32 * (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_int)
                    as uint8_t;
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias8))
                    .u8_0 = (0x1u32).wrapping_mul(filter_0[0usize]) as uint8_t;
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias8))
                    .u8_0 = (0x1u32).wrapping_mul(filter_0[1usize]) as uint8_t;
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                    * (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_int)
                ...
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                    ...
                    .offset(by4 as isize) as *mut int8_t as *mut alias8))
                    .u8_0 = (0x1i32
                    * (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t as libc::c_int)
                    as uint8_t;
            }
            2 => {
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32 * (*b).skip_mode as libc::c_int) as uint16_t;
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = 0u16;
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias16))
                    .u16_0 = (0x101u32).wrapping_mul(filter_0[0usize]) as uint16_t;
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias16))
                    .u16_0 = (0x101u32).wrapping_mul(filter_0[1usize]) as uint16_t;
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101i32
                    * (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_int)
            ...
            4 => {
                ...
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul((*b).skip_mode as libc::c_uint);
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = 0u32;
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(filter_0[0usize]);
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(filter_0[1usize]);
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32)
                ...
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                    ...
                    .u32_0 = (0x1010101u32).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_uint,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut int8_t as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t as libc::c_uint,
                );
            }
            8 => {
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.skip_mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 =
                    (0x101010101010101u64).wrapping_mul((*b).skip_mode as libc::c_ulonglong);
                (*(&mut *((*t).l.intra).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = 0u64;
                (*(&mut *((*t).l.skip).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                ...
                (*(&mut *((*t).l.comp_type).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias64))
                    .u64_0 =
                    (0x101010101010101u64).wrapping_mul(filter_0[0usize] as libc::c_ulonglong);
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut uint8_t as *mut alias64))
                    .u64_0 =
                    (0x101010101010101u64).wrapping_mul(filter_0[1usize] as libc::c_ulonglong);
                (*(&mut *((*t).l.mode).as_mut_ptr().offset(by4 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut int8_t as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset(by4 as isize) as *mut int8_t as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t
                        as libc::c_ulonglong,
                );
            }
            16 => {
                let const_val_123: uint64_t =
                    (0x101010101010101u64).wrapping_mul(seg_pred as libc::c_ulonglong);
                (*(&mut *((*t).l.seg_pred).as_mut_ptr().offset((by4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_123;
                ...
                (*(&mut *((*t).l.skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_124;
                let const_val_125: uint64_t = 0u64;
                (*(&mut *((*t).l.intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_126;
                let const_val_127: uint64_t = 0u64;
                (*(&mut *((*t).l.pal_sz)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_127;
                let const_val_128: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_128;
                let const_val_129: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*t).l.tx_intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*t).l.tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_129;
                let const_val_130: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.comp_type)
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_132;
                let const_val_133: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_133;
                let const_val_134: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_134;
                let const_val_135: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t
                        as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
            ...
            32 => {
                ...
                (*(&mut *((*t).l.skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_137;
                let const_val_138: uint64_t = 0u64;
                (*(&mut *((*t).l.intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.skip)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_139;
                let const_val_140: uint64_t = 0u64;
                (*(&mut *((*t).l.pal_sz)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_140;
                let const_val_141: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(1isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_141;
                let const_val_142: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 1i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*t).l.tx_intra)
                    .as_mut_ptr()
                    .offset((by4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*t).l.tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_142;
                let const_val_143: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.comp_type)
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*t).l.filter).as_mut_ptr().offset(1isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_145;
                let const_val_146: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.mode).as_mut_ptr().offset((by4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*t).l.mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_146;
                let const_val_147: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(0isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_147;
                let const_val_148: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t
                        as libc::c_ulonglong,
                );
                (*(&mut *(*((*t).l.ref_0).as_mut_ptr().offset(1isize))
        ...
        match bw4 {
            ...
            16 => {
                ...
                (*(&mut *((*(*t).a).skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_150;
                let const_val_151: uint64_t = 0u64;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_151;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
                ...
                (*(&mut *((*(*t).a).skip)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_152;
                let const_val_153: uint64_t = 0u64;
                (*(&mut *((*(*t).a).pal_sz)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_153;
                let const_val_154: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_154;
                let const_val_155: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*(*t).a).tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_155;
                let const_val_156: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).comp_type)
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_158;
                let const_val_159: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).mode)
                    .as_mut_ptr()
                ...
                (*(&mut *((*(*t).a).mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_159;
                let const_val_160: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_ulonglong,
                );
                (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_160;
                let const_val_161: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t
                        as libc::c_ulonglong,
                );
                (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
            ...
            32 => {
                ...
                (*(&mut *((*(*t).a).skip_mode)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_163;
                let const_val_164: uint64_t = 0u64;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 0i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_164;
                (*(&mut *((*(*t).a).intra).as_mut_ptr().offset((bx4 + 8i32) as isize)
                ...
                (*(&mut *((*(*t).a).skip).as_mut_ptr().offset((bx4 + 24i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_165;
                let const_val_166: uint64_t = 0u64;
                (*(&mut *((*(*t).a).pal_sz)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *((*(*t).a).pal_sz)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_166;
                let const_val_167: uint64_t = 0u64;
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                ...
                (*(&mut *(*((*t).pal_sz_uv).as_mut_ptr().offset(0isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_167;
                let const_val_168: uint64_t = (0x101010101010101u64)
                    .wrapping_mul(*b_dim.offset((2i32 + 0i32) as isize) as libc::c_ulonglong);
                (*(&mut *((*(*t).a).tx_intra)
                    .as_mut_ptr()
                    .offset((bx4 + 0i32) as isize) as *mut int8_t
                ...
                (*(&mut *((*(*t).a).tx_intra)
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_168;
                let const_val_169: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).comp_type)
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*(*t).a).filter).as_mut_ptr().offset(1isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_171;
                let const_val_172: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).mode)
                    .as_mut_ptr()
                ...
                (*(&mut *((*(*t).a).mode).as_mut_ptr().offset((bx4 + 24i32) as isize)
                    as *mut uint8_t as *mut alias64))
                    .u64_0 = const_val_172;
                let const_val_173: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as libc::c_ulonglong,
                );
                (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                    .as_mut_ptr()
                ...
                (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(0isize))
                    ...
                    as *mut alias64))
                    .u64_0 = const_val_173;
                let const_val_174: uint64_t = (0x101010101010101u64).wrapping_mul(
                    (*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[1usize] as uint8_t
                        as libc::c_ulonglong,
                );
                (*(&mut *(*((*(*t).a).ref_0).as_mut_ptr().offset(1isize))
        ...
        if has_chroma != 0 {
            match cbh4 {
                ...
                16 => {
                    let const_val_175: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_175;
                ...
                32 => {
                    let const_val_176: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*t).l.uvmode).as_mut_ptr().offset((cby4 + 0i32) as isize)
                        as *mut uint8_t as *mut alias64))
                        .u64_0 = const_val_176;
            ...
            match cbw4 {
                ...
                16 => {
                    let const_val_177: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 0i32) as isize) as *mut uint8_t
                ...
                32 => {
                    let const_val_178: uint64_t = (0x101010101010101u64)
                        .wrapping_mul(DC_PRED as libc::c_int as libc::c_ulonglong);
                    (*(&mut *((*(*t).a).uvmode)
                        .as_mut_ptr()
                        .offset((cbx4 + 0i32) as isize) as *mut uint8_t
    ...
    if (*(*f).frame_hdr).segmentation.enabled != 0 && (*(*f).frame_hdr).segmentation.update_map != 0
    {
        ...
        match bw4 {
            1 => {
                ...
                while y_3 < bh4 {
                    (*(&mut *seg_ptr.offset(0isize) as *mut uint8_t as *mut alias8)).u8_0 =
                        (0x1i32 * (*b).seg_id as libc::c_int) as uint8_t;
                    seg_ptr = seg_ptr.offset((*f).b4_stride as isize);
                    y_3 += 1;
                }
            }
            2 => {
                let mut y_4: libc::c_int = 0i32;
                while y_4 < bh4 {
                    (*(&mut *seg_ptr.offset(0isize) as *mut uint8_t as *mut alias16)).u16_0 =
                        (0x101i32 * (*b).seg_id as libc::c_int) as uint16_t;
                    seg_ptr = seg_ptr.offset((*f).b4_stride as isize);
                    y_4 += 1;
                }
            }
            4 => {
                let mut y_5: libc::c_int = 0i32;
                while y_5 < bh4 {
                    (*(&mut *seg_ptr.offset(0isize) as *mut uint8_t as *mut alias32)).u32_0 =
                        (0x1010101u32).wrapping_mul((*b).seg_id as libc::c_uint);
                    seg_ptr = seg_ptr.offset((*f).b4_stride as isize);
                    y_5 += 1;
                }
            }
            8 => {
                let mut y_6: libc::c_int = 0i32;
                while y_6 < bh4 {
                    (*(&mut *seg_ptr.offset(0isize) as *mut uint8_t as *mut alias64)).u64_0 =
                        (0x101010101010101u64).wrapping_mul((*b).seg_id as libc::c_ulonglong);
                    seg_ptr = seg_ptr.offset((*f).b4_stride as isize);
                    y_6 += 1;
                }
            }
            16 => {
                let mut y_7: libc::c_int = 0i32;
                while y_7 < bh4 {
                    let const_val_179: uint64_t =
                        (0x101010101010101u64).wrapping_mul((*b).seg_id as libc::c_ulonglong);
                    (*(&mut *seg_ptr.offset((0i32 + 0i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_179;
                    (*(&mut *seg_ptr.offset((0i32 + 8i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_179;
                    seg_ptr = seg_ptr.offset((*f).b4_stride as isize);
                    y_7 += 1;
            ...
            32 => {
                let mut y_8: libc::c_int = 0i32;
                while y_8 < bh4 {
                    let const_val_180: uint64_t =
                        (0x101010101010101u64).wrapping_mul((*b).seg_id as libc::c_ulonglong);
                    (*(&mut *seg_ptr.offset((0i32 + 0i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_180;
                    (*(&mut *seg_ptr.offset((0i32 + 8i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_180;
                    (*(&mut *seg_ptr.offset((0i32 + 16i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_180;
                    (*(&mut *seg_ptr.offset((0i32 + 24i32) as isize) as *mut uint8_t
                        as *mut alias64))
                        .u64_0 = const_val_180;
                    seg_ptr = seg_ptr.offset((*f).b4_stride as isize);
                    y_8 += 1;
    ...
    if (*b).skip == 0 {
        let mut noskip_mask: *mut [uint16_t; 2] = &mut *((*(*t).lf_mask).noskip_mask)
            .as_mut_ptr()
            .offset((by4 >> 1i32) as isize)
            as *mut [uint16_t; 2];
        let mask_0: libc::c_uint = !(0u32) >> 32i32 - bw4 << (bx4 & 15i32);
        let bx_idx: libc::c_int = (bx4 & 16i32) >> 4i32;
        let mut y_9: libc::c_int = 0i32;
        while y_9 < bh4 {
            (*noskip_mask)[bx_idx as usize] =
                ((*noskip_mask)[bx_idx as usize] as libc::c_uint | mask_0) as uint16_t;
            if bw4 == 32i32 {
                (*noskip_mask)[1usize] =
                    ((*noskip_mask)[1usize] as libc::c_uint | mask_0) as uint16_t;
            }
            y_9 += 2i32;
            noskip_mask = noskip_mask.offset(1);
        }
    }
    if (*t).frame_thread.pass == 1i32 && (*b).intra == 0 && (*(*f).frame_hdr).frame_type & 1u32 != 0
    {
        let sby_0: libc::c_int = (*t).by - (*ts).tiling.row_start >> (*f).sb_shift;
        let lowest_px: *mut [libc::c_int; 2] =
            (*((*ts).lowest_pixel).offset(sby_0 as isize)).as_mut_ptr();
        if (*b).c2rust_unnamed.c2rust_unnamed_0.comp_type as libc::c_int
            == COMP_INTER_NONE as libc::c_int
        {
            if imin(bw4, bh4) > 1i32
                && ((*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_int
                    == GLOBALMV as libc::c_int
                    && (*f).gmv_warp_allowed
                        [(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[0usize] as usize]
                        ...
                        && (*t).warpmv.type_0 > DAV1D_WM_TYPE_TRANSLATION)
            {
                ...
                {
                    obmc_lowest_px(t, lowest_px, 0i32, b_dim, bx4, by4, w4, h4);
                }
            }
            if has_chroma != 0 {
                let mut is_sub8x8: libc::c_int = (bw4 == ss_hor || bh4 == ss_ver) as libc::c_int;
                ...
                if is_sub8x8 != 0 {
                    ...
                    r_1 = &mut *((*t).rt.r)
                        ...
                        as *mut *mut refmvs_block;
                    if bw4 == 1i32 {
                        is_sub8x8 &= ((*(*r_1.offset(0isize)).offset(((*t).bx - 1i32) as isize))
                            .ref_0
                            .ref_0[0usize] as libc::c_int
                            > 0i32) as libc::c_int;
                    }
                    if bh4 == ss_ver {
                        is_sub8x8 &= ((*(*r_1.offset(-1isize)).offset((*t).bx as isize))
                            .ref_0
                            .ref_0[0usize] as libc::c_int
                            > 0i32) as libc::c_int;
                    }
                    if bw4 == 1i32 && bh4 == ss_ver {
                        is_sub8x8 &= ((*(*r_1.offset(-1isize)).offset(((*t).bx - 1i32) as isize))
                            .ref_0
                            .ref_0[0usize] as libc::c_int
                            > 0i32) as libc::c_int;
                    }
                ...
                if is_sub8x8 != 0 {
                    ...
                    if bw4 == 1i32 && bh4 == ss_ver {
                        let rr_1: *const refmvs_block = &mut *(*r_1.offset(-1isize))
                            .offset(((*t).bx - 1i32) as isize)
                            as *mut refmvs_block;
                        mc_lowest_px(
                            &mut *(*lowest_px.offset(
                                (*((*rr_1).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int
                                    - 1i32) as isize,
                            ))
                            .as_mut_ptr()
                            .offset(1isize),
                            (*t).by - 1i32,
                            bh4,
                            (*rr_1).mv.mv[0usize].c2rust_unnamed.y as libc::c_int,
                            ss_ver,
                            &*(*((*f).svc).as_ptr().offset(
                                (*((*rr_1).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int
                                    - 1i32) as isize,
                    ...
                    if bw4 == 1i32 {
                        let rr_2: *const refmvs_block = &mut *(*r_1.offset(0isize))
                            .offset(((*t).bx - 1i32) as isize)
                            as *mut refmvs_block;
                        mc_lowest_px(
                            &mut *(*lowest_px.offset(
                                (*((*rr_2).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int
                                    - 1i32) as isize,
                            ))
                            .as_mut_ptr()
                            .offset(1isize),
                            (*t).by,
                            bh4,
                            (*rr_2).mv.mv[0usize].c2rust_unnamed.y as libc::c_int,
                            ss_ver,
                            &*(*((*f).svc).as_ptr().offset(
                                (*((*rr_2).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int
                                    - 1i32) as isize,
                    ...
                    if bh4 == ss_ver {
                        let rr_3: *const refmvs_block = &mut *(*r_1.offset(-1isize))
                            .offset((*t).bx as isize)
                            as *mut refmvs_block;
                        mc_lowest_px(
                            &mut *(*lowest_px.offset(
                                (*((*rr_3).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int
                                    - 1i32) as isize,
                            ))
                            .as_mut_ptr()
                            .offset(1isize),
                            (*t).by - 1i32,
                            bh4,
                            (*rr_3).mv.mv[0usize].c2rust_unnamed.y as libc::c_int,
                            ss_ver,
                            &*(*((*f).svc).as_ptr().offset(
                                (*((*rr_3).ref_0.ref_0).as_ptr().offset(0isize) as libc::c_int
                                    - 1i32) as isize,
                            ...
                            && (*t).warpmv.type_0 > DAV1D_WM_TYPE_TRANSLATION)
                {
                    ...
                    if (*b).c2rust_unnamed.c2rust_unnamed_0.motion_mode as libc::c_int
                        == MM_OBMC as libc::c_int
                    {
                        obmc_lowest_px(t, lowest_px, 1i32, b_dim, bx4, by4, w4, h4);
                    }
                }
            }
        } else {
            ...
            if has_chroma != 0 {
                ...
                while i_1 < 2i32 {
                    if (*b).c2rust_unnamed.c2rust_unnamed_0.inter_mode as libc::c_int
                        ...
                        && imin(cbw4, cbh4) > 1i32
                        && (*f).gmv_warp_allowed
                            [(*b).c2rust_unnamed.c2rust_unnamed_0.ref_0[i_1 as usize] as usize]
                            as libc::c_int
                            != 0
                    {
                        affine_lowest_px_chroma(
...
unsafe extern "C" fn decode_sb(
    ...
    if have_h_split == 0 && have_v_split == 0 {
        ...
        return decode_sb(
            ...
            (*(node as *const EdgeBranch)).split[0usize],
        );
    }
    ...
    if have_h_split != 0 && have_v_split != 0 {
        if (*t).frame_thread.pass == 2i32 {
            let b: *const Av1Block = &mut *((*f).frame_thread.b).offset(
                ((*t).by as libc::c_long * (*f).b4_stride + (*t).bx as libc::c_long) as isize,
            ) as *mut Av1Block;
            bp = (if (*b).bl as libc::c_uint == bl {
                (*b).bp as libc::c_int
            } else {
        ...
        match bp {
            0 => {
                if decode_b(
                    t,
                    bl,
                    *b_0.offset(0isize) as BlockSize,
                    PARTITION_NONE,
                    (*node).o,
                ) != 0
                {
            ...
            3 => {
                if bl == BL_8X8 {
                    ...
                    if decode_b(t, bl, BS_4x4, PARTITION_SPLIT, (*tip).split[0usize]) != 0 {
                        return -(1i32);
                    }
                    let tl_filter: Filter2d = (*t).tl_4x4_filter;
                    (*t).bx += 1;
                    if decode_b(t, bl, BS_4x4, PARTITION_SPLIT, (*tip).split[1usize]) != 0 {
                        return -(1i32);
                    }
                    (*t).bx -= 1;
                    (*t).by += 1;
                    if decode_b(t, bl, BS_4x4, PARTITION_SPLIT, (*tip).split[2usize]) != 0 {
                        return -(1i32);
                    }
                    (*t).bx += 1;
                    (*t).tl_4x4_filter = tl_filter;
                    if decode_b(t, bl, BS_4x4, PARTITION_SPLIT, (*tip).split[3usize]) != 0 {
                        return -(1i32);
                    }
                    (*t).bx -= 1;
                    (*t).by -= 1;
                    if (*t).frame_thread.pass != 0 {
                        ...
                        (*ts).frame_thread[p as usize].cf =
                            (((*ts).frame_thread[p as usize].cf as uintptr_t).wrapping_add(63u64)
                                & !(63i32) as libc::c_ulong)
                                as *mut libc::c_void;
                    }
                } else {
                    let branch: *const EdgeBranch = node as *const EdgeBranch;
                    if decode_sb(t, (bl).wrapping_add(1u32), (*branch).split[0usize]) != 0 {
                        return 1i32;
                    }
                    (*t).bx += hsz;
                    if decode_sb(t, (bl).wrapping_add(1u32), (*branch).split[1usize]) != 0 {
                        return 1i32;
                    }
                    (*t).bx -= hsz;
                    (*t).by += hsz;
                    if decode_sb(t, (bl).wrapping_add(1u32), (*branch).split[2usize]) != 0 {
                        return 1i32;
                    }
                    (*t).bx += hsz;
                    if decode_sb(t, (bl).wrapping_add(1u32), (*branch).split[3usize]) != 0 {
                        return 1i32;
                    }
                    (*t).bx -= hsz;
                    (*t).by -= hsz;
            ...
            4 => {
                ...
                if decode_b(
                    t,
                    bl,
                    *b_0.offset(1isize) as BlockSize,
                    PARTITION_T_TOP_SPLIT,
                    (*branch_0).tts[2usize],
                ) != 0
                {
        ...
        if (*t).frame_thread.pass == 2i32 {
            let b_1: *const Av1Block = &mut *((*f).frame_thread.b).offset(
                ((*t).by as libc::c_long * (*f).b4_stride + (*t).bx as libc::c_long) as isize,
            ) as *mut Av1Block;
            is_split = ((*b_1).bl as libc::c_uint != bl) as libc::c_uint;
        } else {
        ...
        if is_split != 0 {
            ...
            bp = PARTITION_SPLIT;
            if decode_sb(t, (bl).wrapping_add(1u32), (*branch_6).split[0usize]) != 0 {
                return 1i32;
            }
            (*t).bx += hsz;
            if decode_sb(t, (bl).wrapping_add(1u32), (*branch_6).split[1usize]) != 0 {
                return 1i32;
            }
            (*t).bx -= hsz;
        } else {
            ...
            if decode_b(
                t,
                bl,
                dav1d_block_sizes[bl as usize][PARTITION_H as usize][0usize] as BlockSize,
                PARTITION_H,
                (*node).h[0usize],
            ) != 0
            {
        ...
        if (*t).frame_thread.pass == 2i32 {
            let b_2: *const Av1Block = &mut *((*f).frame_thread.b).offset(
                ((*t).by as libc::c_long * (*f).b4_stride + (*t).bx as libc::c_long) as isize,
            ) as *mut Av1Block;
            is_split_0 = ((*b_2).bl as libc::c_uint != bl) as libc::c_uint;
        } else {
            is_split_0 =
                dav1d_msac_decode_bool(&mut (*ts).msac, gather_left_partition_prob(pc, bl));
        ...
        if is_split_0 != 0 {
            ...
            bp = PARTITION_SPLIT;
            if decode_sb(t, (bl).wrapping_add(1u32), (*branch_7).split[0usize]) != 0 {
                return 1i32;
            }
            (*t).by += hsz;
            if decode_sb(t, (bl).wrapping_add(1u32), (*branch_7).split[2usize]) != 0 {
                return 1i32;
            }
            (*t).by -= hsz;
        } else {
            ...
            if decode_b(
                t,
                bl,
                dav1d_block_sizes[bl as usize][PARTITION_V as usize][0usize] as BlockSize,
                PARTITION_V,
                (*node).v[0usize],
            ) != 0
            {
    ...
    if (*t).frame_thread.pass != 2i32 && (bp != PARTITION_SPLIT || bl == BL_8X8) {
        match hsz {
            1 => {
                (*(&mut *((*(*t).a).partition).as_mut_ptr().offset(bx8 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                    * dav1d_al_part_ctx[0usize][bl as usize][bp as usize] as libc::c_int)
                    as uint8_t;
                (*(&mut *((*t).l.partition).as_mut_ptr().offset(by8 as isize) as *mut uint8_t
                    as *mut alias8))
                    .u8_0 = (0x1i32
                    * dav1d_al_part_ctx[1usize][bl as usize][bp as usize] as libc::c_int)
                    as uint8_t;
            }
            2 => {
                (*(&mut *((*(*t).a).partition).as_mut_ptr().offset(bx8 as isize) as *mut uint8_t
            ...
            4 => {
                (*(&mut *((*(*t).a).partition).as_mut_ptr().offset(bx8 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(
                    dav1d_al_part_ctx[0usize][bl as usize][bp as usize] as libc::c_uint,
                );
                (*(&mut *((*t).l.partition).as_mut_ptr().offset(by8 as isize) as *mut uint8_t
                    as *mut alias32))
                    .u32_0 = (0x1010101u32).wrapping_mul(
                    dav1d_al_part_ctx[1usize][bl as usize][bp as usize] as libc::c_uint,
                );
            }
            8 => {
                (*(&mut *((*(*t).a).partition).as_mut_ptr().offset(bx8 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    dav1d_al_part_ctx[0usize][bl as usize][bp as usize] as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.partition).as_mut_ptr().offset(by8 as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = (0x101010101010101u64).wrapping_mul(
                    dav1d_al_part_ctx[1usize][bl as usize][bp as usize] as libc::c_ulonglong,
                );
            }
            16 => {
                let const_val: uint64_t = (0x101010101010101u64).wrapping_mul(
                    dav1d_al_part_ctx[0usize][bl as usize][bp as usize] as libc::c_ulonglong,
                );
                (*(&mut *((*(*t).a).partition)
                    .as_mut_ptr()
                    .offset((bx8 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val;
                (*(&mut *((*(*t).a).partition)
                    .as_mut_ptr()
                    .offset((bx8 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val;
                let const_val_0: uint64_t = (0x101010101010101u64).wrapping_mul(
                    dav1d_al_part_ctx[1usize][bl as usize][bp as usize] as libc::c_ulonglong,
                );
                (*(&mut *((*t).l.partition)
                    .as_mut_ptr()
                    .offset((by8 + 0i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_0;
                (*(&mut *((*t).l.partition)
                    .as_mut_ptr()
                    .offset((by8 + 8i32) as isize) as *mut uint8_t
                    as *mut alias64))
                    .u64_0 = const_val_0;
            }
            _ => {}
...
static mut ss_size_mul: [[uint8_t; 2]; 4] = [[4u8, 4u8], [6u8, 5u8], [8u8, 6u8], [12u8, 8u8]];
unsafe extern "C" fn setup_tile(
    ...
    let col_sb_start: libc::c_int =
        (*(*f).frame_hdr).tiling.col_start_sb[tile_col as usize] as libc::c_int;
    let col_sb128_start: libc::c_int = col_sb_start >> ((*(*f).seq_hdr).sb128 == 0) as libc::c_int;
    let col_sb_end: libc::c_int =
        (*(*f).frame_hdr).tiling.col_start_sb[(tile_col + 1i32) as usize] as libc::c_int;
    let row_sb_start: libc::c_int =
        (*(*f).frame_hdr).tiling.row_start_sb[tile_row as usize] as libc::c_int;
    let row_sb_end: libc::c_int =
        (*(*f).frame_hdr).tiling.row_start_sb[(tile_row + 1i32) as usize] as libc::c_int;
    ...
    while p < 2i32 {
        (*ts).frame_thread[p as usize].pal_idx = if !((*f).frame_thread.pal_idx).is_null() {
            &mut *((*f).frame_thread.pal_idx).offset(
                (tile_start_off as size_t)
                    .wrapping_mul(*size_mul.offset(1isize) as libc::c_ulong)
                    .wrapping_div(4u64) as isize,
            ) as *mut uint8_t
        } else {
            0 as *mut uint8_t
        };
        (*ts).frame_thread[p as usize].cf = (if !((*f).frame_thread.cf).is_null() {
            ((*f).frame_thread.cf as *mut uint8_t).offset(
                ((tile_start_off as size_t).wrapping_mul(*size_mul.offset(0isize) as libc::c_ulong)
    ...
    if (*(*f).frame_hdr).width[0usize] != (*(*f).frame_hdr).width[1usize] {
        sb_idx = ((*ts).tiling.row_start >> 5i32) * (*f).sr_sb128w;
        unit_idx = ((*ts).tiling.row_start & 16i32) >> 3i32;
    } else {
        sb_idx = ((*ts).tiling.row_start >> 5i32) * (*f).sb128w + col_sb128_start;
        unit_idx =
            (((*ts).tiling.row_start & 16i32) >> 3i32) + (((*ts).tiling.col_start & 16i32) >> 4i32);
    }
    let mut current_block_31: u64;
    let mut p_0: libc::c_int = 0i32;
    while p_0 < 3i32 {
        if !(((*f).lf.restore_planes >> p_0) as libc::c_uint & 1u32 == 0) {
            if (*(*f).frame_hdr).width[0usize] != (*(*f).frame_hdr).width[1usize] {
                let ss_hor: libc::c_int =
                    (p_0 != 0 && (*f).cur.p.layout != DAV1D_PIXEL_LAYOUT_I444) as libc::c_int;
                ...
                let rnd: libc::c_int = ((8i32) << unit_size_log2) - 1i32;
                let shift: libc::c_int = unit_size_log2 + 3i32;
                let x: libc::c_int = (4i32 * (*ts).tiling.col_start * d >> ss_hor) + rnd >> shift;
                let px_x: libc::c_int = x << unit_size_log2 + ss_hor;
                let u_idx: libc::c_int = unit_idx + ((px_x & 64i32) >> 6i32);
                let sb128x: libc::c_int = px_x >> 7i32;
            ...
            match current_block_31 {
                2370887241019905314 => {}
                _ => {
                    (*(*ts).lr_ref[p_0 as usize]).filter_v[0usize] = 3i8;
                    (*(*ts).lr_ref[p_0 as usize]).filter_v[1usize] = -7i8;
                    (*(*ts).lr_ref[p_0 as usize]).filter_v[2usize] = 15i8;
                    (*(*ts).lr_ref[p_0 as usize]).filter_h[0usize] = 3i8;
                    (*(*ts).lr_ref[p_0 as usize]).filter_h[1usize] = -7i8;
                    (*(*ts).lr_ref[p_0 as usize]).filter_h[2usize] = 15i8;
                    (*(*ts).lr_ref[p_0 as usize]).sgr_weights[0usize] = -32i8;
                    (*(*ts).lr_ref[p_0 as usize]).sgr_weights[1usize] = 31i8;
                }
            }
        }
        p_0 += 1;
...
unsafe extern "C" fn read_restoration_info(
    ...
    if (*lr).type_0 as libc::c_int == DAV1D_RESTORATION_WIENER as libc::c_int {
        (*lr).filter_v[0usize] = (if p != 0 {
            0i32
        } else {
            dav1d_msac_decode_subexp(
                &mut (*ts).msac,
                (*(*ts).lr_ref[p as usize]).filter_v[0usize] as libc::c_int + 5i32,
                16i32,
                1u32,
            ) - 5i32
        }) as int8_t;
        (*lr).filter_v[1usize] = (dav1d_msac_decode_subexp(
            &mut (*ts).msac,
            (*(*ts).lr_ref[p as usize]).filter_v[1usize] as libc::c_int + 23i32,
            32i32,
            2u32,
        ) - 23i32) as int8_t;
        (*lr).filter_v[2usize] = (dav1d_msac_decode_subexp(
            &mut (*ts).msac,
            (*(*ts).lr_ref[p as usize]).filter_v[2usize] as libc::c_int + 17i32,
            64i32,
            3u32,
        ) - 17i32) as int8_t;
        (*lr).filter_h[0usize] = (if p != 0 {
            0i32
        } else {
            dav1d_msac_decode_subexp(
                &mut (*ts).msac,
                (*(*ts).lr_ref[p as usize]).filter_h[0usize] as libc::c_int + 5i32,
                16i32,
                1u32,
            ) - 5i32
        }) as int8_t;
        (*lr).filter_h[1usize] = (dav1d_msac_decode_subexp(
            &mut (*ts).msac,
            (*(*ts).lr_ref[p as usize]).filter_h[1usize] as libc::c_int + 23i32,
            32i32,
            2u32,
        ) - 23i32) as int8_t;
        (*lr).filter_h[2usize] = (dav1d_msac_decode_subexp(
            &mut (*ts).msac,
            (*(*ts).lr_ref[p as usize]).filter_h[2usize] as libc::c_int + 17i32,
            64i32,
            3u32,
        ) - 17i32) as int8_t;
        memcpy(
            ...
            && (*t).bx < 12i32
        {
            printf(
                b"Post-lr_wiener[pl=%d,v[%d,%d,%d],h[%d,%d,%d]]: r=%d\n\0" as *const u8
                    as *const libc::c_char,
                p,
                (*lr).filter_v[0usize] as libc::c_int,
                (*lr).filter_v[1usize] as libc::c_int,
                (*lr).filter_v[2usize] as libc::c_int,
                (*lr).filter_h[0usize] as libc::c_int,
                (*lr).filter_h[1usize] as libc::c_int,
                (*lr).filter_h[2usize] as libc::c_int,
                (*ts).msac.rng,
            );
        }
    } else if (*lr).type_0 as libc::c_int == DAV1D_RESTORATION_SGRPROJ as libc::c_int {
        let idx: libc::c_uint = dav1d_msac_decode_bools(&mut (*ts).msac, 4u32);
        let sgr_params: *const uint16_t = (dav1d_sgr_params[idx as usize]).as_ptr();
        (*lr).sgr_idx = idx as uint8_t;
        (*lr).sgr_weights[0usize] = (if *sgr_params.offset(0isize) as libc::c_int != 0 {
            dav1d_msac_decode_subexp(
                &mut (*ts).msac,
                (*(*ts).lr_ref[p as usize]).sgr_weights[0usize] as libc::c_int + 96i32,
                128i32,
                4u32,
            ) - 96i32
        } else {
        ...
        (*lr).sgr_weights[1usize] = (if *sgr_params.offset(1isize) as libc::c_int != 0 {
            dav1d_msac_decode_subexp(
                &mut (*ts).msac,
                (*(*ts).lr_ref[p as usize]).sgr_weights[1usize] as libc::c_int + 32i32,
                128i32,
                4u32,
            ) - 32i32
        } else {
            ...
            && (*t).bx < 12i32
        {
            printf(
                ...
                (*lr).sgr_weights[0usize] as libc::c_int,
                (*lr).sgr_weights[1usize] as libc::c_int,
                (*ts).msac.rng,
            );
        }
    }
...
pub unsafe extern "C" fn dav1d_decode_tile_sbrow(t: *mut Dav1dTaskContext) -> libc::c_int {
    ...
    if (*(*f).frame_hdr).frame_type & 1u32 != 0 && (*c).n_fc > 1u32 {
        ...
        while n < 7i32 {
            let mut m: libc::c_int = 0i32;
            while m < 2i32 {
                (*lowest_px.offset(n as isize))[m as usize] = -(2147483647i32) - 1i32;
                m += 1;
            }
            n += 1;
        }
    ...
    reset_context(
        &mut (*t).l,
        ((*(*f).frame_hdr).frame_type & 1u32 == 0) as libc::c_int,
        (*t).frame_thread.pass,
    );
    if (*t).frame_thread.pass == 2i32 {
        let off_2pass: libc::c_int = if (*c).n_tc > 1u32 {
        ...
        while (*t).bx < (*ts).tiling.col_end {
            ...
            if (*t).bx & 16i32 != 0 || (*(*f).seq_hdr).sb128 != 0 {
                (*t).a = ((*t).a).offset(1);
            }
            (*t).bx += sb_step;
        }
    ...
    if (*ts).msac.cnt < -(15i32) {
        return 1i32;
    }
    if (*(*f).c).n_tc > 1u32 && (*(*f).frame_hdr).use_ref_frame_mvs != 0 {
        dav1d_refmvs_load_tmvs(
            &(*f).rf,
            (*ts).tiling.row,
            (*ts).tiling.col_start >> 1i32,
            (*ts).tiling.col_end >> 1i32,
            (*t).by >> 1i32,
            (*t).by + sb_step >> 1i32,
        );
    }
    memset(
        ((*t).pal_sz_uv[1usize]).as_mut_ptr() as *mut libc::c_void,
        0i32,
        ::core::mem::size_of::<[uint8_t; 32]>() as libc::c_ulong,
    );
    let sb128y: libc::c_int = (*t).by >> 5i32;
    (*t).bx = (*ts).tiling.col_start;
    (*t).a = ((*f).a)
        .offset(col_sb128_start as isize)
        .offset((tile_row * (*f).sb128w) as isize);
    ...
    while (*t).bx < (*ts).tiling.col_end {
        ...
        if root_bl == BL_128X128 {
            ...
            *((*t).cur_sb_cdef_idx_ptr).offset(0isize) = -1i8;
            *((*t).cur_sb_cdef_idx_ptr).offset(1isize) = -1i8;
            *((*t).cur_sb_cdef_idx_ptr).offset(2isize) = -1i8;
            *((*t).cur_sb_cdef_idx_ptr).offset(3isize) = -1i8;
        } else {
            (*t).cur_sb_cdef_idx_ptr = &mut *((*(*t).lf_mask).cdef_idx)
                .as_mut_ptr()
                .offset(((((*t).bx & 16i32) >> 4i32) + (((*t).by & 16i32) >> 3i32)) as isize)
                as *mut int8_t;
            *((*t).cur_sb_cdef_idx_ptr).offset(0isize) = -1i8;
        }
        let mut p: libc::c_int = 0i32;
        while p < 3i32 {
            if !(((*f).lf.restore_planes >> p) as libc::c_uint & 1u32 == 0) {
                let ss_ver: libc::c_int =
                    (p != 0 && (*f).cur.p.layout == DAV1D_PIXEL_LAYOUT_I420) as libc::c_int;
                let ss_hor: libc::c_int =
                    (p != 0 && (*f).cur.p.layout != DAV1D_PIXEL_LAYOUT_I444) as libc::c_int;
                let unit_size_log2: libc::c_int =
                    (*(*f).frame_hdr).restoration.unit_size[(p != 0) as libc::c_int as usize];
                let y: libc::c_int = (*t).by * 4i32 >> ss_ver;
                let h: libc::c_int = (*f).cur.p.h + ss_ver >> ss_ver;
                let unit_size: libc::c_int = (1i32) << unit_size_log2;
                let mask: libc::c_uint = (unit_size - 1i32) as libc::c_uint;
                if !(y as libc::c_uint & mask != 0) {
                    let half_unit: libc::c_int = unit_size >> 1i32;
                    if !(y != 0 && y + half_unit > h) {
                        ...
                        if (*(*f).frame_hdr).width[0usize] != (*(*f).frame_hdr).width[1usize] {
                            ...
                            let n_units: libc::c_int = imax(1i32, w + half_unit >> unit_size_log2);
                            let d: libc::c_int =
                                (*(*f).frame_hdr).super_res.width_scale_denominator;
                            let rnd: libc::c_int = unit_size * 8i32 - 1i32;
                            let shift: libc::c_int = unit_size_log2 + 3i32;
                            let x0: libc::c_int = (4i32 * (*t).bx * d >> ss_hor) + rnd >> shift;
                            let x1: libc::c_int =
                                (4i32 * ((*t).bx + sb_step) * d >> ss_hor) + rnd >> shift;
                            let mut x: libc::c_int = x0;
                            while x < imin(x1, n_units) {
                                let px_x: libc::c_int = x << unit_size_log2 + ss_hor;
                                let sb_idx: libc::c_int =
                                    ((*t).by >> 5i32) * (*f).sr_sb128w + (px_x >> 7i32);
                                let unit_idx: libc::c_int =
                                    (((*t).by & 16i32) >> 3i32) + ((px_x & 64i32) >> 6i32);
                            ...
                            let x_0: libc::c_int = 4i32 * (*t).bx >> ss_hor;
                            if !(x_0 as libc::c_uint & mask != 0) {
                                let w_0: libc::c_int = (*f).cur.p.w + ss_hor >> ss_hor;
                                if !(x_0 != 0 && x_0 + half_unit > w_0) {
                                    let sb_idx_0: libc::c_int =
                                        ((*t).by >> 5i32) * (*f).sr_sb128w + ((*t).bx >> 5i32);
                                    let unit_idx_0: libc::c_int =
                                        (((*t).by & 16i32) >> 3i32) + (((*t).bx & 16i32) >> 4i32);
    ...
    let mut align_h: libc::c_int = (*f).bh + 31i32 & !(31i32);
    memcpy(
        &mut *(*((*f).lf.tx_lpf_right_edge).as_ptr().offset(0isize))
            .offset((align_h * tile_col + (*t).by) as isize) as *mut uint8_t
            as *mut libc::c_void,
        &mut *((*t).l.tx_lpf_y)
            .as_mut_ptr()
            .offset(((*t).by & 16i32) as isize) as *mut uint8_t as *const libc::c_void,
        sb_step as libc::c_ulong,
    );
    let ss_ver_0: libc::c_int = ((*f).cur.p.layout == DAV1D_PIXEL_LAYOUT_I420) as libc::c_int;
    align_h >>= ss_ver_0;
    memcpy(
        &mut *(*((*f).lf.tx_lpf_right_edge).as_ptr().offset(1isize))
            .offset((align_h * tile_col + ((*t).by >> ss_ver_0)) as isize) as *mut uint8_t
            as *mut libc::c_void,
        &mut *((*t).l.tx_lpf_uv)
            .as_mut_ptr()
            .offset((((*t).by & 16i32) >> ss_ver_0) as isize) as *mut uint8_t
...
pub unsafe extern "C" fn dav1d_decode_frame_init(f: *mut Dav1dFrameContext) -> libc::c_int {
    ...
    let c: *const Dav1dContext = (*f).c;
    let mut retval: libc::c_int = -(12i32);
    if (*f).sbh > (*f).lf.start_of_tile_row_sz {
        ...
        if ((*f).lf.start_of_tile_row).is_null() {
            (*f).lf.start_of_tile_row_sz = 0i32;
    ...
    match current_block {
        6873731126896040597 => {
            sby = 0i32;
            let mut tile_row: libc::c_int = 0i32;
            while tile_row < (*(*f).frame_hdr).tiling.rows {
                let fresh33 = sby;
                sby = sby + 1;
                *((*f).lf.start_of_tile_row).offset(fresh33 as isize) = tile_row as uint8_t;
                while sby
                    < (*(*f).frame_hdr).tiling.row_start_sb[(tile_row + 1i32) as usize]
                        as libc::c_int
                {
                    let fresh34 = sby;
                    sby = sby + 1;
                    *((*f).lf.start_of_tile_row).offset(fresh34 as isize) = 0u8;
                }
                tile_row += 1;
            }
            ...
            match current_block {
                ...
                _ => {
                    a_sz = (*f).sb128w
                        ...
                        * (1i32 + ((*c).n_fc > 1u32 && (*c).n_tc > 1u32) as libc::c_int);
                    if a_sz != (*f).a_sz {
                    ...
                    match current_block {
                        ...
                        _ => {
                            ...
                            if (*c).n_fc > 1u32 {
                                ...
                                let mut tile_row_0: libc::c_int = 0i32;
                                while tile_row_0 < (*(*f).frame_hdr).tiling.rows {
                                    let mut row_off: libc::c_int =
                                    ...
                                    let mut b_diff: libc::c_int = ((*(*f).frame_hdr)
                                        .tiling
                                        .row_start_sb
                                        [(tile_row_0 + 1i32) as usize]
                                        as libc::c_int
                                        - (*(*f).frame_hdr).tiling.row_start_sb[tile_row_0 as usize]
                                            as libc::c_int)
                                        * (*f).sb_step
                                        * 4i32;
                                    let mut tile_col: libc::c_int = 0i32;
                                ...
                                let lowest_pixel_mem_sz: libc::c_int =
                                ...
                                if lowest_pixel_mem_sz != (*f).tile_thread.lowest_pixel_mem_sz {
                                    ...
                                    if ((*f).tile_thread.lowest_pixel_mem).is_null() {
                                        (*f).tile_thread.lowest_pixel_mem_sz = 0i32;
                                        current_block = 13495985911605184990;
                                    } else {
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                        let mut lowest_pixel_ptr: *mut [[libc::c_int; 2]; 7] =
                                            (*f).tile_thread.lowest_pixel_mem;
                                        let mut tile_row_1: libc::c_int = 0i32;
                                        let mut tile_row_base: libc::c_int = 0i32;
                                        while tile_row_1 < (*(*f).frame_hdr).tiling.rows {
                                            let tile_row_sb_h: libc::c_int =
                                                (*(*f).frame_hdr).tiling.row_start_sb
                                                    [(tile_row_1 + 1i32) as usize]
                                                    as libc::c_int
                                                    - (*(*f).frame_hdr).tiling.row_start_sb
                                                        [tile_row_1 as usize]
                                                        as libc::c_int;
                                            let mut tile_col_0: libc::c_int = 0i32;
                                        ...
                                        let cf_sz: libc::c_int = (num_sb128
                                            * *size_mul.offset(0isize) as libc::c_int)
                                            << hbd;
                                            ...
                                            _ => {
                                                if (*(*f).frame_hdr).allow_screen_content_tools != 0
                                                {
                                                    ...
                                                    if !((*f).frame_thread.pal).is_null() {
                                                        ...
                                                        (*f).frame_thread.pal_idx_sz = 0i32;
                            ...
                            match current_block {
                                13495985911605184990 => {}
                                _ => {
                                    y_stride = (*f).cur.stride[0usize];
                                    uv_stride = (*f).cur.stride[1usize];
                                    has_resize = ((*(*f).frame_hdr).width[0usize]
                                        != (*(*f).frame_hdr).width[1usize])
                                        as libc::c_int;
                                    need_cdef_lpf_copy =
                                        ((*c).n_tc > 1u32 && has_resize != 0) as libc::c_int;
                                    if y_stride * (*f).sbh as libc::c_long * 4i64
                                        != (*f).lf.cdef_buf_plane_sz[0usize] as libc::c_long
                                        || uv_stride * (*f).sbh as libc::c_long * 8i64
                                            != (*f).lf.cdef_buf_plane_sz[1usize] as libc::c_long
                                        ...
                                        || (*f).sbh != (*f).lf.cdef_buf_sbh
                                    {
                                        ...
                                        let mut alloc_sz: size_t = 64u64;
                                        alloc_sz = (alloc_sz).wrapping_add(
                                            (llabs(y_stride) as size_t)
                                                .wrapping_mul(4u64)
                                                .wrapping_mul((*f).sbh as libc::c_ulong)
                                                << need_cdef_lpf_copy,
                                        );
                                        alloc_sz = (alloc_sz).wrapping_add(
                                            (llabs(uv_stride) as size_t)
                                                .wrapping_mul(8u64)
                                                .wrapping_mul((*f).sbh as libc::c_ulong)
                                                << need_cdef_lpf_copy,
                                        );
                                        (*f).lf.cdef_line_buf =
                                            dav1d_alloc_aligned(alloc_sz, 32u64) as *mut uint8_t;
                                        let mut ptr: *mut uint8_t = (*f).lf.cdef_line_buf;
                                        if ptr.is_null() {
                                            (*f).lf.cdef_buf_plane_sz[1usize] = 0i32;
                                            (*f).lf.cdef_buf_plane_sz[0usize] =
                                                (*f).lf.cdef_buf_plane_sz[1usize];
                                            current_block = 13495985911605184990;
                                        } else {
                                            ptr = ptr.offset(32isize);
                                            if y_stride < 0i64 {
                                                (*f).lf.cdef_line[0usize][0usize] = ptr.offset(
                                                    -((y_stride
                                                        * ((*f).sbh * 4i32 - 1i32) as libc::c_long)
                                                        as isize),
                                                )
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[1usize][0usize] = ptr.offset(
                                                    -((y_stride
                                                        * ((*f).sbh * 4i32 - 3i32) as libc::c_long)
                                                        as isize),
                                                )
                                                    as *mut libc::c_void;
                                            } else {
                                                (*f).lf.cdef_line[0usize][0usize] = ptr
                                                    .offset((y_stride * 0i64) as isize)
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[1usize][0usize] = ptr
                                                    .offset((y_stride * 2i64) as isize)
                                                    as *mut libc::c_void;
                                            }
                                            ptr = ptr.offset(
                                                (llabs(y_stride)
                                            ...
                                            if uv_stride < 0i64 {
                                                (*f).lf.cdef_line[0usize][1usize] = ptr.offset(
                                                    -((uv_stride
                                                        * ((*f).sbh * 8i32 - 1i32) as libc::c_long)
                                                        as isize),
                                                )
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[0usize][2usize] = ptr.offset(
                                                    -((uv_stride
                                                        * ((*f).sbh * 8i32 - 3i32) as libc::c_long)
                                                        as isize),
                                                )
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[1usize][1usize] = ptr.offset(
                                                    -((uv_stride
                                                        * ((*f).sbh * 8i32 - 5i32) as libc::c_long)
                                                        as isize),
                                                )
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[1usize][2usize] = ptr.offset(
                                                    -((uv_stride
                                                        * ((*f).sbh * 8i32 - 7i32) as libc::c_long)
                                                        as isize),
                                                )
                                                    as *mut libc::c_void;
                                            } else {
                                                (*f).lf.cdef_line[0usize][1usize] = ptr
                                                    .offset((uv_stride * 0i64) as isize)
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[0usize][2usize] = ptr
                                                    .offset((uv_stride * 2i64) as isize)
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[1usize][1usize] = ptr
                                                    .offset((uv_stride * 4i64) as isize)
                                                    as *mut libc::c_void;
                                                (*f).lf.cdef_line[1usize][2usize] = ptr
                                                    .offset((uv_stride * 6i64) as isize)
                                                    as *mut libc::c_void;
                                            }
                                            if need_cdef_lpf_copy != 0 {
                                                ...
                                                if y_stride < 0i64 {
                                                    (*f).lf.cdef_lpf_line[0usize] = ptr.offset(
                                                        -((y_stride
                                                            * ((*f).sbh * 4i32 - 1i32)
                                                                as libc::c_long)
                                                            as isize),
                                                ...
                                                if uv_stride < 0i64 {
                                                    (*f).lf.cdef_lpf_line[1usize] = ptr.offset(
                                                        -((uv_stride
                                                            * ((*f).sbh * 4i32 - 1i32)
                                                                as libc::c_long)
                                                            as isize),
                                                        ...
                                                        as *mut libc::c_void;
                                                    (*f).lf.cdef_lpf_line[2usize] = ptr.offset(
                                                        -((uv_stride
                                                            * ((*f).sbh * 8i32 - 1i32)
                                                                as libc::c_long)
                                                            as isize),
                                                    ...
                                                    (*f).lf.cdef_lpf_line[1usize] =
                                                        ptr as *mut libc::c_void;
                                                    (*f).lf.cdef_lpf_line[2usize] = ptr.offset(
                                                        (uv_stride
                                                            * (*f).sbh as libc::c_long
                                                            * 4i64)
                                                            as isize,
                                                    )
                                                        as *mut libc::c_void;
                                            ...
                                            (*f).lf.cdef_buf_plane_sz[0usize] =
                                                y_stride as libc::c_int * (*f).sbh * 4i32;
                                            (*f).lf.cdef_buf_plane_sz[1usize] =
                                                uv_stride as libc::c_int * (*f).sbh * 8i32;
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            ...
                                            num_lines = if (*c).n_tc > 1u32 {
                                                ((*f).sbh * 4i32) << sb128
                                            } else {
                                                12i32
                                            };
                                            y_stride = (*f).sr_cur.p.stride[0usize];
                                            uv_stride = (*f).sr_cur.p.stride[1usize];
                                            if y_stride * num_lines as libc::c_long
                                                != (*f).lf.lr_buf_plane_sz[0usize] as libc::c_long
                                                || uv_stride * num_lines as libc::c_long * 2i64
                                                    != (*f).lf.lr_buf_plane_sz[1usize]
                                                        as libc::c_long
                                            {
                                                dav1d_free_aligned(
                                                    (*f).lf.lr_line_buf as *mut libc::c_void,
                                                );
                                                let mut alloc_sz_0: size_t = 128u64;
                                                ...
                                                (*f).lf.lr_line_buf =
                                                    dav1d_alloc_aligned(alloc_sz_0, 64u64)
                                                        as *mut uint8_t;
                                                let mut ptr_0: *mut uint8_t = (*f).lf.lr_line_buf;
                                                if ptr_0.is_null() {
                                                    (*f).lf.lr_buf_plane_sz[1usize] = 0i32;
                                                    (*f).lf.lr_buf_plane_sz[0usize] =
                                                        (*f).lf.lr_buf_plane_sz[1usize];
                                                    current_block = 13495985911605184990;
                                                } else {
                                                    ptr_0 = ptr_0.offset(64isize);
                                                    if y_stride < 0i64 {
                                                        (*f).lf.lr_lpf_line[0usize] = ptr_0.offset(
                                                            -((y_stride
                                                                * (num_lines - 1i32)
                                                                    as libc::c_long)
                                                                as isize),
                                                    ...
                                                    if uv_stride < 0i64 {
                                                        (*f).lf.lr_lpf_line[1usize] = ptr_0.offset(
                                                            -((uv_stride
                                                                * (num_lines * 1i32 - 1i32)
                                                                    as libc::c_long)
                                                                as isize),
                                                            ...
                                                            as *mut libc::c_void;
                                                        (*f).lf.lr_lpf_line[2usize] = ptr_0.offset(
                                                            -((uv_stride
                                                                * (num_lines * 2i32 - 1i32)
                                                                    as libc::c_long)
                                                                as isize),
                                                        ...
                                                        (*f).lf.lr_lpf_line[1usize] =
                                                            ptr_0 as *mut libc::c_void;
                                                        (*f).lf.lr_lpf_line[2usize] = ptr_0.offset(
                                                            (uv_stride * num_lines as libc::c_long)
                                                                as isize,
                                                        )
                                                            as *mut libc::c_void;
                                                    }
                                                    ...
                                                    (*f).lf.lr_buf_plane_sz[1usize] =
                                                        uv_stride as libc::c_int * num_lines * 2i32;
                                                                ...
                                                                _ => {
                                                                        ...
                                                                        != (*f).ipred_edge_sz
                                                                    {
                                                                        dav1d_freep_aligned(
                                                                            &mut *((*f).ipred_edge)
                                                                                .as_mut_ptr()
                                                                                .offset(0isize) as *mut *mut libc::c_void
                                                                                as *mut libc::c_void,
                                                                        );
                                                                        (*f).ipred_edge[0usize] =
                                                                            dav1d_alloc_aligned(
                                                                        ...
                                                                        let mut ptr_1: *mut uint8_t = (*f)
                                                                            .ipred_edge[0usize] as *mut uint8_t;
                                                                        if ptr_1.is_null() {
                                                                            (*f).ipred_edge_sz =
                                                                                0i32;
                                                                            current_block = 13495985911605184990;
                                                                            ...
                                                                            (*f)
                                                                                .ipred_edge[1usize] = ptr_1
                                                                                .offset(
                                                                                    (ipred_edge_sz * 128i32 * 1i32)
                                                                                        as isize,
                                                                                ) as *mut libc::c_void;
                                                                            (*f)
                                                                                .ipred_edge[2usize] = ptr_1
                                                                                .offset(
                                                                                    (ipred_edge_sz * 128i32 * 2i32)
                                                                                        as isize,
                                                                                ) as *mut libc::c_void;
                                                                            (*f).ipred_edge_sz =
                                                                                ipred_edge_sz;
                                                                                ...
                                                                                != (*f).lf.re_sz
                                                                            {
                                                                                freep(
                                                                                    &mut *((*f).lf.tx_lpf_right_edge)
                                                                                        .as_mut_ptr()
                                                                                        .offset(0isize) as *mut *mut uint8_t
                                                                                        as *mut libc::c_void,
                                                                                );
                                                                                (*f)
                                                                                    .lf
                                                                                    .tx_lpf_right_edge[0usize] = malloc(
                                                                                    (re_sz * 32i32 * 2i32)
                                                                                        as libc::c_ulong,
                                                                                ) as *mut uint8_t;
                                                                                if ((*f).lf.tx_lpf_right_edge[0usize])
                                                                                    .is_null()
                                                                                {
                                                                                    (*f).lf.re_sz = 0i32;
                                                                                    current_block = 13495985911605184990;
                                                                                    ...
                                                                                    (*f)
                                                                                        .lf
                                                                                        .tx_lpf_right_edge[1usize] = ((*f)
                                                                                        .lf
                                                                                        .tx_lpf_right_edge[0usize])
                                                                                        .offset((re_sz * 32i32) as isize);
                                                                                    (*f).lf.re_sz = re_sz;
                                                                                        ...
                                                                                        _ => {
                                                                                            ...
                                                                                            if (*(*f).frame_hdr).quant.qm != 0 {
                                                                                                ...
                                                                                                while i < N_RECT_TX_SIZES as libc::c_int {
                                                                                                    (*f)
                                                                                                        .qm[i
                                                                                                        as usize][0usize] = dav1d_qm_tbl[(*(*f).frame_hdr).quant.qm_y
                                                                                                        as usize][0usize][i as usize];
                                                                                                    (*f)
                                                                                                        .qm[i
                                                                                                        as usize][1usize] = dav1d_qm_tbl[(*(*f).frame_hdr).quant.qm_u
                                                                                                        as usize][1usize][i as usize];
                                                                                                    (*f)
                                                                                                        .qm[i
                                                                                                        as usize][2usize] = dav1d_qm_tbl[(*(*f).frame_hdr).quant.qm_v
                                                                                                        as usize][1usize][i as usize];
                                                                                                    i += 1;
                                                                                                }
                                                                                            } else {
                                                                                            ...
                                                                                            has_chroma = ((*f).cur.p.layout
                                                                                                !=  DAV1D_PIXEL_LAYOUT_I400)
                                                                                                as libc::c_int;
                                                                                            (*f).lf.mask_ptr = (*f).lf.mask;
                                                                                            (*f)
                                                                                                .lf
                                                                                                .p[0usize] = (*f).cur.data[0usize];
                                                                                            (*f)
                                                                                                .lf
                                                                                                .p[1usize] = (*f)
                                                                                                .cur
                                                                                            ...
                                                                                            (*f)
                                                                                                .lf
                                                                                                .sr_p[0usize] = (*f).sr_cur.p.data[0usize];
                                                                                            (*f)
                                                                                                .lf
                                                                                                .sr_p[1usize] = (*f)
                                                                                                .sr_cur
    ...
    's_19: loop {
        ...
        while j <= (*((*f).tile).offset(i as isize)).end {
            ...
            if j == (*((*f).tile).offset(i as isize)).end {
                ...
                tile_sz = 0u64;
                let mut k: libc::c_uint = 0u32;
                while k < (*(*f).frame_hdr).tiling.n_bytes {
                    let fresh37 = data;
                    data = data.offset(1);
                    tile_sz |=
                        ((*fresh37 as libc::c_uint) << k.wrapping_mul(8u32)) as libc::c_ulong;
                    k = k.wrapping_add(1);
                }
                tile_sz = tile_sz.wrapping_add(1);
                size = (size).wrapping_sub((*(*f).frame_hdr).tiling.n_bytes as libc::c_ulong);
                if tile_sz > size {
                    current_block = 610192855792336318;
                    break 's_19;
                }
    ...
    match current_block {
        15768484401365413375 => {
            if (*c).n_tc > 1u32 {
                ...
                let mut n: libc::c_int = 0i32;
                while n < (*f).sb128w * (*(*f).frame_hdr).tiling.rows * (1i32 + uses_2pass) {
                    reset_context(
                        &mut *((*f).a).offset(n as isize),
                        ((*(*f).frame_hdr).frame_type & 1u32 == 0) as libc::c_int,
                        if uses_2pass != 0 {
                            1i32 + (n >= (*f).sb128w * (*(*f).frame_hdr).tiling.rows) as libc::c_int
                        } else {
                            0i32
                        },
                    );
...
pub unsafe extern "C" fn dav1d_decode_frame_main(f: *mut Dav1dFrameContext) -> libc::c_int {
    ...
    let t: *mut Dav1dTaskContext =
        &mut *((*c).tc).offset(f.offset_from((*c).fc)) as *mut Dav1dTaskContext;
    (*t).f = f;
    (*t).frame_thread.pass = 0i32;
    let mut n: libc::c_int = 0i32;
    ...
    's_44: loop {
        ...
        let mut sby: libc::c_int =
            (*(*f).frame_hdr).tiling.row_start_sb[tile_row as usize] as libc::c_int;
        while sby < sbh_end {
            (*t).by = sby << 4i32 + (*(*f).seq_hdr).sb128;
            let by_end: libc::c_int = (*t).by + (*f).sb_step >> 1i32;
...
pub unsafe extern "C" fn dav1d_decode_frame_exit(f: *mut Dav1dFrameContext, retval: libc::c_int) {
    ...
    if !((*f).sr_cur.p.data[0usize]).is_null() {
        *&mut (*f).task_thread.error = 0i32;
    }
    if (*c).n_fc > 1u32 && retval != 0 && !((*f).frame_thread.cf).is_null() {
        memset(
            (*f).frame_thread.cf,
            0i32,
...
unsafe extern "C" fn get_upscale_x0(
    ...
    let err: libc::c_int = out_w * step - (in_w << 14i32);
    let x0: libc::c_int =
        (-(out_w - in_w << 13i32) + (out_w >> 1i32)) / out_w + 128i32 - err / 2i32;
    return x0 & 0x3fffi32;
}
#[no_mangle]
pub unsafe extern "C" fn dav1d_submit_frame(c: *mut Dav1dContext) -> libc::c_int {
    ...
    if (*c).n_fc > 1u32 {
        ...
        if !((*out_delayed).p.data[0usize]).is_null()
            || ::core::intrinsics::atomic_load(&mut (*f).task_thread.error as *mut atomic_int) != 0
        {
            let mut first: libc::c_uint =
                ::core::intrinsics::atomic_load(&mut (*c).task_thread.first);
            if first.wrapping_add(1u32) < (*c).n_fc {
                ::core::intrinsics::atomic_xadd(&mut (*c).task_thread.first, 1u32);
            } else {
                ::core::intrinsics::atomic_store(&mut (*c).task_thread.first, 0u32);
            }
        ...
        } else if !((*out_delayed).p.data[0usize]).is_null() {
            let progress: libc::c_uint = ::core::intrinsics::atomic_load_relaxed(
                &mut *((*out_delayed).progress).offset(1isize) as *mut atomic_uint,
            );
    ...
    let bpc: libc::c_int = 8i32 + 2i32 * (*(*f).seq_hdr).hbd;
        ...
        313581471991351815 => {
            ...
            if (*(*f).frame_hdr).frame_type & 1u32 != 0 {
                if (*(*f).frame_hdr).primary_ref_frame != 7i32 {
                    ...
                    if ((*c).refs[pri_ref as usize].p.p.data[0usize]).is_null() {
                        res = -(22i32);
                        current_block = 9123693364129885070;
                    } else {
                ...
                match current_block {
                    ...
                    _ => {
                        ...
                        loop {
                            ...
                            if ((*c).refs[refidx as usize].p.p.data[0usize]).is_null()
                                || ((*(*f).frame_hdr).width[0usize] * 2i32)
                                    < (*c).refs[refidx as usize].p.p.p.w
                                || ((*(*f).frame_hdr).height * 2i32)
                                    < (*c).refs[refidx as usize].p.p.p.h
                                || (*(*f).frame_hdr).width[0usize]
                                    > (*c).refs[refidx as usize].p.p.p.w * 16i32
                                || (*(*f).frame_hdr).height
                                    > (*c).refs[refidx as usize].p.p.p.h * 16i32
                                ...
                                || bpc != (*c).refs[refidx as usize].p.p.p.bpc
                            {
                                ...
                                ref_coded_width[i as usize] =
                                    (*(*c).refs[refidx as usize].p.p.frame_hdr).width[0usize];
                                if (*(*f).frame_hdr).width[0usize]
                                    != (*c).refs[refidx as usize].p.p.p.w
                                    || (*(*f).frame_hdr).height
                                        != (*c).refs[refidx as usize].p.p.p.h
                                {
                                    (*f).svc[i as usize][0usize].scale =
                                        (((*c).refs[refidx as usize].p.p.p.w << 14i32)
                                            + ((*(*f).frame_hdr).width[0usize] >> 1i32))
                                            / (*(*f).frame_hdr).width[0usize];
                                    (*f).svc[i as usize][1usize].scale =
                                        (((*c).refs[refidx as usize].p.p.p.h << 14i32)
                                            + ((*(*f).frame_hdr).height >> 1i32))
                                            / (*(*f).frame_hdr).height;
                                    (*f).svc[i as usize][0usize].step =
                                        (*f).svc[i as usize][0usize].scale + 8i32 >> 4i32;
                                    (*f).svc[i as usize][1usize].step =
                                        (*f).svc[i as usize][1usize].scale + 8i32 >> 4i32;
                                } else {
                                    (*f).svc[i as usize][1usize].scale = 0i32;
                                    (*f).svc[i as usize][0usize].scale =
                                        (*f).svc[i as usize][1usize].scale;
                                }
                                (*f).gmv_warp_allowed[i as usize] =
                                    ((*(*f).frame_hdr).gmv[i as usize].type_0
                                        > DAV1D_WM_TYPE_TRANSLATION
                                        && (*(*f).frame_hdr).force_integer_mv == 0
                                        ...
                                        && (*f).svc[i as usize][0usize].scale == 0)
                                        as uint8_t;
                                i += 1;
                            }
                        }
                    ...
                    match current_block {
                        ...
                        _ => {
                            if (*f).n_tile_data_alloc < (*c).n_tile_data {
                                ...
                                if !((*c).n_tile_data
                                    < 2147483647i32
                                        / ::core::mem::size_of::<Dav1dTileGroup>() as libc::c_int)
                                {
                                    unreachable!();
                                }
                                (*f).tile = malloc(
                                        ...
                                        match current_block {
                                            ...
                                            _ => {
                                                if (*(*f).frame_hdr).width[0usize]
                                                    != (*(*f).frame_hdr).width[1usize]
                                                {
                                                    (*f).resize_step[0usize] = (((*f).cur.p.w
                                                        << 14i32)
                                                        + ((*f).sr_cur.p.p.w >> 1i32))
                                                        / (*f).sr_cur.p.p.w;
                                                    let ss_hor: libc::c_int = ((*f).cur.p.layout
                                                        != DAV1D_PIXEL_LAYOUT_I444)
                                                        as libc::c_int;
                                                    let in_cw: libc::c_int =
                                                        (*f).cur.p.w + ss_hor >> ss_hor;
                                                    let out_cw: libc::c_int =
                                                        (*f).sr_cur.p.p.w + ss_hor >> ss_hor;
                                                    (*f).resize_step[1usize] = ((in_cw << 14i32)
                                                        + (out_cw >> 1i32))
                                                        / out_cw;
                                                    (*f).resize_start[0usize] = get_upscale_x0(
                                                        (*f).cur.p.w,
                                                        (*f).sr_cur.p.p.w,
                                                        (*f).resize_step[0usize],
                                                    );
                                                    (*f).resize_start[1usize] = get_upscale_x0(
                                                        in_cw,
                                                        out_cw,
                                                        (*f).resize_step[1usize],
                                                    );
                                                }
                                                if (*c).n_fc == 1u32 {
                                                ...
                                                (*f).w4 =
                                                    (*(*f).frame_hdr).width[0usize] + 3i32 >> 2i32;
                                                (*f).h4 = (*(*f).frame_hdr).height + 3i32 >> 2i32;
                                                (*f).bw = ((*(*f).frame_hdr).width[0usize] + 7i32
                                                    >> 3i32)
                                                    << 1i32;
                                                (*f).bh = ((*(*f).frame_hdr).height + 7i32 >> 3i32)
                                                    << 1i32;
                                                (*f).sb128w = (*f).bw + 31i32 >> 5i32;
                                                (*f).sb128h = (*f).bh + 31i32 >> 5i32;
                                                (*f).sb_shift = 4i32 + (*(*f).seq_hdr).sb128;
                                                (*f).sb_step = (16i32) << (*(*f).seq_hdr).sb128;
                                                (*f).sbh =
                                                    (*f).bh + (*f).sb_step - 1i32 >> (*f).sb_shift;
                                                (*f).b4_stride =
                                                    ((*f).bw + 31i32 & !(31i32)) as ptrdiff_t;
                                                (*f).bitdepth_max =
                                                    ((1i32) << (*f).cur.p.bpc) - 1i32;
                                                *&mut (*f).task_thread.error = 0i32;
                                                uses_2pass = ((*c).n_fc > 1u32) as libc::c_int;
                                                    ...
                                                    || (*(*f).frame_hdr).allow_intrabc != 0
                                                {
                                                    ...
                                                    if ((*f).mvs_ref).is_null() {
                                                        ...
                                                        if (*(*f).frame_hdr).use_ref_frame_mvs != 0
                                                        {
                                                            let mut i_1: libc::c_int = 0i32;
                                                            while i_1 < 7i32 {
                                                                let refidx_0: libc::c_int =
                                                                    (*(*f).frame_hdr).refidx
                                                                        [i_1 as usize];
                                                                let ref_w: libc::c_int =
                                                                    (ref_coded_width[i_1 as usize]
                                                                        + 7i32
                                                                        >> 3i32)
                                                                        << 1i32;
                                                                let ref_h: libc::c_int =
                                                            ...
                                                            != 0
                                                        {
                                                            ...
                                                            if (*(*f).frame_hdr)
                                                                ...
                                                                || (*(*f).frame_hdr)
                                                                    ...
                                                                    == 0
                                                            {
                                                                let pri_ref_1: libc::c_int =
                                                                    (*(*f).frame_hdr)
                                                                        .primary_ref_frame;
                                                                if !(pri_ref_1 != 7i32) {
                                                                    unreachable!();
                                                                }
                                                                let ref_w_0: libc::c_int =
                                                                    (ref_coded_width
                                                                        [pri_ref_1 as usize]
                                                                        + 7i32
                                                                        >> 3i32)
                                                                        << 1i32;
                                                                let ref_h_0: libc::c_int =
                                                                    ((*f).refp[pri_ref_1 as usize]
                                                                        .p
                                                                        .p
                                                                        .h
                                                                        + 7i32
