...
pub unsafe extern "C" fn dav1d_ref_dec(pref: *mut *mut Dav1dRef) {
    ...
    *pref = 0 as *mut Dav1dRef;
    ...
    if ::core::intrinsics::atomic_xsub_seqcst(fresh0, fresh1) - fresh1 == 1 as libc::c_int {
...
pub unsafe extern "C" fn dav1d_ref_is_writable(ref_0: *mut Dav1dRef) -> libc::c_int {
    return (::core::intrinsics::atomic_load_seqcst(&mut (*ref_0).ref_cnt as *mut atomic_int)
        == 1 as libc::c_int
