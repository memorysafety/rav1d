...
extern "C" {
    ...
    fn dav1d_generate_grain_y_8bpc_avx2(buf: *mut [entry; 82], data: *const Dav1dFilmGrainData);
...
extern "C" {
    ...
    fn dav1d_generate_grain_y_8bpc_neon(buf: *mut [entry; 82], data: *const Dav1dFilmGrainData);
