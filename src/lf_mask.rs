...
unsafe extern "C" fn decomp_tx(
    ...
    let is_split: libc::c_int = if from as libc::c_uint == TX_4X4 as libc::c_int as libc::c_uint
        || depth > 1 as libc::c_int
    {
        0 as libc::c_int
    } else {
        *tx_masks.offset(depth as isize) as libc::c_int >> y_off * 4 as libc::c_int + x_off
            & 1 as libc::c_int
    };
    if is_split != 0 {
            ...
            1 => {
                ...
                while y < (*t_dim).h as libc::c_int {
                    ...
                    (*txa.offset(0 as libc::c_int as isize))[1 as libc::c_int as usize]
                        [y as usize][0 as libc::c_int as usize] = (*t_dim).w;
                    y += 1;
                }
            }
            2 => {
                ...
                while y_0 < (*t_dim).h as libc::c_int {
                    ...
                    (*txa.offset(0 as libc::c_int as isize))[1 as libc::c_int as usize]
                        [y_0 as usize][0 as libc::c_int as usize] = (*t_dim).w;
                    y_0 += 1;
                }
            }
            4 => {
                ...
                while y_1 < (*t_dim).h as libc::c_int {
                    ...
                    (*txa.offset(0 as libc::c_int as isize))[1 as libc::c_int as usize]
                        [y_1 as usize][0 as libc::c_int as usize] = (*t_dim).w;
                    y_1 += 1;
                }
            }
            8 => {
                ...
                while y_2 < (*t_dim).h as libc::c_int {
                    ...
                    .offset(0 as libc::c_int as isize) as *mut uint8_t
                        ...
                        as uint64_t;
                    (*txa.offset(0 as libc::c_int as isize))[1 as libc::c_int as usize]
                        [y_2 as usize][0 as libc::c_int as usize] = (*t_dim).w;
                    y_2 += 1;
                }
            }
            16 => {
                ...
                while y_3 < (*t_dim).h as libc::c_int {
                    ...
                    .offset((0 as libc::c_int + 8 as libc::c_int) as isize)
                        ...
                        .u64_0 = const_val_0;
                    (*txa.offset(0 as libc::c_int as isize))[1 as libc::c_int as usize]
                        [y_3 as usize][0 as libc::c_int as usize] = (*t_dim).w;
                    y_3 += 1;
                }
            }
            _ => {}
        ...
        match (*t_dim).w as libc::c_int {
            ...
            2 => {
                ...
                .offset(0 as libc::c_int as isize) as *mut uint8_t
                    as *mut alias16))
                    .u16_0 = (0x101 as libc::c_int * (*t_dim).h as libc::c_int) as uint16_t;
            }
            4 => {
                (*(&mut *(*(*(*txa.offset(1 as libc::c_int as isize))
                    .as_mut_ptr()
...
unsafe extern "C" fn mask_edges_inter(
    ...
    y = 0 as libc::c_int;
    while y < h4 {
        let sidx: libc::c_int = (mask >= 0x10000 as libc::c_int as libc::c_uint) as libc::c_int;
        ...
        let ref mut fresh0 = (*masks.offset(0 as libc::c_int as isize))[bx4 as usize][imin(
            txa[0 as libc::c_int as usize][0 as libc::c_int as usize][y as usize]
    ...
    while x < w4 {
        let sidx_0: libc::c_int = (mask >= 0x10000 as libc::c_int as libc::c_uint) as libc::c_int;
        ...
        let ref mut fresh1 = (*masks.offset(1 as libc::c_int as isize))[by4 as usize][imin(
            txa[1 as libc::c_int as usize][0 as libc::c_int as usize][0 as libc::c_int as usize]
    ...
    if skip == 0 {
        ...
        while y < h4 {
            ...
            let mut ltx: libc::c_int = txa[0 as libc::c_int as usize][0 as libc::c_int as usize]
                [y as usize][0 as libc::c_int as usize]
                as libc::c_int;
            let mut step: libc::c_int = txa[0 as libc::c_int as usize][1 as libc::c_int as usize]
                [y as usize][0 as libc::c_int as usize]
                as libc::c_int;
            x = step;
            while x < w4 {
                let rtx: libc::c_int = txa[0 as libc::c_int as usize][0 as libc::c_int as usize]
                    [y as usize][x as usize] as libc::c_int;
                ...
                *fresh2 = (*fresh2 as libc::c_uint | smask_1) as uint16_t;
                ltx = rtx;
                step = txa[0 as libc::c_int as usize][1 as libc::c_int as usize][y as usize]
                    [x as usize] as libc::c_int;
                x += step;
            }
            y += 1;
        ...
        while x < w4 {
            ...
            let mut ttx: libc::c_int = txa[1 as libc::c_int as usize][0 as libc::c_int as usize]
                [0 as libc::c_int as usize][x as usize]
                as libc::c_int;
            let mut step_0: libc::c_int = txa[1 as libc::c_int as usize][1 as libc::c_int as usize]
                [0 as libc::c_int as usize][x as usize]
                as libc::c_int;
            y = step_0;
            while y < h4 {
                let btx: libc::c_int = txa[1 as libc::c_int as usize][0 as libc::c_int as usize]
                    [y as usize][x as usize] as libc::c_int;
                ...
                *fresh3 = (*fresh3 as libc::c_uint | smask_2) as uint16_t;
                ttx = btx;
                step_0 = txa[1 as libc::c_int as usize][1 as libc::c_int as usize][y as usize]
                    [x as usize] as libc::c_int;
                y += step_0;
            }
            x += 1;
    ...
    while y < h4 {
        *l.offset(y as isize) = txa[0 as libc::c_int as usize][0 as libc::c_int as usize]
            [y as usize][(w4 - 1 as libc::c_int) as usize];
        y += 1;
    }
    memcpy(
        a as *mut libc::c_void,
        (txa[1 as libc::c_int as usize][0 as libc::c_int as usize]
            [(h4 - 1 as libc::c_int) as usize])
...
unsafe extern "C" fn mask_edges_intra(
    ...
    while x < w4 {
        if inner1 != 0 {
            let ref mut fresh6 = (*masks.offset(0 as libc::c_int as isize))[(bx4 + x) as usize]
                [twl4c as usize][0 as libc::c_int as usize];
            *fresh6 = (*fresh6 as libc::c_uint | inner1) as uint16_t;
        }
        if inner2 != 0 {
            let ref mut fresh7 = (*masks.offset(0 as libc::c_int as isize))[(bx4 + x) as usize]
                [twl4c as usize][1 as libc::c_int as usize];
    ...
    while y < h4 {
        if inner1 != 0 {
            let ref mut fresh8 = (*masks.offset(1 as libc::c_int as isize))[(by4 + y) as usize]
                [thl4c as usize][0 as libc::c_int as usize];
            *fresh8 = (*fresh8 as libc::c_uint | inner1) as uint16_t;
        }
        if inner2 != 0 {
            let ref mut fresh9 = (*masks.offset(1 as libc::c_int as isize))[(by4 + y) as usize]
                [thl4c as usize][1 as libc::c_int as usize];
    ...
    match w4 {
        1 => {
            (*(&mut *a.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias8)).u8_0 =
                (0x1 as libc::c_int * thl4c) as uint8_t;
        }
        2 => {
            (*(&mut *a.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias16)).u16_0 =
                (0x101 as libc::c_int * thl4c) as uint16_t;
        }
        4 => {
            (*(&mut *a.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias32)).u32_0 =
                (0x1010101 as libc::c_uint).wrapping_mul(thl4c as libc::c_uint);
        }
        8 => {
            (*(&mut *a.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias64)).u64_0 =
        ...
        16 => {
            let const_val: uint64_t = (0x101010101010101 as libc::c_ulonglong)
                ...
                as uint64_t;
            (*(&mut *a.offset((0 as libc::c_int + 0 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val;
            (*(&mut *a.offset((0 as libc::c_int + 8 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val;
        }
        32 => {
            ...
            (*(&mut *a.offset((0 as libc::c_int + 8 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_0;
            (*(&mut *a.offset((0 as libc::c_int + 16 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_0;
            (*(&mut *a.offset((0 as libc::c_int + 24 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_0;
        }
        _ => {
    ...
    match h4 {
        1 => {
            (*(&mut *l.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias8)).u8_0 =
                (0x1 as libc::c_int * twl4c) as uint8_t;
        }
        2 => {
            (*(&mut *l.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias16)).u16_0 =
                (0x101 as libc::c_int * twl4c) as uint16_t;
        }
        4 => {
            (*(&mut *l.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias32)).u32_0 =
                (0x1010101 as libc::c_uint).wrapping_mul(twl4c as libc::c_uint);
        }
        8 => {
            (*(&mut *l.offset(0 as libc::c_int as isize) as *mut uint8_t as *mut alias64)).u64_0 =
        ...
        16 => {
            let const_val_1: uint64_t = (0x101010101010101 as libc::c_ulonglong)
                ...
                as uint64_t;
            (*(&mut *l.offset((0 as libc::c_int + 0 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_1;
            (*(&mut *l.offset((0 as libc::c_int + 8 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_1;
        }
        32 => {
            ...
            (*(&mut *l.offset((0 as libc::c_int + 8 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_2;
            (*(&mut *l.offset((0 as libc::c_int + 16 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_2;
            (*(&mut *l.offset((0 as libc::c_int + 24 as libc::c_int) as isize) as *mut uint8_t
                as *mut alias64))
                .u64_0 = const_val_2;
        }
        _ => {
...
unsafe extern "C" fn mask_edges_chroma(
    ...
    if skip_inter == 0 {
        ...
        let mut inner1: libc::c_uint =
            inner & (((1 as libc::c_int) << vmask) - 1 as libc::c_int) as libc::c_uint;
        ...
        inner1 = inner & (((1 as libc::c_int) << hmask) - 1 as libc::c_int) as libc::c_uint;
        inner2 = inner >> hmask;
        y = vstep;
        while y < ch4 {
            if inner1 != 0 {
...
pub unsafe extern "C" fn dav1d_create_lf_mask_intra(
    ...
    if bw4 != 0 && bh4 != 0 {
        ...
        while y < bh4 {
            ...
            while x < bw4 {
                (*level_cache_ptr.offset(x as isize))[0 as libc::c_int as usize] = (*filter_level
                    .offset(0 as libc::c_int as isize))[0 as libc::c_int as usize]
                    [0 as libc::c_int as usize];
                (*level_cache_ptr.offset(x as isize))[1 as libc::c_int as usize] = (*filter_level
    ...
    while y_0 < cbh4 {
        let mut x_0: libc::c_int = 0 as libc::c_int;
        while x_0 < cbw4 {
            (*level_cache_ptr_0.offset(x_0 as isize))[2 as libc::c_int as usize] = (*filter_level
                .offset(2 as libc::c_int as isize))[0 as libc::c_int as usize]
                [0 as libc::c_int as usize];
            (*level_cache_ptr_0.offset(x_0 as isize))[3 as libc::c_int as usize] = (*filter_level
...
pub unsafe extern "C" fn dav1d_calc_eih(lim_lut: *mut Av1FilterLUT, filter_sharpness: libc::c_int) {
    ...
    while level < 64 as libc::c_int {
        ...
        (*lim_lut).e[level as usize] =
            (2 as libc::c_int * (level + 2 as libc::c_int) + limit) as uint8_t;
        level += 1;
    }
    (*lim_lut).sharp[0 as libc::c_int as usize] =
        (sharp + 3 as libc::c_int >> 2 as libc::c_int) as uint64_t;
...
unsafe extern "C" fn calc_lf_value(
    ...
    if mr_delta.is_null() {
        ...
        let ref mut fresh16 =
            (*lflvl_values.offset(0 as libc::c_int as isize))[1 as libc::c_int as usize];
        *fresh16 = iclip(
            base + (*mr_delta).ref_delta[0 as libc::c_int as usize] * ((1 as libc::c_int) << sh),
            0 as libc::c_int,
            63 as libc::c_int,
        ) as uint8_t;
        (*lflvl_values.offset(0 as libc::c_int as isize))[0 as libc::c_int as usize] = *fresh16;
...
pub unsafe extern "C" fn dav1d_calc_lf_values(
        ...
        && (*hdr).loopfilter.level_y[1 as libc::c_int as usize] == 0
    {
        memset(
            lflvl_values as *mut libc::c_void,
            0 as libc::c_int,
            (8 as libc::c_int * 4 as libc::c_int * 2 as libc::c_int * n_seg) as libc::c_ulong,
        );
        return;
    }
