...
unsafe extern "C" fn padding(
    ...
    if edges as libc::c_uint & LR_HAVE_BOTTOM as libc::c_int as libc::c_uint != 0 {
        ...
        let src: *const pixel =
            p.offset(((stripe_h - 1 as libc::c_int) as libc::c_long * stride) as isize);
        memcpy(
            dst_tl.offset((stripe_h * 390 as libc::c_int) as isize) as *mut libc::c_void,
...
unsafe extern "C" fn wiener_c(
    ...
    while j < h + 6 as libc::c_int {
        ...
        while i < w {
            ...
            sum += *tmp_ptr.offset((i + 3 as libc::c_int) as isize) as libc::c_int
                * 128 as libc::c_int;
...
unsafe extern "C" fn boxsum3(
    ...
    while y_0 < h - 2 as libc::c_int {
        ...
        while x_0 < w - 2 as libc::c_int {
            let c_0: libc::c_int = *sum.offset((x_0 + 1 as libc::c_int) as isize) as libc::c_int;
...
unsafe extern "C" fn boxsum5(
    ...
    while y_0 < h - 2 as libc::c_int {
        ...
        let mut x_0: libc::c_int = 2 as libc::c_int;
        while x_0 < w - 2 as libc::c_int {
            let e_0: libc::c_int = *sum.offset((x_0 + 2 as libc::c_int) as isize) as libc::c_int;
...
unsafe extern "C" fn selfguided_filter(
    ...
    if n == 25 as libc::c_int {
        ...
        while j_0 < h - 1 as libc::c_int {
            ...
            while i_1 < w {
                let a_1: libc::c_int = *B.offset(i_1 as isize) as libc::c_int * 6 as libc::c_int
...
unsafe extern "C" fn sgr_5x5_c(
    ...
    while j < h {
        let mut i: libc::c_int = 0 as libc::c_int;
        while i < w {
            let v: libc::c_int = w0 * dst[(j * 384 as libc::c_int + i) as usize] as libc::c_int;
...
unsafe extern "C" fn sgr_3x3_c(
    ...
    while j < h {
        let mut i: libc::c_int = 0 as libc::c_int;
        while i < w {
            let v: libc::c_int = w1 * dst[(j * 384 as libc::c_int + i) as usize] as libc::c_int;
            *p.offset(i as isize) = iclip_u8(
                *p.offset(i as isize) as libc::c_int
                    + (v + ((1 as libc::c_int) << 10 as libc::c_int) >> 11 as libc::c_int),
            ) as pixel;
...
unsafe extern "C" fn sgr_mix_c(
    ...
    while j < h {
        let mut i: libc::c_int = 0 as libc::c_int;
        while i < w {
            let v: libc::c_int = w0 * dst0[(j * 384 as libc::c_int + i) as usize] as libc::c_int
