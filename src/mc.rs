...
use crate::src::tables::rav1d_mc_subpel_filters;
use crate::src::tables::rav1d_mc_warp_filter;
use crate::src::tables::rav1d_obmc_masks;
use crate::src::tables::rav1d_resize_filter;
...
fn get_filter(m: usize, d: usize, filter_type: Rav1dFilterMode) -> Option<&'static [i8; 8]> {
    ...
    Some(&rav1d_mc_subpel_filters()[i as usize][m])
}
...
fn warp_affine_8x8_rust<BD: BitDepth>(
    ...
    for y in 0..H {
        ...
        for x in 0..W {
            ...
            let filter = &rav1d_mc_warp_filter()[(64 + (tmx + 512 >> 10)) as usize];
            let n = filter.len();
    ...
    for y in 0..H - 7 {
        ...
        for x in 0..W {
            ...
            let filter = &rav1d_mc_warp_filter()[(64 + (tmy + 512 >> 10)) as usize];
            let n = filter.len();
            let mid = &mid[y..][..n];
            dst[x] = bd.iclip_pixel(
                (0..n)
...
fn resize_rust<BD: BitDepth>(
    ...
    for y in 0..h {
        ...
        for dst_x in 0..dst_w {
            let f = &rav1d_resize_filter()[(mx >> 8) as usize];
