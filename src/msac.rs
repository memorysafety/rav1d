...
unsafe extern "C" fn ctx_refill(s: *mut MsacContext) {
    ...
    (*s).dif = dif;
    (*s)
        .cnt = ((::core::mem::size_of::<ec_win>() as libc::c_ulong) << 3 as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn dav1d_msac_decode_bool_equi_c(
    s: *mut MsacContext,
) -> libc::c_uint {
    ...
    v = v
        .wrapping_add(
            ret
                .wrapping_mul(
                    r.wrapping_sub((2 as libc::c_int as libc::c_uint).wrapping_mul(v)),
                ),
        );
    ctx_norm(s, dif, v);
...
pub unsafe extern "C" fn dav1d_msac_decode_bool_c(
    ...
    let mut v: libc::c_uint = ((r >> 8 as libc::c_int)
        .wrapping_mul(f >> 6 as libc::c_int) >> 7 as libc::c_int - 6 as libc::c_int)
        .wrapping_add(4 as libc::c_int as libc::c_uint);
    let vw: ec_win = (v as ec_win)
        << ((::core::mem::size_of::<ec_win>() as libc::c_ulong) << 3 as libc::c_int)
            .wrapping_sub(16 as libc::c_int as libc::c_ulong);
...
pub unsafe extern "C" fn dav1d_msac_decode_subexp(
    ...
    if dav1d_msac_decode_bool_equi_sse2(s) != 0 {
        if dav1d_msac_decode_bool_equi_sse2(s) != 0 {
            k = k
                .wrapping_add(
...
pub unsafe extern "C" fn dav1d_msac_decode_symbol_adapt_c(
    ...
    let c: libc::c_uint = ((*s).dif
        >> ((::core::mem::size_of::<ec_win>() as libc::c_ulong) << 3 as libc::c_int)
            .wrapping_sub(16 as libc::c_int as libc::c_ulong)) as libc::c_uint;
    ...
    loop {
        ...
        v = r
            .wrapping_mul(
                (*cdf.offset(val as isize) as libc::c_int >> 6 as libc::c_int)
                    as libc::c_uint,
            );
    ...
    ctx_norm(
        ...
        ((*s).dif)
            .wrapping_sub(
                (v as ec_win)
                    << ((::core::mem::size_of::<ec_win>() as libc::c_ulong)
                        << 3 as libc::c_int)
                        .wrapping_sub(16 as libc::c_int as libc::c_ulong),
            ),
        u.wrapping_sub(v),
    ...
    if (*s).allow_update_cdf != 0 {
        ...
        *cdf
            ...
            .wrapping_add(
                (count < 32 as libc::c_int as libc::c_uint) as libc::c_int
                    as libc::c_uint,
            ) as uint16_t;
    }
    return val;
...
pub unsafe extern "C" fn dav1d_msac_decode_bool_adapt_c(
    ...
    let bit: libc::c_uint = dav1d_msac_decode_bool_sse2(s, *cdf as libc::c_uint);
    if (*s).allow_update_cdf != 0 {
...
pub unsafe extern "C" fn dav1d_msac_decode_hi_tok_c(
    ...
    let mut tok_br: libc::c_uint = dav1d_msac_decode_symbol_adapt4_sse2(
        s,
        cdf,
    ...
    if tok_br == 3 as libc::c_int as libc::c_uint {
        tok_br = dav1d_msac_decode_symbol_adapt4_sse2(
            s,
            cdf,
            3 as libc::c_int as size_t,
        );
