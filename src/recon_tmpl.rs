...
unsafe extern "C" fn get_skip_ctx(
    ...
    if chroma != 0 {
        ...
        match (*t_dim).lw as libc::c_int {
            0 => {
                current_block_7 = 15429397072006002086;
            }
            1 => {
        ...
        match (*t_dim).lh as libc::c_int {
            0 => {
                current_block_16 = 2466381128091252398;
            }
            1 => {
            ...
            == (*t_dim).lh as libc::c_int
    {
        ...
        match (*t_dim).lw as libc::c_int {
            0 => {
                current_block_80 = 16605772844061215166;
            }
            1 => {
        ...
        match (*t_dim).lh as libc::c_int {
            0 => {
                current_block_140 = 6671189973271993657;
            }
            1 => {
                if TX_8X8 as libc::c_int == TX_64X64 as libc::c_int {
...
unsafe extern "C" fn get_dc_sign_ctx(
    ...
    asm!(
        "", inlateout(reg) mask, inlateout(reg) mul, options(preserves_flags, pure,
        readonly, att_syntax)
    );
...
unsafe extern "C" fn decode_coefs(
    ...
    if dc_tok == 0 {
        ...
        if !qm_tbl.is_null() {
            current_block = 5286516543165580434;
        } else {
            current_block = 2802704498462043270;
        }
    } else {
