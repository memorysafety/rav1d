    ...
    for x in 0..w {
        if !(have_left == 0 && x == 0) {
            ...
            (*dsp).lf.loop_filter_sb[0][0](
                ...
                ls,
                hmask.as_mut_ptr(),
                &*(*lvl.as_ptr().offset(x as isize)).as_ptr().offset(0) as *const u8
                    as *const [u8; 4],
                b4_stride,
                &(*f).lf.lim_lut.0,
                endy4 - starty4,
    ...
    for x in 0..w {
        if !(have_left == 0 && x == 0) {
            ...
            (*dsp).lf.loop_filter_sb[1][0](
                ...
                ls,
                hmask.as_mut_ptr(),
                &*lvl[x as usize].as_ptr().offset(2) as *const u8 as *const [u8; 4],
                b4_stride,
                &(*f).lf.lim_lut.0,
                endy4 - starty4,
                (*f).bitdepth_max,
            ...
            (*dsp).lf.loop_filter_sb[1][0](
                ...
                ls,
                hmask.as_mut_ptr(),
                &*lvl[x as usize].as_ptr().offset(3) as *const u8 as *const [u8; 4],
                b4_stride,
                &(*f).lf.lim_lut.0,
                endy4 - starty4,
                (*f).bitdepth_max,
