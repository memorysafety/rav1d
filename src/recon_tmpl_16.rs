...
unsafe extern "C" fn decode_coefs(
    ...
    if eob != 0 {
        ...
        match tx_class {
            0 => {
                ...
                *cf.offset(rc as isize) = tok << 11i32;
    ...
    let cf_max: libc::c_int =
        !(!(127u32) << (if 16i32 == 8i32 { 8i32 } else { (*f).cur.p.bpc })) as libc::c_int;
    ...
    if dc_tok == 0 {
        ...
        if !qm_tbl.is_null() {
            ...
            *cf.offset(0isize) = if dc_sign != 0 { -dc_dq } else { dc_dq };
            if rc != 0 {
                current_block = 1669574575799829731;
            } else {
...
unsafe extern "C" fn read_coef_tree(
        ...
        && *tx_split.offset(depth as isize) as libc::c_int & (1i32) << y_off * 4i32 + x_off != 0
    {
        ...
        if txh >= txw && (*t).by < (*f).bh {
            if !dst.is_null() {
                dst = dst.offset(
                    ((4i32 * txsh) as libc::c_long * PXSTRIDE((*f).cur.stride[0usize])) as isize,
                );
            }
            read_coef_tree(
                t,
...
unsafe extern "C" fn warp_affine(
    ...
    while y < *b_dim.offset(1isize) as libc::c_int * v_mul {
        ...
        if !dst8.is_null() {
            dst8 = dst8.offset((8i64 * PXSTRIDE(dstride)) as isize);
        } else {
        ...
        while init_x < w4 {
            if (*b).c2rust_unnamed.c2rust_unnamed.pal_sz[0usize] != 0 {
                let mut dst: *mut pixel = ((*f).cur.data[0usize] as *mut pixel).offset(
                    (4i64
                        * ((*t).by as libc::c_long * PXSTRIDE((*f).cur.stride[0usize])
            ...
            if !(has_chroma == 0) {
                    ...
                    == CFL_PRED as libc::c_int
                {
                    ...
                    let mut y_src: *mut pixel = ((*f).cur.data[0usize] as *mut pixel)
                        ...
                        .offset(
                            ((4i32 * ((*t).by & !ss_ver)) as libc::c_long
                                * PXSTRIDE((*f).cur.stride[0usize]))
                                as isize,
                        );
...
pub unsafe extern "C" fn dav1d_recon_b_inter_16bpc(
    ...
    let uvdstoff: ptrdiff_t = 4i64
        * (((*t).bx >> ss_hor) as libc::c_long
            + ((*t).by >> ss_ver) as libc::c_long * PXSTRIDE((*f).cur.stride[1usize]));
        ...
        if !(has_chroma == 0) {
            ...
            if is_sub8x8 != 0 {
                ...
                if bw4 == 1i32 && bh4 == ss_ver {
                    ...
                    v_off = 2i64 * PXSTRIDE((*f).cur.stride[1usize]);
                    h_off = 2i64;
                }
                if bw4 == 1i32 {
    ...
    while init_y < bh4 {
        ...
        while init_x < bw4 {
            ...
            let mut y: libc::c_int = 0;
            dst = dst.offset(
                (PXSTRIDE((*f).cur.stride[0usize]) * 4i64 * init_y as libc::c_long) as isize,
            );
            y = init_y;
            (*t).by += init_y;
            while y < imin(h4, init_y + 16i32) {
                ...
                dst = dst.offset(
                    (PXSTRIDE((*f).cur.stride[0usize]) * 4i64 * (*ytx).h as libc::c_long) as isize,
                );
                (*t).bx -= x;
            ...
            dst = dst
                .offset(-((PXSTRIDE((*f).cur.stride[0usize]) * 4i64 * y as libc::c_long) as isize));
            (*t).by -= y;
            if has_chroma != 0 {
                ...
                while pl_8 < 2i32 {
                    let mut uvdst_1: *mut pixel = ((*f).cur.data[(1i32 + pl_8) as usize]
                        ...
                        .offset(uvdstoff as isize)
                        .offset(
                            (PXSTRIDE((*f).cur.stride[1usize]) * init_y as libc::c_long * 4i64
                                >> ss_ver) as isize,
                        );
                    y = init_y >> ss_ver;
                    (*t).by += init_y;
                    while y < imin(ch4, init_y + 16i32 >> ss_ver) {
                        ...
                        uvdst_1 = uvdst_1.offset(
                            (PXSTRIDE((*f).cur.stride[1usize]) * 4i64 * (*uvtx).h as libc::c_long)
                                as isize,
                        );
                        (*t).bx -= x_0 << ss_hor;
...
pub unsafe extern "C" fn dav1d_filter_sbrow_deblock_cols_16bpc(
    ...
    let p: [*mut pixel; 3] = [
        ((*f).lf.p[0usize])
            .offset((y as libc::c_long * PXSTRIDE((*f).cur.stride[0usize])) as isize),
        ((*f).lf.p[1usize])
            .offset((y as libc::c_long * PXSTRIDE((*f).cur.stride[1usize]) >> ss_ver) as isize),
        ((*f).lf.p[2usize])
            .offset((y as libc::c_long * PXSTRIDE((*f).cur.stride[1usize]) >> ss_ver) as isize),
    ];
...
pub unsafe extern "C" fn dav1d_filter_sbrow_cdef_16bpc(
    ...
    if sby != 0 {
        ...
        let mut p_up: [*mut pixel; 3] = [
            (p[0usize]).offset(-((8i64 * PXSTRIDE((*f).cur.stride[0usize])) as isize)),
            (p[1usize]).offset(-((8i64 * PXSTRIDE((*f).cur.stride[1usize]) >> ss_ver_0) as isize)),
            (p[2usize]).offset(-((8i64 * PXSTRIDE((*f).cur.stride[1usize]) >> ss_ver_0) as isize)),
        ];
    ...
    dav1d_cdef_brow_16bpc(tc, p.as_ptr(), mask, start, end, 0i32, sby);
}
#[no_mangle]
pub unsafe extern "C" fn dav1d_filter_sbrow_resize_16bpc(
    ...
    let ss_ver: libc::c_int = ((*f).cur.p.layout == DAV1D_PIXEL_LAYOUT_I420) as libc::c_int;
    let p: [*const pixel; 3] = [
        ((*f).lf.p[0usize]).offset((y as libc::c_long * PXSTRIDE((*f).cur.stride[0usize])) as isize)
            as *const pixel,
        ((*f).lf.p[1usize])
            .offset((y as libc::c_long * PXSTRIDE((*f).cur.stride[1usize]) >> ss_ver) as isize)
            as *const pixel,
    ...
    let sr_p: [*mut pixel; 3] = [
        ((*f).lf.sr_p[0usize])
            .offset((y as libc::c_long * PXSTRIDE((*f).sr_cur.p.stride[0usize])) as isize),
        ((*f).lf.sr_p[1usize]).offset(
            (y as libc::c_long * PXSTRIDE((*f).sr_cur.p.stride[1usize]) >> ss_ver) as isize,
        ),
        ((*f).lf.sr_p[2usize]).offset(
            (y as libc::c_long * PXSTRIDE((*f).sr_cur.p.stride[1usize]) >> ss_ver) as isize,
        ),
    ];
...
pub unsafe extern "C" fn dav1d_backup_ipred_edge_16bpc(t: *mut Dav1dTaskContext) {
    ...
    let y: *const pixel = ((*f).cur.data[0usize] as *const pixel)
        ...
        .offset(
            ((((*t).by + (*f).sb_step) * 4i32 - 1i32) as libc::c_long
                * PXSTRIDE((*f).cur.stride[0usize])) as isize,
        );
    memcpy(
        ...
        (4i32 * ((*ts).tiling.col_end - x_off) << 1i32) as libc::c_ulong,
    );
    if (*f).cur.p.layout != DAV1D_PIXEL_LAYOUT_I400 {
        ...
        while pl <= 2i32 {
            memcpy(
                ...
                (4i32 * ((*ts).tiling.col_end - x_off) >> ss_hor << 1i32) as libc::c_ulong,
            );
            pl += 1;
        }
    }
