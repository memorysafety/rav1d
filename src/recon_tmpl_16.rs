...
unsafe extern "C" fn get_dc_sign_ctx(
    ...
    match tx {
        ...
        3 => {
            ...
            s = t_2.wrapping_shr(56) as libc::c_int - 8
                - 8;
            current_block_66 = 2606304779496145856;
        }
        4 => {
            ...
            s = t_3.wrapping_shr(56) as libc::c_int - 16
                - 16;
            current_block_66 = 2606304779496145856;
        }
        5 => {
        ...
        9 => {
            ...
            s = t_8.wrapping_shr(56) as libc::c_int - 4
                - 8;
            current_block_66 = 2606304779496145856;
        }
        10 => {
            ...
            s = t_9.wrapping_shr(56) as libc::c_int - 8
                - 4;
            current_block_66 = 2606304779496145856;
        }
        11 => {
            ...
            s = t_10.wrapping_shr(56) as libc::c_int - 8
                - 16;
            current_block_66 = 2606304779496145856;
        }
        12 => {
            ...
            s = t_11.wrapping_shr(56) as libc::c_int - 16
                - 8;
            current_block_66 = 2606304779496145856;
        }
        13 => {
        ...
        15 => {
            ...
            s = t_14.wrapping_shr(56) as libc::c_int - 2
                - 8;
            current_block_66 = 2606304779496145856;
        }
        16 => {
            ...
            s = t_15.wrapping_shr(56) as libc::c_int - 8
                - 2;
            current_block_66 = 2606304779496145856;
        }
        17 => {
            ...
            s = t_16.wrapping_shr(56) as libc::c_int - 4
                - 16;
            current_block_66 = 2606304779496145856;
        }
        18 => {
            ...
            s = t_17.wrapping_shr(56) as libc::c_int - 16
                - 4;
            current_block_66 = 2606304779496145856;
        }
        _ => {
...
pub unsafe extern "C" fn dav1d_filter_sbrow_deblock_cols_16bpc(
    ...
    let p: [*mut pixel; 3] = [
        ...
        ((*f).lf.p[1])
            .offset(
                (y as isize * PXSTRIDE((*f).cur.stride[1])
                    >> ss_ver) as isize,
            ),
        ((*f).lf.p[2])
            .offset(
...
pub unsafe extern "C" fn dav1d_filter_sbrow_cdef_16bpc(
    ...
    if sby != 0 {
        ...
        let mut p_up: [*mut pixel; 3] = [
            (p[0])
                .offset(
                    -((8 * PXSTRIDE((*f).cur.stride[0])) as isize),
                ),
            (p[1])
                .offset(
                    -((8 * PXSTRIDE((*f).cur.stride[1])
                        >> ss_ver_0) as isize),
                ),
            (p[2])
                .offset(
...
pub unsafe extern "C" fn dav1d_filter_sbrow_resize_16bpc(
    ...
    let sr_p: [*mut pixel; 3] = [
        ((*f).lf.sr_p[0])
            .offset(
                (y as isize
                    * PXSTRIDE((*f).sr_cur.p.stride[0])) as isize,
            ),
        ((*f).lf.sr_p[1])
            .offset(
                (y as isize
                    * PXSTRIDE((*f).sr_cur.p.stride[1])
                    >> ss_ver) as isize,
            ),
        ((*f).lf.sr_p[2])
            .offset(
...
pub unsafe extern "C" fn dav1d_backup_ipred_edge_16bpc(t: *mut Dav1dTaskContext) {
    ...
    let y: *const pixel = ((*f).cur.data[0] as *const pixel)
        ...
        .offset(
            ((((*t).by + (*f).sb_step) * 4 - 1)
                as isize * PXSTRIDE((*f).cur.stride[0]))
                as isize,
        );
    memcpy(
