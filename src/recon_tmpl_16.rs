...
unsafe extern "C" fn get_dc_sign_ctx(
    ...
    match tx {
        ...
        3 => {
            ...
            s = t_2.wrapping_shr(56) as libc::c_int - 8 - 8;
            current_block_66 = 2606304779496145856;
        }
        4 => {
            ...
            s = t_3.wrapping_shr(56) as libc::c_int - 16 - 16;
            current_block_66 = 2606304779496145856;
        }
        5 => {
            ...
            t_4 = (t_4 as libc::c_uint)
                .wrapping_add(*(l as *const uint16_t) as libc::c_uint & mask as uint32_t)
                as uint32_t as uint32_t;
            t_4 = t_4.wrapping_mul(0x4040404 as libc::c_uint) as uint32_t as uint32_t;
        ...
        9 => {
            ...
            s = t_8.wrapping_shr(56) as libc::c_int - 4 - 8;
            current_block_66 = 2606304779496145856;
        }
        10 => {
            let mut t_9: uint64_t = *(a as *const uint64_t) & mask;
            t_9 = t_9.wrapping_add((*(l as *const uint32_t) & mask as uint32_t) as uint64_t)
                as uint64_t as uint64_t;
            t_9 = (t_9 >> 6).wrapping_mul(mul);
            s = t_9.wrapping_shr(56) as libc::c_int - 8 - 4;
            current_block_66 = 2606304779496145856;
        }
        11 => {
            ...
            s = t_10.wrapping_shr(56) as libc::c_int - 8 - 16;
            current_block_66 = 2606304779496145856;
        }
        12 => {
            ...
            s = t_11.wrapping_shr(56) as libc::c_int - 16 - 8;
            current_block_66 = 2606304779496145856;
        }
        13 => {
        ...
        15 => {
            ...
            s = t_14.wrapping_shr(56) as libc::c_int - 2 - 8;
            current_block_66 = 2606304779496145856;
        }
        16 => {
            ...
            s = t_15.wrapping_shr(56) as libc::c_int - 8 - 2;
            current_block_66 = 2606304779496145856;
        }
        17 => {
            ...
            s = t_16.wrapping_shr(56) as libc::c_int - 4 - 16;
            current_block_66 = 2606304779496145856;
        }
        18 => {
            ...
            s = t_17.wrapping_shr(56) as libc::c_int - 16 - 4;
            current_block_66 = 2606304779496145856;
        }
        _ => {
            if 0 == 0 {
    ...
    if tx_class as libc::c_uint == TX_CLASS_2D as libc::c_int as libc::c_uint {
        ...
        *hi_mag = mag;
        mag = mag.wrapping_add(
            (*levels.offset(0 * stride as isize + 2) as libc::c_int
                + *levels.offset(2 * stride as isize + 0) as libc::c_int)
                as libc::c_uint,
        );
        ...
        mag = mag.wrapping_add(*levels.offset(0 * stride as isize + 2) as libc::c_uint);
        *hi_mag = mag;
        mag = mag.wrapping_add(
            (*levels.offset(0 * stride as isize + 3) as libc::c_int
        ...
        if (*t).frame_thread.pass != 2 as libc::c_int {
            ...
            match txw {
                1 => {
                    let mut y = 0;
                    while y < txh {
                        (*(&mut *txtp_map.offset(0) as *mut uint8_t as *mut alias8)).u8_0 =
                            (0x1 as libc::c_int as libc::c_uint).wrapping_mul(txtp as libc::c_uint)
                                as uint8_t;
                ...
                2 => {
                    let mut y_0 = 0;
                    while y_0 < txh {
                        (*(&mut *txtp_map.offset(0) as *mut uint8_t as *mut alias16)).u16_0 =
                ...
                4 => {
                    let mut y_1 = 0;
                    while y_1 < txh {
                        (*(&mut *txtp_map.offset(0) as *mut uint8_t as *mut alias32)).u32_0 =
                            (0x1010101 as libc::c_uint).wrapping_mul(txtp as libc::c_uint);
                        txtp_map = txtp_map.offset(32);
                        y_1 += 1;
                    }
                }
                8 => {
                    let mut y_2 = 0;
                    while y_2 < txh {
                        (*(&mut *txtp_map.offset(0) as *mut uint8_t as *mut alias64)).u64_0 =
                ...
                16 => {
                    ...
                    while y_3 < txh {
                        let const_val_1: uint64_t = (0x101010101010101 as libc::c_ulonglong)
                            .wrapping_mul(txtp as libc::c_ulonglong)
                            as uint64_t;
                        (*(&mut *txtp_map.offset((0 + 0) as isize) as *mut uint8_t
                            as *mut alias64))
                            .u64_0 = const_val_1;
                        (*(&mut *txtp_map.offset((0 + 8) as isize) as *mut uint8_t
                            as *mut alias64))
                            .u64_0 = const_val_1;
                        txtp_map = txtp_map.offset(32);
                        y_3 += 1;
                            ...
                            _ => {
                                memset(
                                    &mut *((*t).l.lcoef).as_mut_ptr().offset((by4 + y) as isize)
                                        ...
                                        as *mut libc::c_void,
                                    cf_ctx as libc::c_int,
                                    imin((*t_dim).h as libc::c_int, (*f).bh - (*t).by) as size_t,
                                );
                            }
                        }
                            ...
                            _ => {
                                memset(
                                    &mut *((*(*t).a).lcoef).as_mut_ptr().offset((bx4 + x) as isize)
                                        ...
                                        as *mut libc::c_void,
                                    cf_ctx as libc::c_int,
                                    imin((*t_dim).w as libc::c_int, (*f).bw - (*t).bx) as size_t,
                                );
                            }
                        }
                    }
