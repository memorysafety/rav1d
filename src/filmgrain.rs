...
impl Rav1dFilmGrainDSPContext {
    fn new_c<BD: BitDepth>() -> Self {
        ...
        c.generate_grain_uv[RAV1D_PIXEL_LAYOUT_I420 as usize - 1] =
            generate_grain_uv_c_erased::<BD, 420, true, true>;
        c.generate_grain_uv[RAV1D_PIXEL_LAYOUT_I422 as usize - 1] =
            generate_grain_uv_c_erased::<BD, 422, true, false>;
        c.generate_grain_uv[RAV1D_PIXEL_LAYOUT_I444 as usize - 1] =
            generate_grain_uv_c_erased::<BD, 444, false, false>;

        c.fguv_32x32xn[RAV1D_PIXEL_LAYOUT_I420 as usize - 1] =
            fguv_32x32xn_c_erased::<BD, 420, true, true>;
        c.fguv_32x32xn[RAV1D_PIXEL_LAYOUT_I422 as usize - 1] =
            fguv_32x32xn_c_erased::<BD, 422, true, false>;
        c.fguv_32x32xn[RAV1D_PIXEL_LAYOUT_I444 as usize - 1] =
    ...
    fn init_x86<BD: BitDepth>(&mut self, flags: CpuFlags) {
        ...
        self.generate_grain_uv[RAV1D_PIXEL_LAYOUT_I420 as usize - 1] =
            bd_fn!(decl_generate_grain_uv_fn, BD, generate_grain_uv_420, ssse3);
        self.generate_grain_uv[RAV1D_PIXEL_LAYOUT_I422 as usize - 1] =
            bd_fn!(decl_generate_grain_uv_fn, BD, generate_grain_uv_422, ssse3);
        self.generate_grain_uv[RAV1D_PIXEL_LAYOUT_I444 as usize - 1] =
        ...
        self.fguv_32x32xn[RAV1D_PIXEL_LAYOUT_I420 as usize - 1] =
            bd_fn!(decl_fguv_32x32xn_fn, BD, fguv_32x32xn_i420, ssse3);
        self.fguv_32x32xn[RAV1D_PIXEL_LAYOUT_I422 as usize - 1] =
            bd_fn!(decl_fguv_32x32xn_fn, BD, fguv_32x32xn_i422, ssse3);
        self.fguv_32x32xn[RAV1D_PIXEL_LAYOUT_I444 as usize - 1] =
