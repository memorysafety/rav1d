    ...
    if eob != 0 {
        ...
        match tx_class {
            TxClass::TwoD => {
                ...
                cf[rc as usize] = (tok << 11).as_::<BD::Coef>();
                ...
                while i > 0 {
                    ...
                    if tok == 3 {
                        ...
                        cf[rc_i as usize] = ((tok << 11) as c_uint | rc).as_::<BD::Coef>();
                        rc = rc_i;
                    } else {
                        ...
                        cf[rc_i as usize] = tok.as_::<BD::Coef>();
                    }
                    i -= 1;
                }
    ...
    match current_block {
        1669574575799829731 => {
            ...
            loop {
                ...
                cf[rc as usize] = (if sign != 0 { -dq_sat } else { dq_sat }).as_::<BD::Coef>();
                ...
                while x < sub_w4 {
                    ...
                    if b.skip == 0 {
                        ...
                        if t.frame_thread.pass != 0 {
                            ...
                            ts.frame_thread[p as usize].cf += cmp::min((*t_dim).w, 8) as usize
                                * cmp::min((*t_dim).h, 8) as usize
                                * 16;
...
pub(crate) unsafe fn rav1d_recon_b_inter<BD: BitDepth>(
    ...
    if frame_hdr.frame_type.is_key_or_intra() {
        ...
        if !(has_chroma == 0) {
            ...
            if is_sub8x8 != 0 {
                assert!(ss_hor == 1);
                let mut h_off: ptrdiff_t = 0;
                let mut v_off: ptrdiff_t = 0;
                if bw4 == 1 && bh4 == ss_ver {
                    let mut pl = 0;
                    while pl < 2 {
                        mc::<BD>(
                ...
                if bh4 == ss_ver {
                    ...
                    while pl < 2 {
                        mc::<BD>(
                            ...
                            &*(f.refp).as_ptr().offset(
                                *((*(*r.offset(-1)).offset(t.b.x as isize)).0.r#ref.r#ref)
                                    .as_mut_ptr()
                                    .offset(0) as isize
                                    - 1,
                            ),
    ...
    let uvtx: *const TxfmInfo = dav1d_txfm_dimensions.as_ptr().offset(b.uvtx as isize);
