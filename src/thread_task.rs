...
unsafe extern "C" fn merge_pending_frame(f: *mut Dav1dFrameContext) -> libc::c_int {
    let merge: libc::c_int =
        ::core::intrinsics::atomic_load_seqcst(&mut (*f).task_thread.pending_tasks.merge);
    if merge != 0 {
        pthread_mutex_lock(&mut (*f).task_thread.pending_tasks.lock);
...
unsafe extern "C" fn delayed_fg_task(c: *const Dav1dContext, ttd: *mut TaskThreadData) {
    ...
    loop {
        ...
        let fresh15 = 1 as libc::c_int;
            ...
            ::core::intrinsics::atomic_xadd_seqcst(fresh14, fresh15) + fresh15 + 1 as libc::c_int;
        if row < progmax {
            continue;
        }
        pthread_mutex_lock(&mut (*ttd).lock);
    ...
    done = ::core::intrinsics::atomic_xadd_seqcst(fresh16, fresh17) + fresh17 + 1 as libc::c_int;
                ...
                match current_block {
                    ...
                    _ => {
                        loop {
                            ...
                            let fresh27 = flush;
                            error_0 = ::core::intrinsics::atomic_or_seqcst(fresh26, fresh27)
                                | fresh27
                                | flush;
                            (*tc).f = f;
                            sby = (*t).sby;
                            ...
                            7445507753695543878 => {
                                        ...
                                        != 0
                                {
                                    ...
                                    let fresh40 = &mut *((*f).frame_thread.copy_lpf_progress)
                                        ...
                                        as *mut atomic_uint;
                                    let fresh41 = (1 as libc::c_uint) << (sby & 31 as libc::c_int);
                            ...
                            == DAV1D_TASK_TYPE_ENTROPY_PROGRESS as libc::c_int as libc::c_uint
                        {
                            ...
                            let num_tasks: libc::c_int =
                                ::core::intrinsics::atomic_xsub_seqcst(fresh44, fresh45)
                                    - fresh45
                                    - 1 as libc::c_int;
                            ...
                            let fresh46 = &mut *((*f).frame_thread.frame_progress)
                                .offset((sby >> 5 as libc::c_int) as isize)
                                as *mut atomic_uint;
                            let fresh47 = (1 as libc::c_uint) << (sby & 31 as libc::c_int);
                            ::core::intrinsics::atomic_or_seqcst(fresh46, fresh47) | fresh47;
                            ...
                            let num_tasks_0: libc::c_int =
                                ::core::intrinsics::atomic_xsub_seqcst(fresh48, fresh49)
                                    - fresh49
                                    - 1 as libc::c_int;
